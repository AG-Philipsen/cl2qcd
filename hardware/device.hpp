...
namespace hardware {
    ...
    namespace buffers {
        ...
        copyDataRect(const hardware::Device* device, const hardware::buffers::Buffer* dest,
                     const hardware::buffers::Buffer* orig, const size_t* destOrigin, const size_t* srcOrigin,
                     const size_t* region, size_t destRowPitch, size_t destSlicePitch, size_t srcRowPitch,
                     size_t srcSlicePitch, const std::vector<hardware::SynchronizationEvent>& events);
    }  // namespace buffers
    namespace transfer {
    ...
    class Device : public DeviceInfo {
        ...
        friend hardware::SynchronizationEvent
        hardware::buffers::copyDataRect(const hardware::Device* device, const hardware::buffers::Buffer* dest,
                                        const hardware::buffers::Buffer* orig, const size_t* destOrigin,
                                        const size_t* srcOrigin, const size_t* region, size_t destRowPitch,
                                        size_t destSlicePitch, size_t srcRowPitch, size_t srcSlicePitch,
      ...
      public:
         ...
         */
        Device(cl_context, cl_device_id, LatticeGridIndex lI, LatticeGrid lG, const hardware::OpenClCode& builderIn,
        ...
        void enqueue_barrier(const hardware::SynchronizationEvent& event1,
         ...
         */
        size_t recommendStride(size_t elementsOfCompleteType, size_t sizeOfBasicStorageElement,
                               size_t numbeOfBasicStorageElementsInCompleteType) const;
