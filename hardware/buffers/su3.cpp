...
hardware::buffers::SU3::SU3(const size_t elems, const hardware::Device* device)
    : Buffer(calculate_su3_buffer_size(elems, device), device), elems(elems), soa(check_SU3_for_SOA(device))
{
    // nothing to do
}
...
void hardware::buffers::SU3::loadRect_raw(const void* src, const size_t* buffer_origin, const size_t* host_origin,
...
void hardware::buffers::SU3::dumpRect_raw(void* dest, const size_t* buffer_origin, const size_t* host_origin,
                                          const size_t* region, size_t buffer_row_pitch, size_t buffer_slice_pitch,
                                          size_t host_row_pitch, size_t host_slice_pitch) const
{
    logger.trace() << "Dumping raw data from SU3 buffer.";
...
hardware::buffers::SU3::loadRect_rawAsync(const void* src, const size_t* buffer_origin, const size_t* host_origin,
                                          const size_t* region, size_t buffer_row_pitch, size_t buffer_slice_pitch,
...
hardware::SynchronizationEvent
hardware::buffers::SU3::dumpRect_rawAsync(void* dest, const size_t* buffer_origin, const size_t* host_origin,
                                          const size_t* region, size_t buffer_row_pitch, size_t buffer_slice_pitch,
                                          size_t host_row_pitch, size_t host_slice_pitch,
                                          const hardware::SynchronizationEvent& event) const
{
