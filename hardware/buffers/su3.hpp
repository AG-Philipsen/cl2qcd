...
namespace hardware {
    namespace buffers {
        ...
        size_t calculateGaugefieldSize(LatticeExtents latticeExtentsIn) noexcept;

        /**
         * Check whether SU3 should be stored SOA style on this device
         */
        size_t check_SU3_for_SOA(const hardware::Device* device);

        /**
         * Get the stride for an SU3 buffer of the given number of elements on the given device
         */
        size_t get_SU3_buffer_stride(const size_t elems, const Device* device);
        ...
        class SU3 : public Buffer {
          public:
             ...
             */
            SU3(const size_t elems, const Device* device);
            SU3(const LatticeExtents lE, const Device* device);
             ...
             */
            void dump(Matrixsu3*, const size_t elems = 0, const size_t offset = 0) const;
            ...
            void loadRect_raw(const void* src, const size_t* buffer_origin, const size_t* host_origin,
                              const size_t* region, size_t buffer_row_pitch, size_t buffer_slice_pitch,
                              size_t host_row_pitch, size_t host_slice_pitch) const;
            void dumpRect_raw(void* dest, const size_t* buffer_origin, const size_t* host_origin, const size_t* region,
                              size_t buffer_row_pitch, size_t buffer_slice_pitch, size_t host_row_pitch,
                              size_t host_slice_pitch) const;
            hardware::SynchronizationEvent loadRect_rawAsync(const void* src, const size_t* buffer_origin,
            ...
            dumpRect_rawAsync(void* dest, const size_t* buffer_origin, const size_t* host_origin, const size_t* region,
                              size_t buffer_row_pitch, size_t buffer_slice_pitch, size_t host_row_pitch,
