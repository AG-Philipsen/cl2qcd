...
void hardware::buffers::Gaugemomentum::loadRect_raw(const void* src, const size_t* buffer_origin,
...
void hardware::buffers::Gaugemomentum::dumpRect_raw(void* dest, const size_t* buffer_origin, const size_t* host_origin,
...
hardware::buffers::Gaugemomentum::loadRect_rawAsync(const void* src, const size_t* buffer_origin,
                                                    const size_t* host_origin, const size_t* region,
                                                    size_t buffer_row_pitch, size_t buffer_slice_pitch,
...
hardware::SynchronizationEvent
hardware::buffers::Gaugemomentum::dumpRect_rawAsync(void* dest, const size_t* buffer_origin, const size_t* host_origin,
                                                    const size_t* region, size_t buffer_row_pitch,
                                                    size_t buffer_slice_pitch, size_t host_row_pitch,
