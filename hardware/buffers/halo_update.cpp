...
hardware::buffers::ProxyBufferCache::ProxyBufferCache() : cache() {}
...
const std::vector<hardware::buffers::DeviceAccessibleMemory*>&
hardware::buffers::ProxyBufferCache::getBuffers(size_t rows, size_t bytes,
                                                const std::vector<hardware::Device*>& devices)
{
