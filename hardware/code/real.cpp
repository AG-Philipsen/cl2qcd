...
void hardware::code::Real::set_real_to_vector_element_device(const hardware::buffers::Plain<hmc_float>* in,
                                                             const int index,
...
void hardware::code::Real::set_vector_element_to_real_device(const hardware::buffers::Plain<hmc_float>* in,
                                                             const int index,
                                                             const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Real::set_real_to_ratio_device(const hardware::buffers::Plain<hmc_float>* a,
                                                    const hardware::buffers::Plain<hmc_float>* b,
                                                    const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Real::set_real_to_product_device(const hardware::buffers::Plain<hmc_float>* a,
                                                      const hardware::buffers::Plain<hmc_float>* b,
                                                      const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Real::set_real_to_sum_device(const hardware::buffers::Plain<hmc_float>* a,
                                                  const hardware::buffers::Plain<hmc_float>* b,
                                                  const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Real::set_real_to_difference_device(const hardware::buffers::Plain<hmc_float>* a,
                                                         const hardware::buffers::Plain<hmc_float>* b,
                                                         const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Real::update_zeta_cgm_device(const hardware::buffers::Plain<hmc_float>* zeta_prev,
                                                  const hardware::buffers::Plain<hmc_float>* zeta_prev_prev,
                                                  const hardware::buffers::Plain<hmc_float>* sbeta_prev,
                                                  const hardware::buffers::Plain<hmc_float>* sbeta_pres,
                                                  const hardware::buffers::Plain<hmc_float>* salpha_prev,
                                                  const hardware::buffers::Plain<hmc_float>* sigma, const int numeq,
                                                  const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Real::update_beta_cgm_device(const hardware::buffers::Plain<hmc_float>* sbeta_pres,
                                                  const hardware::buffers::Plain<hmc_float>* zeta_pres,
                                                  const hardware::buffers::Plain<hmc_float>* zeta_prev, const int numeq,
                                                  const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Real::update_alpha_cgm_device(const hardware::buffers::Plain<hmc_float>* salpha_pres,
                                                   const hardware::buffers::Plain<hmc_float>* zeta_pres,
                                                   const hardware::buffers::Plain<hmc_float>* beta_pres,
                                                   const hardware::buffers::Plain<hmc_float>* zeta_prev,
                                                   const hardware::buffers::Plain<hmc_float>* sbeta_pres,
                                                   const int numeq,
                                                   const hardware::buffers::Plain<hmc_float>* out) const
{
...
hardware::code::Real::Real(const hardware::code::OpenClKernelParametersInterface& kernelParameters,
