...
void hardware::code::Fermions::fill_kernels()
{
	...
	if(get_parameters().get_fermact() == common::action::wilson) {
		M_wilson = createKernel("M_wilson") << sources << "fermionmatrix.cl" << "fermionmatrix_m.cl";
	} else if(get_parameters().get_fermact() == common::action::twistedmass) {
	...
	} else if(get_parameters().get_fermact() == common::action::clover) {
	...
	if(get_parameters().get_use_eo() == true) {
		if(get_parameters().get_fermact() == common::action::twistedmass) {
