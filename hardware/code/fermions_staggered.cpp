...
hardware::code::Fermions_staggered::Fermions_staggered(const meta::Inputparameters& params, const hardware::code::OpenClKernelParametersInterface& kernelParams, hardware::Device * device)
