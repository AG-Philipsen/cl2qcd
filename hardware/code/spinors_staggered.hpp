    ...
    namespace code {
        ...
        class Spinors_staggered : public Opencl_Module {
          public:
             ...
             */
            void sax_device(const hardware::buffers::Plain<su3vec>* x,
             ...
             */
            void saxpy_device(const hardware::buffers::Plain<su3vec>* x, const hardware::buffers::Plain<su3vec>* y,
                              const hardware::buffers::Plain<hmc_complex>* alpha,
                              const hardware::buffers::Plain<su3vec>* out) const;
             ...
             */
            void saxpbypz_device(const hardware::buffers::Plain<su3vec>* x, const hardware::buffers::Plain<su3vec>* y,
             ...
             *                reductions.
             */
            void global_squarenorm_reduction(const hardware::buffers::Plain<hmc_float>* out,
             ...
             * @param out The result of the reduction
             */
            void set_float_to_global_squarenorm_device(const hardware::buffers::Plain<su3vec>* a,
             ...
             */
            void set_complex_to_scalar_product_device(const hardware::buffers::Plain<su3vec>* a,
                                                      const hardware::buffers::Plain<su3vec>* b,
             ...
             */
            void set_gaussian_spinorfield_device(const hardware::buffers::Plain<su3vec>* in,
             ...
             */
            void sax_eoprec_device(const hardware::buffers::SU3vec* x,
                                   const hardware::buffers::Plain<hmc_complex>* alpha,
                                   const hardware::buffers::SU3vec* out) const;
            void sax_eoprec_device(const hardware::buffers::SU3vec* x, const hmc_complex alpha,
                                   const hardware::buffers::SU3vec* out) const;
            void sax_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::Plain<hmc_float>* alpha,
                                   const hardware::buffers::SU3vec* out) const;
            void sax_eoprec_device(const hardware::buffers::SU3vec* x, const hmc_float alpha,
                                   const hardware::buffers::SU3vec* out) const;
            void sax_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::Plain<hmc_float>* alpha,
                                   const int index_alpha, const hardware::buffers::SU3vec* out) const;
             ...
             * @note If alpha is a vector of constants, the index of that to be used must be specified!
             */
            void saxpy_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                     const hardware::buffers::Plain<hmc_complex>* alpha,
                                     const hardware::buffers::SU3vec* out) const;
            void saxpy_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                     const hmc_complex alpha, const hardware::buffers::SU3vec* out) const;
            void saxpy_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                     const hardware::buffers::Plain<hmc_float>* alpha,
                                     const hardware::buffers::SU3vec* out) const;
            void saxpy_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                     const hmc_float alpha, const hardware::buffers::SU3vec* out) const;
            void saxpy_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                     const hardware::buffers::Plain<hmc_float>* alpha, const int index_alpha,
                                     const hardware::buffers::SU3vec* out) const;
             ...
             */
            void saxpby_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                      const hardware::buffers::Plain<hmc_complex>* alpha,
                                      const hardware::buffers::Plain<hmc_complex>* beta,
                                      const hardware::buffers::SU3vec* out) const;
            void saxpby_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
            ...
            void saxpby_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                      ...
                                      const hardware::buffers::SU3vec* out) const;
            void saxpby_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                      const hmc_float alpha, const hmc_float beta,
                                      const hardware::buffers::SU3vec* out) const;
            void saxpby_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                      const hardware::buffers::Plain<hmc_float>* alpha,
                                      const hardware::buffers::Plain<hmc_float>* beta, const int index_alpha,
                                      const int index_beta, const hardware::buffers::SU3vec* out) const;
             ...
             */
            void saxpbypz_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                        const hardware::buffers::SU3vec* z,
                                        const hardware::buffers::Plain<hmc_complex>* alpha,
                                        const hardware::buffers::Plain<hmc_complex>* beta,
                                        const hardware::buffers::SU3vec* out) const;
            void saxpbypz_eoprec_device(const hardware::buffers::SU3vec* x, const hardware::buffers::SU3vec* y,
                                        const hardware::buffers::SU3vec* z, const hmc_complex alpha,
                                        const hmc_complex beta, const hardware::buffers::SU3vec* out) const;
             ...
             * @param out The result of the reduction
             */
            void set_float_to_global_squarenorm_eoprec_device(const hardware::buffers::SU3vec* a,
                                                              const hardware::buffers::Plain<hmc_float>* out) const;
             ...
             */
            void set_complex_to_scalar_product_eoprec_device(const hardware::buffers::SU3vec* a,
                                                             const hardware::buffers::SU3vec* b,
                                                             const hardware::buffers::Plain<hmc_complex>* out) const;
            ///@note If this function is called and out is complex an exception is thrown!
            void
            set_float_to_scalar_product_real_part_eoprec_device(const hardware::buffers::SU3vec* a,
                                                                const hardware::buffers::SU3vec* b,
                                                                const hardware::buffers::Plain<hmc_float>* out) const;
             ...
             */
            void sax_vectorized_and_squarenorm_eoprec_device(const hardware::buffers::SU3vec* x,
                                                             const hardware::buffers::Plain<hmc_float>* alpha,
                                                             const int numeqs,
                                                             const hardware::buffers::Plain<hmc_float>* out) const;
            /**
            ...
            void sax_vectorized_squarenorm_reduction(const hardware::buffers::Plain<hmc_float>* out,
                                                     const hardware::buffers::Plain<hmc_float>* tmp_buf,
             ...
             *       PETER J. SCHREIER around page 22).
             */
            void set_gaussian_spinorfield_eoprec_device(const hardware::buffers::SU3vec* in,
                                                        const hardware::buffers::PRNGBuffer* prng) const;
             ...
             */
            void convert_from_eoprec_device(const hardware::buffers::SU3vec* even, const hardware::buffers::SU3vec* odd,
                                            const hardware::buffers::Plain<su3vec>* out) const;
             ...
             * @param odd The staggered field on odd sites
             */
            void convert_to_eoprec_device(const hardware::buffers::SU3vec* even, const hardware::buffers::SU3vec* odd,
          ...
          private:
             ...
             */
            void convert_staggered_field_to_SoA_eo_device(const hardware::buffers::SU3vec* out,
                                                          const hardware::buffers::Plain<su3vec>* in) const;
             ...
             */
            void convert_staggered_field_from_SoA_eo_device(const hardware::buffers::Plain<su3vec>* out,
