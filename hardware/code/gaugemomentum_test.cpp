...
struct SquarenormTester : public GaugemomentumTester {
    SquarenormTester(const ParameterCollection pC, const GaugemomentumTestParameters tP)
        : GaugemomentumTester("gaugemomenta squarenorm", pC,
                              calculateReferenceValues_squarenorm(tP.latticeExtents, tP.fillType), tP)
    {
...
BOOST_AUTO_TEST_SUITE(SET_ZERO)
    ...
    BOOST_AUTO_TEST_CASE(SET_ZERO_1) { testSetZero(LatticeExtents{ns4, nt4}); }
...
BOOST_AUTO_TEST_SUITE(CONVERT_TO_SOA)
    ...
    BOOST_AUTO_TEST_CASE(CONVERT_TO_SOA_1) { BOOST_TEST_MESSAGE("NOT YET IMPLEMENTED!!"); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(CONVERT_FROM_SOA)

    BOOST_AUTO_TEST_CASE(CONVERT_FROM_SOA_1) { BOOST_TEST_MESSAGE("NOT YET IMPLEMENTED!!"); }
