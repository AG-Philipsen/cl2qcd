    ...
    namespace code {
        ...
        class Real : public Opencl_Module {
          public:
             ...
             */
            void set_real_to_vector_element_device(const hardware::buffers::Plain<hmc_float>* in, const int index,
                                                   const hardware::buffers::Plain<hmc_float>* out) const;

            /**
             * Function to set one element of a buffer
             */
            void set_vector_element_to_real_device(const hardware::buffers::Plain<hmc_float>* in, const int index,
                                                   const hardware::buffers::Plain<hmc_float>* out) const;
             ...
             */
            void set_real_to_ratio_device(const hardware::buffers::Plain<hmc_float>* a,
             ...
             * @param out A real number containing a * b
             */
            void set_real_to_product_device(const hardware::buffers::Plain<hmc_float>* a,
                                            const hardware::buffers::Plain<hmc_float>* b,
                                            const hardware::buffers::Plain<hmc_float>* out) const;
             ...
             * @param out A real number containing a + b
             */
            void set_real_to_sum_device(const hardware::buffers::Plain<hmc_float>* a,
                                        const hardware::buffers::Plain<hmc_float>* b,
                                        const hardware::buffers::Plain<hmc_float>* out) const;
             ...
             * @param out A real number containing a - b
             */
            void set_real_to_difference_device(const hardware::buffers::Plain<hmc_float>* a,
                                               const hardware::buffers::Plain<hmc_float>* b,
                                               const hardware::buffers::Plain<hmc_float>* out) const;
             ...
             */
            void update_zeta_cgm_device(const hardware::buffers::Plain<hmc_float>* zeta_prev,
             ...
             */
            void update_beta_cgm_device(const hardware::buffers::Plain<hmc_float>* sbeta_pres,
             ...
             * @param sbeta_pres scalar beta at the present iteration (real number)
             * @param numeq number of masses of the cgm (unsigned integer)
             * @param out salpha_pres * zeta_pres[k] * beta_pres[k] / (zeta_prev[k] * sbeta_pres)  (vector of real
             * numbers)
             */
            void update_alpha_cgm_device(const hardware::buffers::Plain<hmc_float>* salpha_pres,
                                         const hardware::buffers::Plain<hmc_float>* zeta_pres,
                                         const hardware::buffers::Plain<hmc_float>* beta_pres,
                                         const hardware::buffers::Plain<hmc_float>* zeta_prev,
                                         const hardware::buffers::Plain<hmc_float>* sbeta_pres, const int numeq,
                                         const hardware::buffers::Plain<hmc_float>* out) const;
