...
const ReferenceValues calculateReferenceValues_scalarProduct(const int latticeVolume, const SpinorFillTypes fillTypesIn)
{
    if (fillTypesIn.at(0) == SpinorFillType::one and fillTypesIn.at(1) == SpinorFillType::one) {
        ...
        return ReferenceValues{latticeVolume * sumOfIntegers(1, 5, 2), -latticeVolume * sumOfIntegers(2, 6, 2)};
    } else if (fillTypesIn.at(0) == SpinorFillType::ascendingComplex and
               fillTypesIn.at(1) == SpinorFillType::ascendingComplex) {
...
{
    return ReferenceValues{(alphaIn.at(0).im * alphaIn.at(0).im + alphaIn.at(0).re * alphaIn.at(0).re) * latticeVolume *
                           sumOfIntegersSquared(6)};
}
...
const ReferenceValues calculateReferenceValues_saxpy(const int latticeVolume, const ComplexNumbers alphaIn)
{
    return ReferenceValues{
        calculateReferenceValues_sax(latticeVolume, ComplexNumbers{{1. + alphaIn.at(0).re, 0. + alphaIn.at(0).im}})
            .at(0)};
}
...
{
    return ReferenceValues{
        calculateReferenceValues_sax(latticeVolume, ComplexNumbers{{alphaIn.at(0).re + alphaIn.at(1).re,
                                                                    alphaIn.at(0).im + alphaIn.at(1).im}})
            .at(0)};
}
...
{
    return ReferenceValues{
        calculateReferenceValues_sax(latticeVolume, RealNumbers{alphaIn.at(0) + alphaIn.at(1)}).at(0)};
}

const ReferenceValues calculateReferenceValues_saxpbypz(const int latticeVolume, const ComplexNumbers alphaIn)
{
    return ReferenceValues{
        calculateReferenceValues_sax(latticeVolume, ComplexNumbers{{1. + alphaIn.at(0).re + alphaIn.at(1).re,
                                                                    0. + alphaIn.at(0).im + alphaIn.at(1).im}})
            .at(0)};
}
...
calculateReferenceValue_sax_vec_and_sqnorm(const int latticeVolume, const ComplexNumbers alphaIn, int numEqsIn)
{
    std::vector<double> alpha;
    for (int i = 0; i < numEqsIn; i++)
        alpha.push_back((alphaIn.at(0).re + i * alphaIn.at(0).im) * (alphaIn.at(0).re + i * alphaIn.at(0).im));
...
struct LinearCombinationTestParameters : public SpinorStaggeredTestParameters {
    LinearCombinationTestParameters(const LatticeExtents latticeExtentsIn, const SpinorFillTypes fillTypesIn)
        ...
        , SpinorStaggeredTestParameters(latticeExtentsIn, fillTypesIn)
        , numberOfSpinors(1){};
    LinearCombinationTestParameters(const LatticeExtents latticeExtentsIn, const SpinorFillTypes fillTypesIn,
                                    const ComplexNumbers cN, const size_t numberOfSpinorsIn)
        : TestParameters(latticeExtentsIn)
        , SpinorStaggeredTestParameters(latticeExtentsIn, fillTypesIn)
        , complexCoefficients(cN)
        , numberOfSpinors(numberOfSpinorsIn){};
    LinearCombinationTestParameters(const LatticeExtents latticeExtentsIn, const SpinorFillTypes fillTypesIn,
                                    const RealNumbers rN, const size_t numberOfSpinorsIn)
        : TestParameters(latticeExtentsIn)
        , SpinorStaggeredTestParameters(latticeExtentsIn, fillTypesIn)
        , realCoefficients(rN)
        , numberOfSpinors(numberOfSpinorsIn){};
...
struct SaxVecAndSqnormEvenOddTestParameters : public SpinorStaggeredTestParameters {
    SaxVecAndSqnormEvenOddTestParameters(const LatticeExtents latticeExtentsIn, const ComplexNumbers coefficientsIn,
                                         const int numEqsIn)
        : TestParameters(latticeExtentsIn)
...
template<typename TesterClass, typename ParameterClass>
void callTest(const ParameterClass parametersForThisTest, const bool needEvenOdd)
{
    hardware::HardwareParametersMockup hardwareParameters(parametersForThisTest.latticeExtents, needEvenOdd);
    hardware::code::OpenClKernelParametersMockupForSpinorStaggered
        kernelParameters(parametersForThisTest.latticeExtents, needEvenOdd);
    ParameterCollection parameterCollection{hardwareParameters, kernelParameters};
    TesterClass(parameterCollection, parametersForThisTest);
}

template<typename TesterClass>
void performTest(LatticeExtents latticeExtendsIn, const SpinorFillTypes fillTypesIn, const bool needEvenOdd)
{
...
template<typename TesterClass>
void performTest(LatticeExtents latticeExtendsIn, const ComplexNumbers alphaIn, const int numberOfSpinors,
                 const bool needEvenOdd)
{
    LinearCombinationTestParameters parametersForThisTest(latticeExtendsIn,
                                                          SpinorFillTypes{SpinorFillType::ascendingComplex}, alphaIn,
                                                          numberOfSpinors);
    callTest<TesterClass, LinearCombinationTestParameters>(parametersForThisTest, needEvenOdd);
}

template<typename TesterClass>
void performTest(LatticeExtents latticeExtendsIn, const RealNumbers alphaIn, const int numberOfSpinors,
                 const bool needEvenOdd)
{
    LinearCombinationTestParameters parametersForThisTest(latticeExtendsIn,
                                                          SpinorFillTypes{SpinorFillType::ascendingComplex}, alphaIn,
...
template<typename TesterClass>
void performTest(LatticeExtents latticeExtendsIn, const ComplexNumbers alphaIn, const int numEqsIn)
{
...
template<typename TesterClass>
void performTest(LatticeExtents latticeExtendsIn, const SpinorFillTypes sF, const ComplexNumbers alphaIn,
                 const int numberOfSpinors, const bool needEvenOdd)
{
...
template<typename TesterClass>
void performTest(LatticeExtents latticeExtendsIn, const bool fillEvenSitesIn)
{
    ...
    hardware::code::OpenClKernelParametersMockupForSpinorStaggered
        kernelParameters(parametersForThisTest.latticeExtents, true);
    ParameterCollection parameterCollection{hardwareParameters, kernelParameters};
...
struct NonEvenOddLinearCombinationTester : public NonEvenOddSpinorStaggeredTester {
    NonEvenOddLinearCombinationTester(const std::string kernelName, const ParameterCollection pC,
                                      const LinearCombinationTestParameters tP,
                                      const ReferenceValues (*rV)(const int, const ComplexNumbers))
        : NonEvenOddSpinorStaggeredTester(kernelName, pC, tP,
                                          rV(calculateSpinorfieldSize(tP.latticeExtents), tP.complexCoefficients))
    {
        loadCoefficients(tP);
        loadSpinorfields(tP);
    }
    NonEvenOddLinearCombinationTester(const std::string kernelName, const ParameterCollection pC,
                                      const LinearCombinationTestParameters tP, const ReferenceValues rV)
  ...
  protected:
    ...
    const hardware::buffers::Plain<su3vec>* getOutSpinor() const { return spinorfields.back(); }
...
struct NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult : public NonEvenOddLinearCombinationTester {
    NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult(
        const std::string kernelName, const ParameterCollection pC, const LinearCombinationTestParameters tP,
        const ReferenceValues (*rV)(const int, const SpinorFillTypes))
        : NonEvenOddLinearCombinationTester(kernelName, pC, tP,
                                            rV(calculateSpinorfieldSize(tP.latticeExtents), tP.fillTypes))
    {
    }
    NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult(
        const std::string kernelName, const ParameterCollection pC, const LinearCombinationTestParameters tP,
    ...
    NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult(const std::string kernelName,
                                                                  const ParameterCollection pC,
                                                                  const LinearCombinationTestParameters tP,
...
struct EvenOddLinearCombinationTester : public EvenOddSpinorStaggeredTester {
    EvenOddLinearCombinationTester(const std::string kernelName, const ParameterCollection pC,
                                   const LinearCombinationTestParameters tP,
                                   const ReferenceValues (*rV)(const int, const SpinorFillTypes))
        : EvenOddSpinorStaggeredTester(kernelName, pC, tP,
                                       rV(calculateEvenOddSpinorfieldSize(tP.latticeExtents), tP.fillTypes))
    {
        loadCoefficients(tP);
        loadSpinorfields(tP);
    }
    EvenOddLinearCombinationTester(const std::string kernelName, const ParameterCollection pC,
                                   ...
                                   const ReferenceValues (*rV)(const int, const ComplexNumbers))
        : EvenOddSpinorStaggeredTester(kernelName, pC, tP,
                                       rV(calculateEvenOddSpinorfieldSize(tP.latticeExtents), tP.complexCoefficients))
    {
        loadCoefficients(tP);
        loadSpinorfields(tP);
    }
    EvenOddLinearCombinationTester(const std::string kernelName, const ParameterCollection pC,
                                   const LinearCombinationTestParameters tP,
                                   const ReferenceValues (*rV)(const int, const RealNumbers))
        : EvenOddSpinorStaggeredTester(kernelName, pC, tP,
                                       rV(calculateEvenOddSpinorfieldSize(tP.latticeExtents), tP.realCoefficients))
    {
        loadCoefficients(tP);
        loadSpinorfields(tP);
    }
  ...
  protected:
    ...
    const hardware::buffers::SU3vec* getOutSpinor() const { return spinorfields.back(); }
...
struct EvenOddLinearCombinationTesterWithSquarenormAsKernelResult : public EvenOddLinearCombinationTester {
    ...
    EvenOddLinearCombinationTesterWithSquarenormAsKernelResult(const std::string kernelName,
                                                               const ParameterCollection pC,
                                                               const LinearCombinationTestParameters tP,
                                                               const ReferenceValues rV)
        : EvenOddLinearCombinationTester(kernelName, pC, tP, rV)
...
struct SquarenormTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SquarenormTester(const ParameterCollection& parameterCollection,
                     const LinearCombinationTestParameters& testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("squarenorm", parameterCollection,
                                                                        testParameters,
                                                                        calculateReferenceValues_squarenorm)
    {
    }
};

struct ScalarProductTester : public NonEvenOddLinearCombinationTester {
    ScalarProductTester(const ParameterCollection& parameterCollection,
                        const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTester("scalar_product", parameterCollection, testParameters,
                                            calculateReferenceValues_scalarProduct(calculateSpinorfieldSize(
                                                                                       testParameters.latticeExtents),
                                                                                   testParameters.fillTypes))
    {
...
struct ZeroTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    ZeroTester(const ParameterCollection& parameterCollection, const LinearCombinationTestParameters& testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("zero", parameterCollection, testParameters,
                                                                        calculateReferenceValues_zero())
    {
...
struct ColdTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    ColdTester(const ParameterCollection& parameterCollection, const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("cold", parameterCollection, testParameters,
                                                                        calculateReferenceValues_cold(false))
    {
...
struct SaxTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxTester(const ParameterCollection& parameterCollection, const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax", parameterCollection, testParameters,
                                                                        calculateReferenceValues_sax)
    {
...
struct SaxpyTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyTester(const ParameterCollection& parameterCollection, const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy", parameterCollection, testParameters,
                                                                        calculateReferenceValues_saxpy)
    {
...
struct SaxpbypzTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbypzTester(const ParameterCollection& parameterCollection, const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpbypz", parameterCollection, testParameters,
                                                                        calculateReferenceValues_saxpbypz)
    {
        code->saxpbypz_device(spinorfields.at(0), spinorfields.at(1), spinorfields.at(3), complexNums.at(0),
                              complexNums.at(1), getOutSpinor());
    }
};

struct ConvertToEvenOddTester : public SpinorStaggeredTester {
    ConvertToEvenOddTester(const ParameterCollection& parameterCollection, SpinorStaggeredTestParameters testParameters,
                           const bool fillEvenSitesIn)
        : SpinorStaggeredTester("convert_to_eo", parameterCollection, testParameters,
                                calculateReferenceValues_convert_eo(calculateEvenOddSpinorfieldSize(
                                                                        testParameters.latticeExtents),
                                                                    fillEvenSitesIn))
    {
...
struct ConvertFromEvenOddTester : public SpinorStaggeredTester {
    ConvertFromEvenOddTester(const ParameterCollection& parameterCollection,
                             SpinorStaggeredTestParameters testParameters, const bool fillEvenSitesIn)
        : SpinorStaggeredTester("convert_from_eo", parameterCollection, testParameters,
                                calculateReferenceValues_convertFromEvenOdd(
                                    calculateSpinorfieldSize(testParameters.latticeExtents)))
    {
        const hardware::buffers::Plain<su3vec> in(calculateSpinorfieldSize(testParameters.latticeExtents), device);
        const hardware::buffers::SU3vec in2(testParameters.latticeExtents, device);
        const hardware::buffers::SU3vec in3(testParameters.latticeExtents, device);
...
struct SquarenormEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SquarenormEvenOddTester(const ParameterCollection& parameterCollection,
                            const LinearCombinationTestParameters& testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("squarenorm_eo", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_squarenorm)
    {
    }
...
struct ScalarProductEvenOddRealTester : public EvenOddLinearCombinationTester {
    ScalarProductEvenOddRealTester(const ParameterCollection& parameterCollection,
                                   const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTester("scalar_product_real_eo", parameterCollection, testParameters,
                                         calculateReferenceValues_scalarProduct)
    {
...
struct ScalarProductEvenOddComplexTester : public EvenOddLinearCombinationTester {
    ScalarProductEvenOddComplexTester(const ParameterCollection& parameterCollection,
                                      const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTester("scalar_product_real_eo", parameterCollection, testParameters,
                                         calculateReferenceValues_scalarProduct)
    {
...
struct ZeroEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    ZeroEvenOddTester(const ParameterCollection& parameterCollection,
                      const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("zero_eo", parameterCollection, testParameters,
                                                                     calculateReferenceValues_zero())
    {
...
struct ColdEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    ColdEvenOddTester(const ParameterCollection& parameterCollection,
                      const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("cold_eo", parameterCollection, testParameters,
                                                                     calculateReferenceValues_cold(true))
    {
...
struct SaxEvenOddComplexTester : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxEvenOddComplexTester(const ParameterCollection& parameterCollection,
                            const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax_eo_complex", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_sax(calculateEvenOddSpinorfieldSize(
                                                                                                      testParameters
                                                                                                          .latticeExtents),
                                                                                                  testParameters
                                                                                                      .complexCoefficients))
...
struct SaxArgEvenOddComplexTester : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxArgEvenOddComplexTester(const ParameterCollection& parameterCollection,
                               const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax_arg_eo_complex", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_sax(calculateEvenOddSpinorfieldSize(
                                                                                                      testParameters
                                                                                                          .latticeExtents),
...
struct SaxEvenOddRealTester : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxEvenOddRealTester(const ParameterCollection& parameterCollection,
                         const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax_eo_real", parameterCollection, testParameters,
                                                                     calculateReferenceValues_sax(calculateEvenOddSpinorfieldSize(
                                                                                                      testParameters
                                                                                                          .latticeExtents),
                                                                                                  testParameters
...
struct SaxArgEvenOddRealTester : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxArgEvenOddRealTester(const ParameterCollection& parameterCollection,
                            const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax_arg_eo_real", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_sax(calculateEvenOddSpinorfieldSize(
                                                                                                      testParameters
                                                                                                          .latticeExtents),
...
struct SaxVecEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxVecEvenOddTester(const ParameterCollection& parameterCollection,
                        const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax_eo_vec", parameterCollection, testParameters,
                                                                     calculateReferenceValues_sax(calculateEvenOddSpinorfieldSize(
                                                                                                      testParameters
                                                                                                          .latticeExtents),
                                                                                                  testParameters
...
struct SaxpyEvenOddComplexTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyEvenOddComplexTester(const ParameterCollection& parameterCollection,
                              const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_eo_complex", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_saxpy(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
                                                                                                            .latticeExtents),
                                                                                                    testParameters
                                                                                                        .complexCoefficients))
...
struct SaxpyArgEvenOddComplexTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyArgEvenOddComplexTester(const ParameterCollection& parameterCollection,
                                 const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_arg_eo_complex", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_saxpy(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
                                                                                                            .latticeExtents),
                                                                                                    testParameters
                                                                                                        .complexCoefficients))
    {
        code->saxpy_eoprec_device(spinorfields.at(0), spinorfields.at(1), testParameters.complexCoefficients.at(0),
                                  getOutSpinor());
    }
};

struct SaxpyEvenOddRealTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyEvenOddRealTester(const ParameterCollection& parameterCollection,
                           const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_eo_real", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_saxpy(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
                                                                                                            .latticeExtents),
...
struct SaxpyArgEvenOddRealTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyArgEvenOddRealTester(const ParameterCollection& parameterCollection,
                              const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_arg_eo_real", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_saxpy(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
                                                                                                            .latticeExtents),
                                                                                                    testParameters
                                                                                                        .realCoefficients))
    {
        code->saxpy_eoprec_device(spinorfields.at(0), spinorfields.at(1), testParameters.realCoefficients.at(0),
                                  getOutSpinor());
    }
};

struct SaxpyVecEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyVecEvenOddTester(const ParameterCollection& parameterCollection,
                          const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax_eo_vec", parameterCollection, testParameters,
                                                                     calculateReferenceValues_saxpy(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
...
struct SaxpbyEvenOddComplexTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbyEvenOddComplexTester(const ParameterCollection& parameterCollection,
                               const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpby_eo_complex", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValue_saxpby(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
                                                                                                            .latticeExtents),
                                                                                                    testParameters
                                                                                                        .complexCoefficients))
    {
        code->saxpby_eoprec_device(spinorfields.at(0), spinorfields.at(1), complexNums.at(0), complexNums.at(1),
                                   getOutSpinor());
    }
};

struct SaxpbyArgEvenOddComplexTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbyArgEvenOddComplexTester(const ParameterCollection& parameterCollection,
                                  const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpby_arg_eo_complex", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValue_saxpby(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
                                                                                                            .latticeExtents),
                                                                                                    testParameters
                                                                                                        .complexCoefficients))
    {
        code->saxpby_eoprec_device(spinorfields.at(0), spinorfields.at(1), testParameters.complexCoefficients.at(0),
                                   testParameters.complexCoefficients.at(1), getOutSpinor());
    }
};

struct SaxpbyEvenOddRealTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbyEvenOddRealTester(const ParameterCollection& parameterCollection,
                            const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpby_eo_real", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValue_saxpby(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
                                                                                                            .latticeExtents),
                                                                                                        ...
                                                                                                        .realCoefficients))
    {
        ...
        code->saxpby_eoprec_device(spinorfields.at(0), spinorfields.at(1), realNums.at(0), realNums.at(1),
                                   getOutSpinor());
    }
};

struct SaxpbyArgEvenOddRealTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbyArgEvenOddRealTester(const ParameterCollection& parameterCollection,
                               const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpby_arg_eo_real", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValue_saxpby(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
                                                                                                            .latticeExtents),
                                                                                                    testParameters
                                                                                                        .realCoefficients))
    {
        code->saxpby_eoprec_device(spinorfields.at(0), spinorfields.at(1), testParameters.realCoefficients.at(0),
                                   testParameters.realCoefficients.at(1), getOutSpinor());
    }
};

struct SaxpbyVecEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbyVecEvenOddTester(const ParameterCollection parameterCollection,
                           const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpby_eo_vec", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValue_saxpby(calculateEvenOddSpinorfieldSize(
                                                                                                        testParameters
                                                                                                            .latticeExtents),
                                                                                                        ...
                                                                                                        .realCoefficients))
    {
        ...
        code->saxpby_eoprec_device(spinorfields.at(0), spinorfields.at(1), &alpha_real_vec, &beta_real_vec, index_alpha,
                                   index_beta, getOutSpinor());
    }
};

struct SaxpbypzEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbypzEvenOddTester(const ParameterCollection& parameterCollection,
                          LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpbypz_eo", parameterCollection, testParameters,
                                                                     calculateReferenceValues_saxpbypz)
    {
        code->saxpbypz_eoprec_device(spinorfields.at(0), spinorfields.at(1), spinorfields.at(2), complexNums.at(0),
                                     complexNums.at(1), getOutSpinor());
    }
};

struct SaxpbypzArgEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbypzArgEvenOddTester(const ParameterCollection& parameterCollection,
                             LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpbypz_arg_eo", parameterCollection,
                                                                     testParameters, calculateReferenceValues_saxpbypz)
    {
        code->saxpbypz_eoprec_device(spinorfields.at(0), spinorfields.at(1), spinorfields.at(2),
                                     testParameters.complexCoefficients.at(0), testParameters.complexCoefficients.at(1),
                                     getOutSpinor());
    }
};

struct SaxVecAndSqnormEvenOddTester : public EvenOddSpinorStaggeredTester {
    SaxVecAndSqnormEvenOddTester(const ParameterCollection& parameterCollection,
                                 const SaxVecAndSqnormEvenOddTestParameters testParameters)
        : EvenOddSpinorStaggeredTester("sax_vectorized_and_squarenorm_eoprec", parameterCollection, testParameters,
                                       calculateReferenceValue_sax_vec_and_sqnorm(calculateEvenOddSpinorfieldSize(
                                                                                      testParameters.latticeExtents),
                                                                                  testParameters.coefficients,
                                                                                  testParameters.numEqs))
    {
...
struct NonEvenOddGaussianStaggeredSpinorfieldTester : public PrngSpinorStaggeredTester {
    NonEvenOddGaussianStaggeredSpinorfieldTester(const ParameterCollection& parameterCollection,
                                                 const PrngSpinorStaggeredTestParameters testParameters)
        : PrngSpinorStaggeredTester("generate_gaussian_staggeredspinorfield", parameterCollection, testParameters,
                                    calculateSpinorfieldSize(testParameters.latticeExtents),
                                    calculateReferenceValues_gaussian())
    {
    }
...
struct EvenOddGaussianStaggeredSpinorfieldTester : public PrngSpinorStaggeredTester {
    EvenOddGaussianStaggeredSpinorfieldTester(const ParameterCollection& parameterCollection,
                                              const PrngSpinorStaggeredTestParameters testParameters)
        : PrngSpinorStaggeredTester("generate_gaussian_staggeredspinorfield", parameterCollection, testParameters,
                                    calculateEvenOddSpinorfieldSize(testParameters.latticeExtents),
                                    calculateReferenceValues_gaussian())
    {
    }
...
BOOST_AUTO_TEST_SUITE(SCALAR_PRODUCT)
    ...
    {
        testNonEvenOddScalarProduct(LatticeExtents{ns4, nt4},
                                    SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_2)
    {
        testNonEvenOddScalarProduct(LatticeExtents{ns4, nt4}, SpinorFillTypes{SpinorFillType::ascendingComplex,
                                                                              SpinorFillType::ascendingComplex});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REDUCTION_1)
    {
        testNonEvenOddScalarProduct(LatticeExtents{ns8, nt8},
                                    SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REDUCTION_2)
    {
        testNonEvenOddScalarProduct(LatticeExtents{ns12, nt12},
                                    SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REDUCTION_3)
    {
        testNonEvenOddScalarProduct(LatticeExtents{ns16, nt16},
                                    SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }
...
BOOST_AUTO_TEST_SUITE(ZERO)
    ...
    BOOST_AUTO_TEST_CASE(ZERO_1) { testNonEvenOddZero(LatticeExtents{ns4, nt4}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(COLD)

    BOOST_AUTO_TEST_CASE(COLD_1) { testNonEvenOddCold(LatticeExtents{ns4, nt4}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(SAX)

    BOOST_AUTO_TEST_CASE(SAX_1) { testNonEvenOddSax(LatticeExtents{ns4, nt4}, ComplexNumbers{{0., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAX_2) { testNonEvenOddSax(LatticeExtents{ns8, nt4}, ComplexNumbers{{1., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAX_3) { testNonEvenOddSax(LatticeExtents{ns4, nt8}, ComplexNumbers{{0., 1.}}); }

    BOOST_AUTO_TEST_CASE(SAX_4) { testNonEvenOddSax(LatticeExtents{ns16, nt4}, ComplexNumbers{{1., 1.}}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(SAXPY)

    BOOST_AUTO_TEST_CASE(SAXPY_1) { testNonEvenOddSaxpy(LatticeExtents{ns4, nt4}, ComplexNumbers{{0., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_2) { testNonEvenOddSaxpy(LatticeExtents{ns8, nt4}, ComplexNumbers{{1., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_3) { testNonEvenOddSaxpy(LatticeExtents{ns4, nt8}, ComplexNumbers{{0., 1.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_4) { testNonEvenOddSaxpy(LatticeExtents{ns8, nt8}, ComplexNumbers{{1., 1.}}); }
...
BOOST_AUTO_TEST_SUITE(GAUSSIAN)
    ...
    BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(GAUSSIAN_1, 8)  // 6 failures (3 for the mean, 3 for the variance) could
                                                           // arise in the Kolmogorov-Smirnov test

    BOOST_AUTO_TEST_CASE(GAUSSIAN_1) { testNonEvenOddGaussianSpinorfield(LatticeExtents{ns8, nt4}, 1000); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(CONVERT_EO)

    BOOST_AUTO_TEST_CASE(CONVERT_EO_1) { testConvertToEvenOdd(LatticeExtents{ns4, nt4}, true); }

    BOOST_AUTO_TEST_CASE(CONVERT_EO_2) { testConvertToEvenOdd(LatticeExtents{ns8, nt4}, false); }

    BOOST_AUTO_TEST_CASE(CONVERT_EO_3) { testConvertFromEvenOdd(LatticeExtents{ns4, nt4}, true); }

    BOOST_AUTO_TEST_CASE(CONVERT_EO_4) { testConvertFromEvenOdd(LatticeExtents{ns8, nt4}, false); }
...
BOOST_AUTO_TEST_SUITE(SCALAR_PRODUCT_EO)
    ...
    {
        testEvenOddScalarProductComplex(LatticeExtents{ns8, nt4},
                                        SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_EO_2)
    {
        testEvenOddScalarProductComplex(LatticeExtents{ns4, nt12},
                                        SpinorFillTypes{SpinorFillType::one, SpinorFillType::ascendingComplex});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_EO_3)
    {
        testEvenOddScalarProductComplex(LatticeExtents{ns8, nt8},
                                        SpinorFillTypes{SpinorFillType::ascendingComplex, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_EO_4)
    {
        testEvenOddScalarProductComplex(LatticeExtents{ns4, nt4}, SpinorFillTypes{SpinorFillType::ascendingComplex,
                                                                                  SpinorFillType::ascendingComplex});
    }
    ...
    {
        testEvenOddScalarProductComplex(LatticeExtents{ns12, nt12},
                                        SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_EO_REDUCTION_3)
    {
        testEvenOddScalarProductComplex(LatticeExtents{ns16, nt16},
                                        SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REAL_EO_1)
    {
        testEvenOddScalarProductReal(LatticeExtents{ns8, nt4},
                                     SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REAL_EO_2)
    {
        testEvenOddScalarProductReal(LatticeExtents{ns4, nt4}, SpinorFillTypes{SpinorFillType::ascendingComplex,
                                                                               SpinorFillType::ascendingComplex});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REAL_EO_REDUCTION_1)
    {
        testEvenOddScalarProductReal(LatticeExtents{ns8, nt8},
                                     SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REAL_EO_REDUCTION_2)
    {
        testEvenOddScalarProductReal(LatticeExtents{ns12, nt12},
                                     SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REAL_EO_REDUCTION_3)
    {
        testEvenOddScalarProductReal(LatticeExtents{ns16, nt16},
                                     SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }
...
BOOST_AUTO_TEST_SUITE(ZERO_EO)
    ...
    BOOST_AUTO_TEST_CASE(ZERO_EO_1) { testEvenOddZero(LatticeExtents{ns4, nt4}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(COLD_EO)

    BOOST_AUTO_TEST_CASE(COLD_EO_1) { testEvenOddCold(LatticeExtents{ns4, nt4}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(SAX_EO)

    BOOST_AUTO_TEST_CASE(SAX_CPLX_EO_1) { testEvenOddSaxComplex(LatticeExtents{ns4, nt4}, ComplexNumbers{{0., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAX_CPLX_EO_2) { testEvenOddSaxComplex(LatticeExtents{ns8, nt4}, ComplexNumbers{{1., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAX_CPLX_EO_3) { testEvenOddSaxComplex(LatticeExtents{ns4, nt8}, ComplexNumbers{{0., 1.}}); }

    BOOST_AUTO_TEST_CASE(SAX_CPLX_EO_4) { testEvenOddSaxComplex(LatticeExtents{ns16, nt8}, ComplexNumbers{{1., -1.}}); }
    ...
    BOOST_AUTO_TEST_CASE(SAX_REAL_EO_1) { testEvenOddSaxReal(LatticeExtents{ns4, nt4}, RealNumbers{0.}); }

    BOOST_AUTO_TEST_CASE(SAX_REAL_EO_2) { testEvenOddSaxReal(LatticeExtents{ns8, nt4}, RealNumbers{1.}); }

    BOOST_AUTO_TEST_CASE(SAX_REAL_EO_3) { testEvenOddSaxReal(LatticeExtents{ns4, nt8}, RealNumbers{-1.}); }

    BOOST_AUTO_TEST_CASE(SAX_ARG_REAL_EO_1) { testEvenOddSaxArgReal(LatticeExtents{ns4, nt4}, RealNumbers{0.}); }

    BOOST_AUTO_TEST_CASE(SAX_ARG_REAL_EO_2) { testEvenOddSaxArgReal(LatticeExtents{ns8, nt4}, RealNumbers{1.}); }

    BOOST_AUTO_TEST_CASE(SAX_ARG_REAL_EO_3) { testEvenOddSaxArgReal(LatticeExtents{ns4, nt8}, RealNumbers{-1.}); }

    BOOST_AUTO_TEST_CASE(SAX_REAL_VEC_EO_1) { testEvenOddSaxVecReal(LatticeExtents{ns4, nt4}, RealNumbers{1.}); }

    BOOST_AUTO_TEST_CASE(SAX_REAL_VEC_EO_2) { testEvenOddSaxVecReal(LatticeExtents{ns8, nt4}, RealNumbers{1.}); }

    BOOST_AUTO_TEST_CASE(SAX_REAL_VEC_EO_3) { testEvenOddSaxVecReal(LatticeExtents{ns4, nt8}, RealNumbers{-1.}); }
...
BOOST_AUTO_TEST_SUITE(SAXPY_EO)
    ...
    BOOST_AUTO_TEST_CASE(SAXPY_REAL_EO_1) { testEvenOddSaxpyReal(LatticeExtents{ns4, nt4}, RealNumbers{0.}); }

    BOOST_AUTO_TEST_CASE(SAXPY_REAL_EO_2) { testEvenOddSaxpyReal(LatticeExtents{ns8, nt4}, RealNumbers{1.}); }

    BOOST_AUTO_TEST_CASE(SAXPY_REAL_EO_3) { testEvenOddSaxpyReal(LatticeExtents{ns4, nt8}, RealNumbers{-1.}); }

    BOOST_AUTO_TEST_CASE(SAXPY_ARG_REAL_EO_1) { testEvenOddSaxpyArgReal(LatticeExtents{ns4, nt4}, RealNumbers{0.}); }

    BOOST_AUTO_TEST_CASE(SAXPY_ARG_REAL_EO_2) { testEvenOddSaxpyArgReal(LatticeExtents{ns8, nt4}, RealNumbers{1.}); }

    BOOST_AUTO_TEST_CASE(SAXPY_ARG_REAL_EO_3) { testEvenOddSaxpyArgReal(LatticeExtents{ns4, nt8}, RealNumbers{-1.}); }

    BOOST_AUTO_TEST_CASE(SAXPY_REAL_VEC_EO_1) { testEvenOddSaxpyVecReal(LatticeExtents{ns4, nt4}, RealNumbers{0.}); }

    BOOST_AUTO_TEST_CASE(SAXPY_REAL_VEC_EO_2) { testEvenOddSaxpyVecReal(LatticeExtents{ns8, nt4}, RealNumbers{1.}); }

    BOOST_AUTO_TEST_CASE(SAXPY_REAL_VEC_EO_3) { testEvenOddSaxpyVecReal(LatticeExtents{ns4, nt8}, RealNumbers{-1.}); }
...
BOOST_AUTO_TEST_SUITE(SAXPBY_EO)
    ...
    BOOST_AUTO_TEST_CASE(SAXPBY_REAL_EO_1) { testEvenOddSaxpbyReal(LatticeExtents{ns4, nt4}, RealNumbers{{0.}, {0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPBY_REAL_EO_2) { testEvenOddSaxpbyReal(LatticeExtents{ns8, nt4}, RealNumbers{{1.}, {0.}}); }
...
BOOST_AUTO_TEST_SUITE(GAUSSIAN_EO)
    ...
    BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(GAUSSIAN_EO_1, 8)  // 6 failures (3 for the mean, 3 for the variance) could
                                                              // arise in the Kolmogorov-Smirnov test
