...
void hardware::code::Spinors_staggered::fill_kernels()
{
	...
	global_squarenorm_reduction_stagg = createKernel("global_squarenorm_reduction") << fundamental_sources << "types.hpp" << "spinorfield_staggered_squarenorm_reduction.cl";
	scalar_product_reduction_stagg = createKernel("scalar_product_reduction") << fundamental_sources << "types.hpp" << "operations_complex.hpp" << "spinorfield_staggered_scalar_product_reduction.cl";
	scalar_product_real_reduction_stagg = createKernel("scalar_product_real_reduction") << fundamental_sources << "types.hpp" << "operations_complex.hpp" << "spinorfield_staggered_scalar_product_reduction.cl";
