...
void hardware::code::Spinors_staggered::fill_kernels()
{
    ...
    basic_fermion_code = get_basic_sources() << "operations_geometry.cl"
    ...
    global_squarenorm_reduction_stagg = createKernel("global_squarenorm_reduction")
                                        << fundamental_sources << "types.hpp"
                                        << "spinorfield_staggered_squarenorm_reduction.cl";
    scalar_product_reduction_stagg = createKernel("scalar_product_reduction")
                                     << fundamental_sources << "types.hpp"
                                     << "operations_complex.hpp"
                                     << "spinorfield_staggered_scalar_product_reduction.cl";
    scalar_product_real_reduction_stagg = createKernel("scalar_product_real_reduction")
                                          << fundamental_sources << "types.hpp"
                                          << "operations_complex.hpp"
                                          << "spinorfield_staggered_scalar_product_reduction.cl";
    ...
    if (kernelParameters->getUseEo()) {
        ...
        convert_from_eoprec_stagg = createKernel("convert_from_eoprec_staggered")
                                    << basic_fermion_code << "spinorfield_staggered_eo_convert.cl";
        convert_to_eoprec_stagg = createKernel("convert_to_eoprec_staggered")
                                  << basic_fermion_code << "spinorfield_staggered_eo_convert.cl";
        // Functionalities to switch from AoS to SoA and viceversa
        convert_staggered_field_to_SoA_eo = createKernel("convert_staggered_field_to_SoA_eo")
                                            << basic_fermion_code << "spinorfield_staggered_eo_convert.cl";
        convert_staggered_field_from_SoA_eo = createKernel("convert_staggered_field_from_SoA_eo")
                                              << basic_fermion_code << "spinorfield_staggered_eo_convert.cl";
        // Squarenorm
        global_squarenorm_stagg_eoprec = createKernel("global_squarenorm_staggered_eoprec")
                                         << basic_fermion_code << "spinorfield_staggered_eo_squarenorm.cl";
        // Scalar Product
        scalar_product_stagg_eoprec = createKernel("scalar_product_staggered_eoprec")
                                      << basic_fermion_code << "spinorfield_staggered_eo_scalar_product.cl";
        scalar_product_real_part_stagg_eoprec = createKernel("scalar_product_real_part_staggered_eoprec")
                                                << basic_fermion_code
                                                << "spinorfield_staggered_eo_scalar_product_real_part.cl";
        // Setting fields
        set_zero_spinorfield_stagg_eoprec = createKernel("set_zero_spinorfield_stagg_eoprec")
                                            << basic_fermion_code << "spinorfield_staggered_eo_set_zero.cl";
        set_cold_spinorfield_stagg_eoprec = createKernel("set_cold_spinorfield_stagg_eoprec")
                                            << basic_fermion_code << "spinorfield_staggered_eo_set_cold.cl";
        set_gaussian_spinorfield_stagg_eoprec = createKernel("set_gaussian_spinorfield_stagg_eoprec")
                                                << basic_fermion_code << prng_code
                                                << "spinorfield_staggered_eo_gaussian.cl";
        // Fields algebra operations
        sax_cplx_stagg_eoprec = createKernel("sax_cplx_staggered_eoprec")
                                << basic_fermion_code << "spinorfield_staggered_eo_sax_cplx.cl";
        sax_real_stagg_eoprec = createKernel("sax_real_staggered_eoprec")
                                << basic_fermion_code << "spinorfield_staggered_eo_sax_real.cl";
        sax_real_vec_stagg_eoprec = createKernel("sax_real_vec_staggered_eoprec")
                                    << basic_fermion_code << "spinorfield_staggered_eo_sax_real_vec.cl";
        saxpy_cplx_stagg_eoprec = createKernel("saxpy_cplx_staggered_eoprec")
                                  << basic_fermion_code << "spinorfield_staggered_eo_saxpy_cplx.cl";
        saxpy_real_stagg_eoprec = createKernel("saxpy_real_staggered_eoprec")
                                  << basic_fermion_code << "spinorfield_staggered_eo_saxpy_real.cl";
        saxpy_real_vec_stagg_eoprec = createKernel("saxpy_real_vec_staggered_eoprec")
                                      << basic_fermion_code << "spinorfield_staggered_eo_saxpy_real_vec.cl";
        saxpby_cplx_stagg_eoprec = createKernel("saxpby_cplx_staggered_eoprec")
                                   << basic_fermion_code << "spinorfield_staggered_eo_saxpby_cplx.cl";
        saxpby_real_stagg_eoprec = createKernel("saxpby_real_staggered_eoprec")
                                   << basic_fermion_code << "spinorfield_staggered_eo_saxpby_real.cl";
        saxpby_real_vec_stagg_eoprec = createKernel("saxpby_real_vec_staggered_eoprec")
                                       << basic_fermion_code << "spinorfield_staggered_eo_saxpby_real_vec.cl";
        saxpbypz_cplx_stagg_eoprec = createKernel("saxpbypz_cplx_staggered_eoprec")
                                     << basic_fermion_code << "spinorfield_staggered_eo_saxpbypz_cplx.cl";
        // Fields algebra operations with non buffer arguments
        sax_cplx_arg_stagg_eoprec = createKernel("sax_cplx_arg_staggered_eoprec")
                                    << basic_fermion_code << "spinorfield_staggered_eo_sax_cplx.cl";
        sax_real_arg_stagg_eoprec = createKernel("sax_real_arg_staggered_eoprec")
                                    << basic_fermion_code << "spinorfield_staggered_eo_sax_real.cl";
        saxpy_cplx_arg_stagg_eoprec = createKernel("saxpy_cplx_arg_staggered_eoprec")
                                      << basic_fermion_code << "spinorfield_staggered_eo_saxpy_cplx.cl";
        saxpy_real_arg_stagg_eoprec = createKernel("saxpy_real_arg_staggered_eoprec")
                                      << basic_fermion_code << "spinorfield_staggered_eo_saxpy_real.cl";
        saxpby_cplx_arg_stagg_eoprec = createKernel("saxpby_cplx_arg_staggered_eoprec")
                                       << basic_fermion_code << "spinorfield_staggered_eo_saxpby_cplx.cl";
        saxpby_real_arg_stagg_eoprec = createKernel("saxpby_real_arg_staggered_eoprec")
                                       << basic_fermion_code << "spinorfield_staggered_eo_saxpby_real.cl";
        saxpbypz_cplx_arg_stagg_eoprec = createKernel("saxpbypz_cplx_arg_staggered_eoprec")
                                         << basic_fermion_code << "spinorfield_staggered_eo_saxpbypz_cplx.cl";
        // Mixed kernels
        sax_vectorized_and_squarenorm_reduction = createKernel("sax_vectorized_and_squarenorm_reduction")
                                                  << basic_fermion_code
                                                  << "spinorfield_staggered_eo_sax_AND_squarenorm.cl";
        sax_vectorized_and_squarenorm_eoprec = createKernel("sax_vectorized_and_squarenorm_eoprec")
                                               << basic_fermion_code
                                               << "spinorfield_staggered_eo_sax_AND_squarenorm.cl";
    } else {
        ...
        // Scalar Product
        scalar_product_stagg = createKernel("scalar_product_staggered")
                               << basic_fermion_code << "spinorfield_staggered_scalar_product.cl";
        // Setting fields
        set_zero_spinorfield_stagg = createKernel("set_zero_spinorfield_stagg")
                                     << basic_fermion_code << "spinorfield_staggered_set_zero.cl";
        set_cold_spinorfield_stagg = createKernel("set_cold_spinorfield_stagg")
                                     << basic_fermion_code << "spinorfield_staggered_set_cold.cl";
        set_gaussian_spinorfield_stagg = createKernel("set_gaussian_spinorfield_stagg")
                                         << basic_fermion_code << prng_code << "spinorfield_staggered_gaussian.cl";
        // Fields algebra operations
        ...
        saxpbypz_stagg = createKernel("saxpbypz_staggered")
                         << basic_fermion_code << "spinorfield_staggered_saxpbypz.cl";
    }
    // Squarenorm non_eo always built because needed in tests for conversion from eo to non eo
    global_squarenorm_stagg = createKernel("global_squarenorm_staggered")
                              << basic_fermion_code << "spinorfield_staggered_squarenorm.cl";
}
...
void hardware::code::Spinors_staggered::get_work_sizes(const cl_kernel kernel, size_t* ls, size_t* gs,
                                                       cl_uint* num_groups) const
{
    Opencl_Module::get_work_sizes(kernel, ls, gs, num_groups);

    // kernels that use random numbers must not exceed the size of the random state array
    if (kernel == set_gaussian_spinorfield_stagg || kernel == set_gaussian_spinorfield_stagg_eoprec) {
        if (*gs > hardware::buffers::get_prng_buffer_size(get_device(), kernelParameters->getUseSameRndNumbers())) {
            *gs = hardware::buffers::get_prng_buffer_size(get_device(), kernelParameters->getUseSameRndNumbers());
            logger.trace() << "I changed gs without changing neither ls nor num_groups (in "
                              "Spinors_staggered::get_work_sizes)!!!";
        }
    }
...
void hardware::code::Spinors_staggered::global_squarenorm_reduction(
    const hardware::buffers::Plain<hmc_float>* out, const hardware::buffers::Plain<hmc_float>* tmp_buf) const
{
...
void hardware::code::Spinors_staggered::set_float_to_global_squarenorm_device(
    const hardware::buffers::Plain<su3vec>* a, const hardware::buffers::Plain<hmc_float>* out) const
{
...
void hardware::code::Spinors_staggered::set_complex_to_scalar_product_device(
    const hardware::buffers::Plain<su3vec>* a, const hardware::buffers::Plain<su3vec>* b,
    const hardware::buffers::Plain<hmc_complex>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors_staggered::sax_device(const hardware::buffers::Plain<su3vec>* x,
                                                   const hardware::buffers::Plain<hmc_complex>* alpha,
                                                   const hardware::buffers::Plain<su3vec>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors_staggered::saxpy_device(const hardware::buffers::Plain<su3vec>* x,
                                                     const hardware::buffers::Plain<su3vec>* y,
                                                     const hardware::buffers::Plain<hmc_complex>* alpha,
                                                     const hardware::buffers::Plain<su3vec>* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Spinors_staggered::saxpbypz_device(const hardware::buffers::Plain<su3vec>* x,
                                                        const hardware::buffers::Plain<su3vec>* y,
                                                        const hardware::buffers::Plain<su3vec>* z,
                                                        const hardware::buffers::Plain<hmc_complex>* alpha,
...
void hardware::code::Spinors_staggered::set_gaussian_spinorfield_device(const hardware::buffers::Plain<su3vec>* in,
...
void hardware::code::Spinors_staggered::convert_staggered_field_from_SoA_eo_device(
    const hardware::buffers::Plain<su3vec>* out, const hardware::buffers::SU3vec* in) const
{
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors_staggered::convert_from_eoprec_device(const hardware::buffers::SU3vec* in1,
                                                                   const hardware::buffers::SU3vec* in2,
                                                                   const hardware::buffers::Plain<su3vec>* out) const
{
...
void hardware::code::Spinors_staggered::convert_to_eoprec_device(const hardware::buffers::SU3vec* out1,
                                                                 const hardware::buffers::SU3vec* out2,
...
void hardware::code::Spinors_staggered::set_float_to_global_squarenorm_eoprec_device(
    const hardware::buffers::SU3vec* a, const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors_staggered::set_complex_to_scalar_product_eoprec_device(
    const hardware::buffers::SU3vec* a, const hardware::buffers::SU3vec* b,
    const hardware::buffers::Plain<hmc_complex>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors_staggered::set_float_to_scalar_product_real_part_eoprec_device(
    const hardware::buffers::SU3vec* a, const hardware::buffers::SU3vec* b,
    const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
    ...
    clerr = clSetKernelArg(scalar_product_real_part_stagg_eoprec, 3, sizeof(hmc_float) * ls2,
...
void hardware::code::Spinors_staggered::sax_eoprec_device(const hardware::buffers::SU3vec* x,
                                                          const hardware::buffers::Plain<hmc_complex>* alpha,
                                                          const hardware::buffers::SU3vec* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors_staggered::sax_eoprec_device(const hardware::buffers::SU3vec* x, const hmc_complex alpha,
                                                          const hardware::buffers::SU3vec* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors_staggered::sax_eoprec_device(const hardware::buffers::SU3vec* x, const hmc_float alpha,
                                                          const hardware::buffers::SU3vec* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors_staggered::saxpy_eoprec_device(const hardware::buffers::SU3vec* x,
                                                            const hardware::buffers::SU3vec* y,
                                                            const hardware::buffers::Plain<hmc_complex>* alpha,
                                                            const hardware::buffers::SU3vec* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Spinors_staggered::saxpy_eoprec_device(const hardware::buffers::SU3vec* x,
                                                            const hardware::buffers::SU3vec* y, const hmc_complex alpha,
                                                            const hardware::buffers::SU3vec* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors_staggered::saxpy_eoprec_device(const hardware::buffers::SU3vec* x,
                                                            const hardware::buffers::SU3vec* y, const hmc_float alpha,
                                                            const hardware::buffers::SU3vec* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors_staggered::saxpby_eoprec_device(const hardware::buffers::SU3vec* x,
                                                             const hardware::buffers::SU3vec* y,
                                                             const hardware::buffers::Plain<hmc_complex>* alpha,
                                                             const hardware::buffers::Plain<hmc_complex>* beta,
                                                             const hardware::buffers::SU3vec* out) const
...
void hardware::code::Spinors_staggered::saxpby_eoprec_device(const hardware::buffers::SU3vec* x,
                                                             const hardware::buffers::SU3vec* y,
                                                             const hardware::buffers::Plain<hmc_float>* alpha,
                                                             const hardware::buffers::Plain<hmc_float>* beta,
                                                             const hardware::buffers::SU3vec* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors_staggered::saxpby_eoprec_device(const hardware::buffers::SU3vec* x,
                                                             const hardware::buffers::SU3vec* y,
                                                             const hmc_complex alpha, const hmc_complex beta,
                                                             const hardware::buffers::SU3vec* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors_staggered::saxpbypz_eoprec_device(const hardware::buffers::SU3vec* x,
                                                               const hardware::buffers::SU3vec* y,
                                                               const hardware::buffers::SU3vec* z,
                                                               const hardware::buffers::Plain<hmc_complex>* alpha,
                                                               const hardware::buffers::Plain<hmc_complex>* beta,
                                                               const hardware::buffers::SU3vec* out) const
{
...
void hardware::code::Spinors_staggered::set_gaussian_spinorfield_eoprec_device(
    const hardware::buffers::SU3vec* in, const hardware::buffers::PRNGBuffer* prng) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors_staggered::sax_vectorized_squarenorm_reduction(
    const hardware::buffers::Plain<hmc_float>* out, const hardware::buffers::Plain<hmc_float>* tmp_buf,
    const int numeqs) const
{
...
void hardware::code::Spinors_staggered::sax_vectorized_and_squarenorm_eoprec_device(
    const hardware::buffers::SU3vec* x, const hardware::buffers::Plain<hmc_float>* alpha, const int numeqs,
    const hardware::buffers::Plain<hmc_float>* out) const
{
    if (numeqs > std::max(kernelParameters->getMetroApproxOrd(), kernelParameters->getMdApproxOrd())) {
        throw Invalid_Parameters("In sax_vectorized_and_squarenorm_eoprec_device numeqs to big!!",
                                 "numeqs < " + to_string(std::max(kernelParameters->getMetroApproxOrd(),
    ...
    clerr = clSetKernelArg(sax_vectorized_and_squarenorm_eoprec, 4, sizeof(hmc_float) * ls2 * numeqs,
                           static_cast<void*>(nullptr));
    if (clerr != CL_SUCCESS)
        throw Opencl_Error(clerr, "clSetKernelArg", __FILE__, __LINE__);
...
size_t hardware::code::Spinors_staggered::get_read_write_size(const std::string& in) const
{
    ...
    if (in == "sax_vectorized_and_squarenorm_eoprec" || in == "sax_vectorized_and_squarenorm_reduction") {
        ...
        throw Print_Error_Message("Spinors_staggered::get_read_write_size entered with "
                                  "in=sax_vectorized_and_squarenorm_*!",
                                  __FILE__, __LINE__);
    }
...
uint64_t hardware::code::Spinors_staggered::get_flop_size(const std::string& in) const
{
    ...
    if (in == "global_squarenorm_reduction") {
        ...
        throw Print_Error_Message("Spinors_staggered::get_flop_size entered with in=global_squarenorm_reduction!",
                                  __FILE__, __LINE__);
    }
    if (in == "scalar_product_staggered") {
    ...
    if (in == "scalar_product_reduction" || in == "scalar_product_real_reduction") {
        // This if should not be entered since the sum of the site squarenorms
        // has already taken into account with the (S-1)*2 term in the previous if
        throw Print_Error_Message("Spinors_staggered::get_flop_size entered with in=scalar_product_reduction!",
                                  __FILE__, __LINE__);
    }
    if (in == "set_zero_spinorfield_stagg") {
    ...
    if (in == "sax_vectorized_and_squarenorm_eoprec" || in == "sax_vectorized_and_squarenorm_reduction") {
        ...
        throw Print_Error_Message("Spinors_staggered::get_flop_size entered with in=sax_vectorized_and_squarenorm_*!",
                                  __FILE__, __LINE__);
    }
