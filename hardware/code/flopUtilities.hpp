...
namespace hardware {
    namespace code {
        ...
        inline size_t getFlopComplexMult() noexcept { return 6; }
        inline size_t getFlopSu3MatrixTimesSu3Matrix() noexcept
        {
            return (getFlopComplexMult() * NC + (NC - 1) * 2) * NC * NC;
        }
        inline size_t getFlopSu3MatrixTrace() noexcept { return (NC - 1) * 2; }
        ...
        inline size_t getSu3AlgebraSize() noexcept { return NC * NC - 1; }
