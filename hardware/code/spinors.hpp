    ...
    namespace code {
        ...
        class Spinors : public Opencl_Module {
          public:
            ...
            /////////////////////////////////////////
            // device operations
            void generate_gaussian_spinorfield_device(const hardware::buffers::Plain<spinor>* in,
                                                      const hardware::buffers::PRNGBuffer* prng) const;
            void generate_gaussian_spinorfield_eo_device(const hardware::buffers::Spinor* in,
                                                         const hardware::buffers::PRNGBuffer* prng) const;

            //    linear Algebra operations
            void convert_from_eoprec_device(const hardware::buffers::Spinor* even, const hardware::buffers::Spinor* odd,
                                            const hardware::buffers::Plain<spinor>* out) const;
            void convert_to_eoprec_device(const hardware::buffers::Spinor* even, const hardware::buffers::Spinor* odd,
                                          const hardware::buffers::Plain<spinor>* in) const;

            void set_complex_to_scalar_product_device(const hardware::buffers::Plain<spinor>* a,
                                                      const hardware::buffers::Plain<spinor>* b,
                                                      const hardware::buffers::Plain<hmc_complex>* out) const;
            void set_complex_to_scalar_product_eoprec_device(const hardware::buffers::Spinor* a,
            ...
            void set_float_to_global_squarenorm_device(const hardware::buffers::Plain<spinor>* a,
                                                       const hardware::buffers::Plain<hmc_float>* out) const;
            void set_float_to_global_squarenorm_eoprec_device(const hardware::buffers::Spinor* a,
                                                              const hardware::buffers::Plain<hmc_float>* out) const;
            ...
            void saxpy_device(const hardware::buffers::Plain<spinor>* x, const hardware::buffers::Plain<spinor>* y,
                              const hardware::buffers::Plain<hmc_complex>* alpha,
                              const hardware::buffers::Plain<spinor>* out) const;
            void saxpy_device(const hardware::buffers::Plain<spinor>* x, const hardware::buffers::Plain<spinor>* y,
                              const hmc_complex alpha, const hardware::buffers::Plain<spinor>* out) const;
            void sax_device(const hardware::buffers::Plain<spinor>* x,
                            const hardware::buffers::Plain<hmc_complex>* alpha,
                            const hardware::buffers::Plain<spinor>* out) const;
            void saxsbypz_device(const hardware::buffers::Plain<spinor>* x, const hardware::buffers::Plain<spinor>* y,
                                 const hardware::buffers::Plain<spinor>* z,
                                 const hardware::buffers::Plain<hmc_complex>* alpha,
                                 const hardware::buffers::Plain<hmc_complex>* beta,
                                 const hardware::buffers::Plain<spinor>* out) const;
            void saxpy_eoprec_device(const hardware::buffers::Spinor* x, const hardware::buffers::Spinor* y,
                                     const hardware::buffers::Plain<hmc_complex>* alpha,
                                     const hardware::buffers::Spinor* out) const;
            void saxpy_eoprec_device(const hardware::buffers::Spinor* x, const hardware::buffers::Spinor* y,
                                     const hmc_complex alpha, const hardware::buffers::Spinor* out) const;
            void sax_eoprec_device(const hardware::buffers::Spinor* x,
                                   const hardware::buffers::Plain<hmc_complex>* alpha,
                                   const hardware::buffers::Spinor* out) const;
            void saxsbypz_eoprec_device(const hardware::buffers::Spinor* x, const hardware::buffers::Spinor* y,
            ...
            //    merged kernel calls
            void saxpy_AND_squarenorm_eo_device(const hardware::buffers::Spinor* x, const hardware::buffers::Spinor* y,
                                                const hardware::buffers::Plain<hmc_complex>* alpha,
             ...
             */
            void
            copy_to_eoprec_spinorfield_buffer(const hardware::buffers::Spinor* buf, const spinor* const source) const;
