...
enum CorrelatorDirection {
    temporal = 0,
    spatialX = 1,
    spatialY = 2,
    spatialZ = 3
};  //@todo: should this be name more general, "direction" or so, and be moved to common?
typedef std::string KernelIdentifier;

struct SourceTestParameters : public PrngSpinorTestParameters {
    SourceTestParameters(const LatticeExtents lE, common::sourcecontents sC, common::sourcetypes sT,
...
ReferenceValues calculateReferenceValues_volumeSource(const SourceTestParameters& tP)
{
    ...
    if (tP.sC == common::sourcecontents::one) {
        ...
        mean = 0.123456;
    variance = sqrt(normalize(((0. - mean) * (0. - mean) * 12 + (1. - mean) * (1. - mean) * 12) *
                                  calculateSpinorfieldSize(tP.latticeExtents),
                              tP.latticeExtents));
...
ReferenceValues calculateReferenceValues_zSliceSource(const SourceTestParameters& tP)
{
    double mean, variance;
    if (tP.sC == common::sourcecontents::one) {
        mean = normalize(12 * tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * tP.latticeExtents.getNt(),
                         tP.latticeExtents);
    } else if (tP.sC == common::sourcecontents::gaussian or tP.sC == common::sourcecontents::z4) {
        mean = 0.;
    } else
        mean = 0.123456;
    variance = sqrt(
        normalize((0. - mean) * (0. - mean) *
                          (tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * tP.latticeExtents.getNt() * 12) +
                      (1. - mean) * (1. - mean) *
                          (tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * tP.latticeExtents.getNt() * 12) +
                      (0. - mean) * (0. - mean) *
                          (calculateSpinorfieldSize(tP.latticeExtents) -
                           tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * tP.latticeExtents.getNt()) *
                          24,
                  tP.latticeExtents));
    return ReferenceValues{mean, variance,
                           (double)tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * tP.latticeExtents.getNt()};
}
...
ReferenceValues calculateReferenceValues_timeSliceSource(const SourceTestParameters& tP)
{
    double mean, variance;
    if (tP.sC == common::sourcecontents::one) {
        mean = normalize(12 * tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * tP.latticeExtents.getNs(),
                         tP.latticeExtents);
    } else if (tP.sC == common::sourcecontents::gaussian or tP.sC == common::sourcecontents::z4) {
        mean = 0.;
    } else
    ...
    variance = sqrt(
        normalize((0. - mean) * (0. - mean) *
                          (tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * 12) +
                      (1. - mean) * (1. - mean) *
                          (tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * 12) +
                      (0. - mean) * (0. - mean) *
                          (calculateSpinorfieldSize(tP.latticeExtents) -
                  ...
                  tP.latticeExtents));
    return ReferenceValues{mean, variance,
                           (double)tP.latticeExtents.getNs() * tP.latticeExtents.getNs() * tP.latticeExtents.getNs()};
}
...
struct SourceTester : public PrngSpinorTester {
    SourceTester(KernelIdentifier kI, const ParameterCollection pC, const SourceTestParameters& tP,
                 const int numberOfElements, const ReferenceValues rV)
    ...
    ~SourceTester()
    {
        numberOfNonZeroEntries = countNonZeroElements(&hostOutput[0], testParameters.iterations * numberOfElements) /
                                 testParameters.iterations;
...
struct VolumeSourceTester : public SourceTester {
    VolumeSourceTester(const ParameterCollection pC, const SourceTestParameters& tP, const int numberOfElements)
        : SourceTester("create_volume_source", pC, tP, calculateSpinorfieldSize(tP.latticeExtents),
                       calculateReferenceValues_volumeSource(tP))
    {
...
struct ZSliceSourceTester : public SourceTester {
    ZSliceSourceTester(const ParameterCollection pC, const SourceTestParameters& tP, const int numberOfElements)
        : SourceTester("create_zslice_source", pC, tP, calculateSpinorfieldSize(tP.latticeExtents),
                       calculateReferenceValues_zSliceSource(tP))
    {
        for (unsigned int i = 0; i < testParameters.iterations; i++) {
...
struct TimeSliceSourceTester : public SourceTester {
    TimeSliceSourceTester(const ParameterCollection pC, const SourceTestParameters& tP, const int numberOfElements)
        : SourceTester("create_timeslice_source", pC, tP, calculateSpinorfieldSize(tP.latticeExtents),
                       calculateReferenceValues_timeSliceSource(tP))
    {
        for (unsigned int i = 0; i < testParameters.iterations; i++) {
...
struct PointSourceTester : public SourceTester {
    PointSourceTester(const ParameterCollection pC, const SourceTestParameters& tP, const int numberOfElements)
        : SourceTester("create_point_source", pC, tP, calculateSpinorfieldSize(tP.latticeExtents),
                       calculateReferenceValues_pointSource(tP))
    {
        for (unsigned int i = 0; i < testParameters.iterations; i++) {
...
struct CorrelatorTester : public NonEvenOddSpinorTester {
    CorrelatorTester(const KernelIdentifier kI, const ParameterCollection pC, const ReferenceValues rV,
                     const CorrelatorTestParameters tP)
    ...
    ~CorrelatorTester() { result->dump(&kernelResult.at(0)); }
...
struct ComponentwiseCorrelatorTester : public CorrelatorTester {
    ComponentwiseCorrelatorTester(const KernelIdentifier kI, const ParameterCollection pC, const ReferenceValues rV,
                                  const CorrelatorTestParameters tP)
...
struct ColorwiseCorrelatorTester : public CorrelatorTester {
    ColorwiseCorrelatorTester(const KernelIdentifier kI, const ParameterCollection pC, const ReferenceValues rV,
                              const CorrelatorTestParameters tP)
        : CorrelatorTester(kI, pC, rV, tP)
    {
        code->correlator(code->get_correlator_kernel(kI), result, spinorfields.at(0), spinorfields.at(1),
                         spinorfields.at(2), spinorfields.at(3));
    }
};

template<class TesterClass>
void callTest(const KernelIdentifier kI, const LatticeExtents lE, const CorrelatorDirection cD,
              const SpinorFillTypes sF, const ReferenceValues rV)
{
    ...
    hardware::code::OpenClKernelParametersMockupForCorrelators kernelParameters(parametersForThisTest.ns,
                                                                                parametersForThisTest.nt,
                                                                                parametersForThisTest.kappa,
                                                                                parametersForThisTest.direction);
    ParameterCollection parameterCollection{hardwareParameters, kernelParameters};
    TesterClass(kI, parameterCollection, rV, parametersForThisTest);
}

template<class TesterClass>
void callTest(const LatticeExtents lE, const common::sourcecontents sC, const common::sourcetypes sT,
              const int iterations)
{
    SourceTestParameters parametersForThisTest(lE, sC, sT, iterations);
    hardware::HardwareParametersMockup hardwareParameters(parametersForThisTest.ns, parametersForThisTest.nt, false);
    hardware::code::OpenClKernelParametersMockupForSourceTests kernelParameters(parametersForThisTest.ns,
                                                                                parametersForThisTest.nt,
                                                                                parametersForThisTest.sC,
                                                                                parametersForThisTest.sT);
    ParameterCollection parameterCollection{hardwareParameters, kernelParameters};
...
void testPsCorrelator(const LatticeExtents lE, const CorrelatorDirection cD, const SpinorFillTypes sF,
                      const ReferenceValues rV)
{
    callTest<ComponentwiseCorrelatorTester>("ps", lE, cD, sF, rV);
}

void testAvpsCorrelator(const LatticeExtents lE, const CorrelatorDirection cD, const SpinorFillTypes sF,
                        const ReferenceValues rV)
{
    callTest<ComponentwiseCorrelatorTester>("avps", lE, cD, sF, rV);
}

void testScCorrelator(const LatticeExtents lE, const CorrelatorDirection cD, const SpinorFillTypes sF,
                      const ReferenceValues rV)
{
    callTest<ColorwiseCorrelatorTester>("sc", lE, cD, sF, rV);
}

void testVxCorrelator(const LatticeExtents lE, const CorrelatorDirection cD, const SpinorFillTypes sF,
                      const ReferenceValues rV)
{
    callTest<ColorwiseCorrelatorTester>("vx", lE, cD, sF, rV);
}

void testVyCorrelator(const LatticeExtents lE, const CorrelatorDirection cD, const SpinorFillTypes sF,
                      const ReferenceValues rV)
{
    callTest<ColorwiseCorrelatorTester>("vy", lE, cD, sF, rV);
}

void testVzCorrelator(const LatticeExtents lE, const CorrelatorDirection cD, const SpinorFillTypes sF,
                      const ReferenceValues rV)
{
    callTest<ColorwiseCorrelatorTester>("vz", lE, cD, sF, rV);
}

void testAxCorrelator(const LatticeExtents lE, const CorrelatorDirection cD, const SpinorFillTypes sF,
                      const ReferenceValues rV)
{
    callTest<ColorwiseCorrelatorTester>("ax", lE, cD, sF, rV);
}

void testAyCorrelator(const LatticeExtents lE, const CorrelatorDirection cD, const SpinorFillTypes sF,
                      const ReferenceValues rV)
{
    callTest<ColorwiseCorrelatorTester>("ay", lE, cD, sF, rV);
}

void testAzCorrelator(const LatticeExtents lE, const CorrelatorDirection cD, const SpinorFillTypes sF,
                      const ReferenceValues rV)
{
...
BOOST_AUTO_TEST_SUITE(SRC_VOLUME)
    ...
    BOOST_AUTO_TEST_CASE(SRC_VOLUME_1) { testVolumeSource(LatticeExtents{4, 4}, common::sourcecontents::one, 12); }
    ...
    BOOST_AUTO_TEST_CASE(SRC_VOLUME_3) { testVolumeSource(LatticeExtents{8, 4}, common::sourcecontents::z4, 1000); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(SRC_ZSLICE)

    BOOST_AUTO_TEST_CASE(SRC_ZSLICE_1) { testZSliceSource(LatticeExtents{4, 4}, common::sourcecontents::one, 1); }
    ...
    BOOST_AUTO_TEST_CASE(SRC_ZSLICE_3) { testZSliceSource(LatticeExtents{16, 4}, common::sourcecontents::z4, 20); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(SRC_TIMESLICE)

    BOOST_AUTO_TEST_CASE(SRC_TIMESLICE_1) { testTimeSliceSource(LatticeExtents{4, 4}, common::sourcecontents::one, 1); }
...
BOOST_AUTO_TEST_SUITE(SRC_POINT)
    ...
    BOOST_AUTO_TEST_CASE(SRC_POINT_1) { testPointSource(LatticeExtents{4, 4}, common::sourcecontents::one, 12); }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_PS_Z)
    ...
    {
        testPsCorrelator(LatticeExtents{ns8, nt4}, CorrelatorDirection::spatialZ, SpinorFillTypes{SpinorFillType::zero},
                         ReferenceValues(ns8, 0));
    }

    BOOST_AUTO_TEST_CASE(nonZero1)
    {
        testPsCorrelator(LatticeExtents{ns8, nt4}, CorrelatorDirection::spatialZ, SpinorFillTypes{SpinorFillType::one},
                         ReferenceValues(ns8, 48));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_PS_T)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testPsCorrelator(LatticeExtents{ns8, nt4}, CorrelatorDirection::temporal, SpinorFillTypes{SpinorFillType::zero},
                         ReferenceValues(nt4, 0));
    }

    BOOST_AUTO_TEST_CASE(nonZero1)
    {
        testPsCorrelator(LatticeExtents{ns8, nt4}, CorrelatorDirection::temporal, SpinorFillTypes{SpinorFillType::one},
                         ReferenceValues(nt4, 48));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_SC_Z)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testScCorrelator(LatticeExtents{ns8, nt4}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(ns8, 0));
    }
    ...
    {
        testScCorrelator(LatticeExtents{ns8, nt4}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::one, SpinorFillType::one, SpinorFillType::one,
                                         SpinorFillType::one},
                         ReferenceValues(ns8, 0));
    }
    ...
    {
        testScCorrelator(LatticeExtents{ns8, nt4}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::ascendingReal, SpinorFillType::oneZero, SpinorFillType::one,
                                         SpinorFillType::one},
                         ReferenceValues(ns8, 1872));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_SC_T)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testScCorrelator(LatticeExtents{ns4, nt8}, CorrelatorDirection::temporal,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(nt8, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_VX_Z)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testVxCorrelator(LatticeExtents{ns8, nt12}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(ns8, 0));
    }
    ...
    BOOST_AUTO_TEST_CASE(nonZero1)
    {
        testVxCorrelator(LatticeExtents{ns8, nt12}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::one, SpinorFillType::one, SpinorFillType::one,
                                         SpinorFillType::one},
                         ReferenceValues(ns8, 192.));
    }

    BOOST_AUTO_TEST_CASE(nonZero2)
    {
        testVxCorrelator(LatticeExtents{ns8, nt12}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::oneZero, SpinorFillType::zeroOne, SpinorFillType::oneZero,
                                         SpinorFillType::zeroOne},
                         ReferenceValues(ns8, 96.));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_VX_T)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testVxCorrelator(LatticeExtents{ns8, nt12}, CorrelatorDirection::temporal,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(nt12, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_VY_Z)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testVyCorrelator(LatticeExtents{ns8, nt12}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(ns8, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_VY_T)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testVyCorrelator(LatticeExtents{ns8, nt12}, CorrelatorDirection::temporal,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(nt12, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_VZ_Z)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testVzCorrelator(LatticeExtents{ns4, nt12}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(ns4, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_VZ_T)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testVzCorrelator(LatticeExtents{ns12, nt12}, CorrelatorDirection::temporal,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(nt12, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_AX_Z)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testAxCorrelator(LatticeExtents{ns4, nt12}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(ns4, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_AX_T)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testAxCorrelator(LatticeExtents{ns12, nt12}, CorrelatorDirection::temporal,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(nt12, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_AY_Z)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testAyCorrelator(LatticeExtents{ns4, nt12}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(ns4, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_AY_T)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testAyCorrelator(LatticeExtents{ns12, nt12}, CorrelatorDirection::temporal,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(nt12, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_AZ_Z)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testAzCorrelator(LatticeExtents{ns4, nt12}, CorrelatorDirection::spatialZ,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(ns4, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_AZ_T)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testAzCorrelator(LatticeExtents{ns12, nt12}, CorrelatorDirection::temporal,
                         SpinorFillTypes{SpinorFillType::zero, SpinorFillType::zero, SpinorFillType::zero,
                                         SpinorFillType::zero},
                         ReferenceValues(nt12, 0));
    }
...
BOOST_AUTO_TEST_SUITE(CORRELATOR_AVPS_T)
    ...
    BOOST_AUTO_TEST_CASE(zero1)
    {
        testAvpsCorrelator(LatticeExtents{ns8, nt8}, CorrelatorDirection::temporal,
                           SpinorFillTypes{SpinorFillType::zero}, ReferenceValues(nt8, 0));
    }

    BOOST_AUTO_TEST_CASE(nonZero1)
    {
        testAvpsCorrelator(LatticeExtents{ns8, nt8}, CorrelatorDirection::temporal,
                           SpinorFillTypes{SpinorFillType::one}, ReferenceValues(nt8, -48));
    }
