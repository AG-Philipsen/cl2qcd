    ...
    namespace code {
        ...
        class Fermions_staggered : public hardware::code::Opencl_Module {
          public:
             ...
             */
            void M_staggered_device(const hardware::buffers::Plain<su3vec>* in,
                                    const hardware::buffers::Plain<su3vec>* out, const hardware::buffers::SU3* gf,
                                    hmc_float mass = ARG_DEF) const;
             ...
             *  @param gf The gauge configuration
             */
            void D_KS_eo_device(const hardware::buffers::SU3vec* in, const hardware::buffers::SU3vec* out,
          ...
          protected:
             ...
             */
          public:
            Fermions_staggered(const hardware::code::OpenClKernelParametersInterface& kernelParams,
