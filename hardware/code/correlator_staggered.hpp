    ...
    namespace code {
        ...
        class Correlator_staggered : public Opencl_Module {
          public:
            ...
            void create_point_source_stagg_eoprec_device(const hardware::buffers::SU3vec* inout, int i, int spacepos,
                                                         int timepos) const;

            void create_volume_source_stagg_eoprec_device(const hardware::buffers::SU3vec* inout,
            ...
            void pseudoScalarCorrelator(const hardware::buffers::Plain<hmc_float>* correlator,
                                        ...
                                        const hardware::buffers::SU3vec* invertedSourcesOdd) const;
