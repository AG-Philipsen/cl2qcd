...
void hardware::code::Spinors::fill_kernels()
{
    ...
    _global_squarenorm_reduction = createKernel("global_squarenorm_reduction") << fundamental_sources << "types.hpp"
                                                                               << "spinorfield_squarenorm_reduction.cl";
    scalar_product_reduction = createKernel("scalar_product_reduction") << fundamental_sources << "types.hpp"
                                                                        << "operations_complex.hpp"
                                                                        << "spinorfield_scalar_product_reduction.cl";

    if (kernelParameters->getUseEo()) {
        generate_gaussian_spinorfield_eo = createKernel("generate_gaussian_spinorfield_eo")
                                           << basic_fermion_code << prng_code << "spinorfield_eo_gaussian.cl";
        ...
        set_eoprec_spinorfield_cold = createKernel("set_eoprec_spinorfield_cold")
                                      << basic_fermion_code << "spinorfield_eo_cold.cl";
        ...
        scalar_product_eoprec = createKernel("scalar_product_eoprec")
                                << basic_fermion_code << "spinorfield_eo_scalar_product.cl";
        set_zero_spinorfield_eoprec = createKernel("set_zero_spinorfield_eoprec")
                                      << basic_fermion_code << "spinorfield_eo_zero.cl";
        global_squarenorm_eoprec = createKernel("global_squarenorm_eoprec")
                                   << basic_fermion_code << "spinorfield_eo_squarenorm.cl";
        convertSpinorfieldToSOA_eo = createKernel("convertSpinorfieldToSOA_eo")
                                     << basic_fermion_code << "spinorfield_eo_convert.cl";
        convertSpinorfieldFromSOA_eo = createKernel("convertSpinorfieldFromSOA_eo")
                                       << basic_fermion_code << "spinorfield_eo_convert.cl";
        // merged kernels
        if (kernelParameters->getUseMergeKernelsSpinor() == true) {
            saxpy_AND_squarenorm_eo = createKernel("saxpy_AND_squarenorm_eo")
                                      << basic_fermion_code << "spinorfield_eo_saxpy_AND_squarenorm.cl";
        } else {
    ...
    generate_gaussian_spinorfield = createKernel("generate_gaussian_spinorfield")
                                    << basic_fermion_code << prng_code << "spinorfield_gaussian.cl";
...
void hardware::code::Spinors::get_work_sizes(const cl_kernel kernel, size_t* ls, size_t* gs, cl_uint* num_groups) const
{
    ...
    if (kernel == generate_gaussian_spinorfield || kernel == generate_gaussian_spinorfield_eo) {
    ...
    if (kernel == scalar_product_eoprec || kernel == scalar_product || kernel == global_squarenorm ||
        kernel == global_squarenorm_eoprec) {
        if (*ls > 64) {
            *ls         = 64;
            *num_groups = (*gs) / (*ls);
        }
...
void hardware::code::Spinors::convert_from_eoprec_device(const hardware::buffers::Spinor* in1,
                                                         const hardware::buffers::Spinor* in2,
                                                         const hardware::buffers::Plain<spinor>* out) const
{
...
void hardware::code::Spinors::convert_to_eoprec_device(const hardware::buffers::Spinor* out1,
                                                       const hardware::buffers::Spinor* out2,
...
// BLAS-functions
void hardware::code::Spinors::saxpy_device(const hardware::buffers::Plain<spinor>* x,
                                           const hardware::buffers::Plain<spinor>* y,
...
void hardware::code::Spinors::saxpy_device(const hardware::buffers::Plain<spinor>* x,
                                           const hardware::buffers::Plain<spinor>* y, const hmc_complex alpha,
                                           const hardware::buffers::Plain<spinor>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors::sax_device(const hardware::buffers::Plain<spinor>* x,
                                         const hardware::buffers::Plain<hmc_complex>* alpha,
                                         const hardware::buffers::Plain<spinor>* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Spinors::saxpy_eoprec_device(const hardware::buffers::Spinor* x,
                                                  const hardware::buffers::Spinor* y,
                                                  const hardware::buffers::Plain<hmc_complex>* alpha,
...
void hardware::code::Spinors::sax_eoprec_device(const hardware::buffers::Spinor* x,
                                                const hardware::buffers::Plain<hmc_complex>* alpha,
                                                const hardware::buffers::Spinor* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Spinors::saxsbypz_device(const hardware::buffers::Plain<spinor>* x,
                                              const hardware::buffers::Plain<spinor>* y,
                                              const hardware::buffers::Plain<spinor>* z,
                                              const hardware::buffers::Plain<hmc_complex>* alpha,
...
void hardware::code::Spinors::saxsbypz_eoprec_device(const hardware::buffers::Spinor* x,
                                                     const hardware::buffers::Spinor* y,
                                                     const hardware::buffers::Spinor* z,
                                                     const hardware::buffers::Plain<hmc_complex>* alpha,
                                                     const hardware::buffers::Plain<hmc_complex>* beta,
                                                     const hardware::buffers::Spinor* out) const
{
...
void hardware::code::Spinors::set_complex_to_scalar_product_device(
    const hardware::buffers::Plain<spinor>* a, const hardware::buffers::Plain<spinor>* b,
...
void hardware::code::Spinors::set_complex_to_scalar_product_eoprec_device(
    const hardware::buffers::Spinor* a, const hardware::buffers::Spinor* b,
    const hardware::buffers::Plain<hmc_complex>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors::global_squarenorm_reduction(const hardware::buffers::Plain<hmc_float>* out,
                                                          const hardware::buffers::Plain<hmc_float>* tmp_buf) const
{
...
void hardware::code::Spinors::set_float_to_global_squarenorm_device(
    const hardware::buffers::Plain<spinor>* a, const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors::set_float_to_global_squarenorm_eoprec_device(
    const hardware::buffers::Spinor* a, const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
// merged kernel calls
void hardware::code::Spinors::saxpy_AND_squarenorm_eo_device(const hardware::buffers::Spinor* x,
                                                             const hardware::buffers::Spinor* y,
                                                             const hardware::buffers::Plain<hmc_complex>* alpha,
                                                             const hardware::buffers::Spinor* out,
                                                             const hardware::buffers::Plain<hmc_complex>* sq_out) const
{
...
void hardware::code::Spinors::copy_to_eoprec_spinorfield_buffer(const hardware::buffers::Spinor* buf,
                                                                const spinor* const source) const
{
    using namespace hardware::buffers;
...
void hardware::code::Spinors::generate_gaussian_spinorfield_device(const hardware::buffers::Plain<spinor>* in,
...
void hardware::code::Spinors::generate_gaussian_spinorfield_eo_device(const hardware::buffers::Spinor* in,
                                                                      const hardware::buffers::PRNGBuffer* prng) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
