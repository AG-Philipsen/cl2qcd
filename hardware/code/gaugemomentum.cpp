...
hardware::code::Gaugemomentum::Gaugemomentum(const meta::Inputparameters& params, const hardware::code::OpenClKernelParametersInterface& kernelParams, hardware::Device * device)
