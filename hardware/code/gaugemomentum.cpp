...
hardware::code::Gaugemomentum::Gaugemomentum(const hardware::code::OpenClKernelParametersInterface& kernelParameters,
...
{
    basic_gaugemomentum_code = get_basic_sources() << "operations_geometry.cl"
    ...
    gaugemomentum_squarenorm_reduction = createKernel("global_squarenorm_reduction")
                                         << get_fundamental_sources() << "types.hpp"
                                         << "gaugemomentum_squarenorm_reduction.cl";

    _set_zero_gaugemomentum = createKernel("set_zero_gaugemomentum")
                              << basic_gaugemomentum_code << "gaugemomentum_zero.cl";
    generate_gaussian_gaugemomenta = createKernel("generate_gaussian_gaugemomenta")
                                     << basic_gaugemomentum_code << prng_code << "gaugemomentum_gaussian.cl";
    gaugemomentum_squarenorm = createKernel("gaugemomentum_squarenorm")
                               << basic_gaugemomentum_code << "gaugemomentum_squarenorm.cl";
    ...
    if (get_device()->get_prefers_soa()) {
        gaugemomentum_convert_to_soa = createKernel("gaugemomentum_convert_to_soa")
                                       << basic_gaugemomentum_code << "gaugemomentum_convert.cl";
        gaugemomentum_convert_from_soa = createKernel("gaugemomentum_convert_from_soa")
                                         << basic_gaugemomentum_code << "gaugemomentum_convert.cl";
    } else {
...
void hardware::code::Gaugemomentum::get_work_sizes(const cl_kernel kernel, size_t* ls, size_t* gs,
...
void hardware::code::Gaugemomentum::generate_gaussian_gaugemomenta_device(
    const hardware::buffers::Gaugemomentum* in, const hardware::buffers::PRNGBuffer* prng) const
{
...
void hardware::code::Gaugemomentum::global_squarenorm_reduction(
...
void hardware::code::Gaugemomentum::set_float_to_gaugemomentum_squarenorm_device(
    const hardware::buffers::Gaugemomentum* clmem_in, const hardware::buffers::Plain<hmc_float>* out) const
{
...
void hardware::code::Gaugemomentum::saxpy_device(const hardware::buffers::Gaugemomentum* x,
                                                 const hardware::buffers::Gaugemomentum* y,
