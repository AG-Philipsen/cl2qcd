    ...
    namespace code {
        ...
        class Complex : public Opencl_Module {
          public:
             ...
             */
            void set_complex_to_float_device(const hardware::buffers::Plain<hmc_float>* in,
             ...
             */
            void set_complex_to_ratio_device(const hardware::buffers::Plain<hmc_complex>* a,
             ...
             * @param out A complex number containing a * b
             */
            void set_complex_to_product_device(const hardware::buffers::Plain<hmc_complex>* a,
                                               const hardware::buffers::Plain<hmc_complex>* b,
                                               const hardware::buffers::Plain<hmc_complex>* out) const;
             ...
             * @param out A complex number containing a + b
             */
            void set_complex_to_sum_device(const hardware::buffers::Plain<hmc_complex>* a,
                                           const hardware::buffers::Plain<hmc_complex>* b,
                                           const hardware::buffers::Plain<hmc_complex>* out) const;
             ...
             * @param out A complex number containing a - b
             */
            void set_complex_to_difference_device(const hardware::buffers::Plain<hmc_complex>* a,
                                                  const hardware::buffers::Plain<hmc_complex>* b,
                                                  const hardware::buffers::Plain<hmc_complex>* out) const;
