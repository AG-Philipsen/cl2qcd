...
struct TestCode : public hardware::code::Opencl_Module {
    ...
    virtual void
    runTestKernel(const hardware::buffers::SU3*, const hardware::buffers::Plain<hmc_float>*, const int, const int){};
...
struct OtherKernelTester : public GaugefieldTester {
    OtherKernelTester(const std::string kernelName, const ParameterCollection pC, const GaugefieldTestParameters tP,
