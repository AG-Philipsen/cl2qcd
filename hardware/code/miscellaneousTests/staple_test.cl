...
{
    return in.e00.re + in.e00.im + in.e01.re + in.e01.im + in.e02.re + in.e02.im + in.e10.re + in.e10.im + in.e11.re +
           in.e11.im + in.e12.re + in.e12.im + in.e20.re + in.e20.im + in.e21.re + in.e21.im + in.e22.re + in.e22.im;
}

__kernel void
staple_test(__global const Matrixsu3StorageType* const restrict field, __global hmc_float* const restrict out)
{
