...
calculateReferenceValues_globalSquarenorm(const int latticeVolume, const SpinorFillTypes fillTypesIn)
{
...
struct LinearCombinationTestParameters : public SpinorTestParameters {
    LinearCombinationTestParameters(const LatticeExtents lE, const SpinorFillTypes sF)
        : TestParameters(lE)
        , SpinorTestParameters(lE, sF)
        , complexCoefficients(ComplexNumbers{{1., 0.}})
        , numberOfSpinors(1){};
    LinearCombinationTestParameters(const LatticeExtents lE, const SpinorFillTypes sF, const ComplexNumbers cN,
                                    const size_t numberOfSpinorsIn)
        : TestParameters(lE)
        , SpinorTestParameters(lE, sF)
...
void callTest(const ParameterClass parametersForThisTest, const bool needEvenOdd)
{
    hardware::HardwareParametersMockup hardwareParameters(parametersForThisTest.ns, parametersForThisTest.nt,
                                                          needEvenOdd);
    hardware::code::OpenClKernelParametersMockupForSpinorTests kernelParameters(parametersForThisTest.ns,
...
template<typename TesterClass>
void performTest(LatticeExtents latticeExtendsIn)
{
    SpinorTestParameters parametersForThisTest(latticeExtendsIn);
    hardware::HardwareParametersMockup hardwareParameters(parametersForThisTest.latticeExtents, true);
    hardware::code::OpenClKernelParametersMockupForSpinorTests kernelParameters(parametersForThisTest.latticeExtents,
...
struct NonEvenOddLinearCombinationTester : public NonEvenOddSpinorTester {
  ...
  protected:
    ...
    const hardware::buffers::Plain<spinor>* getOutSpinor() const { return spinorfields.back(); }
    ...
    void loadSpinorfields(const LinearCombinationTestParameters& tP)
    {
        for (size_t number = 0; number < tP.numberOfSpinors; number++) {
            ...
            spinorfields.push_back(
                new hardware::buffers::Plain<spinor>(calculateSpinorfieldSize(tP.latticeExtents), device));
            (tP.fillTypes.size() < tP.numberOfSpinors)
                ? spinorfields.back()->load(sf.createSpinorfield(tP.fillTypes.at(0)))
                : spinorfields.back()->load(sf.createSpinorfield(tP.fillTypes.at(number)));
        }
    }
};
...
struct EvenOddLinearCombinationTester : public EvenOddSpinorTester {
  ...
  protected:
    ...
    const hardware::buffers::Spinor* getOutSpinor() const { return spinorfields.back(); }
...
struct NonEvenGaussianSpinorfieldTester : public PrngSpinorTester {
    NonEvenGaussianSpinorfieldTester(const ParameterCollection parameterCollection,
                                     const PrngSpinorTestParameters testParameters)
        : PrngSpinorTester("generate_gaussian_spinorfield", parameterCollection, testParameters,
                           calculateSpinorfieldSize(testParameters.latticeExtents), calculateReferenceValues_gaussian())
    {
    }
...
struct EvenOddGaussianSpinorfieldEvenOddTester : public PrngSpinorTester {
    EvenOddGaussianSpinorfieldEvenOddTester(const ParameterCollection parameterCollection,
                                            const PrngSpinorTestParameters testParameters)
        : PrngSpinorTester("generate_gaussian_spinorfield_eo", parameterCollection, testParameters,
...
struct ConvertToEvenOddTester : public SpinorTester {
    ConvertToEvenOddTester(const ParameterCollection& parameterCollection, const SpinorTestParameters tP,
                           const bool fillEvenSitesIn)
        : SpinorTester("convert_to_eo", parameterCollection, tP,
                       calculateReferenceValues_convert_eo(calculateEvenOddSpinorfieldSize(tP.latticeExtents),
                                                           fillEvenSitesIn))
    {
...
struct SaxsbypzEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxsbypzEvenOddTester(const ParameterCollection& parameterCollection,
                          const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxsbypz_eo", parameterCollection, testParameters,
                                                                     calculateReferenceValues_saxsbypz)
    {
        code->saxsbypz_eoprec_device(spinorfields.at(0), spinorfields.at(1), spinorfields.at(2), complexNums.at(0),
...
struct SaxsbypzTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxsbypzTester(const ParameterCollection& parameterCollection, const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxsbypz", parameterCollection, testParameters,
                                                                        calculateReferenceValues_saxsbypz)
    {
        code->saxsbypz_device(spinorfields.at(0), spinorfields.at(1), spinorfields.at(2), complexNums.at(0),
                              complexNums.at(1), getOutSpinor());
    }
};
...
struct SquarenormTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SquarenormTester(const ParameterCollection& parameterCollection,
                     const LinearCombinationTestParameters& testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("global squarenorm", parameterCollection,
                                                                        testParameters,
                                                                        calculateReferenceValues_globalSquarenorm)
    {
    }
};
...
struct SquarenormEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SquarenormEvenOddTester(const ParameterCollection& parameterCollection,
                            const LinearCombinationTestParameters& testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("global_squarenorm_eo", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_globalSquarenorm)
    {
    }
...
struct ScalarProductEvenOddTester : public EvenOddLinearCombinationTester {
    ScalarProductEvenOddTester(const ParameterCollection& parameterCollection,
                               const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTester("scalar_product_eo", parameterCollection, testParameters,
                                         calculateReferenceValues_scalarProduct(calculateEvenOddSpinorfieldSize(
                                                                                    testParameters.latticeExtents),
                                                                                testParameters.fillTypes))
    {
...
struct SaxEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxEvenOddTester(const ParameterCollection& parameterCollection,
                     const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax_eo", parameterCollection, testParameters,
                                                                     calculateReferenceValues_sax)
    {
...
struct SaxpyArgTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyArgTester(const ParameterCollection& parameterCollection, const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_arg", parameterCollection,
                                                                        testParameters, calculateReferenceValues_saxpy)
    {
        code->saxpy_device(spinorfields.at(0), spinorfields.at(1), testParameters.complexCoefficients.at(0),
                           getOutSpinor());
    }
};

struct SaxpyEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyEvenOddTester(const ParameterCollection& parameterCollection,
                       const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_eo", parameterCollection, testParameters,
                                                                     calculateReferenceValues_saxpy)
    {
...
struct SaxpyArgEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyArgEvenOddTester(const ParameterCollection& parameterCollection,
                          const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_arg_eo", parameterCollection,
                                                                     testParameters, calculateReferenceValues_saxpy)
    {
        code->saxpy_eoprec_device(spinorfields.at(0), spinorfields.at(0), testParameters.complexCoefficients.at(0),
                                  getOutSpinor());
    }
};
...
BOOST_AUTO_TEST_SUITE(SCALAR_PRODUCT)
    ...
    {
        testNonEvenOddScalarProduct(LatticeExtents{ns8, nt12},
                                    SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REDUCTION_2)
    {
        testNonEvenOddScalarProduct(LatticeExtents{ns8, nt4},
                                    SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REDUCTION_3)
    {
        testNonEvenOddScalarProduct(LatticeExtents{ns8, nt16},
                                    SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }
...
BOOST_AUTO_TEST_SUITE(SCALAR_PRODUCT_EO)
    ...
    {
        testEvenOddScalarProduct(LatticeExtents{ns4, nt12},
                                 SpinorFillTypes{SpinorFillType::one, SpinorFillType::ascendingComplex});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_EO_3)
    {
        testEvenOddScalarProduct(LatticeExtents{ns8, nt8},
                                 SpinorFillTypes{SpinorFillType::ascendingComplex, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_EO_4)
    {
        testEvenOddScalarProduct(LatticeExtents{ns4, nt4},
                                 SpinorFillTypes{SpinorFillType::ascendingComplex, SpinorFillType::ascendingComplex});
    }
...
BOOST_AUTO_TEST_SUITE(ZERO)
    ...
    BOOST_AUTO_TEST_CASE(ZERO_1) { testNonEvenOddZero(LatticeExtents{ns4, nt4}, SpinorFillTypes{SpinorFillType::one}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(COLD)

    BOOST_AUTO_TEST_CASE(COLD_1) { testNonEvenOddCold(LatticeExtents{ns4, nt4}, SpinorFillTypes{SpinorFillType::one}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(ZERO_EO)

    BOOST_AUTO_TEST_CASE(ZERO_EO_1) { testEvenOddZero(LatticeExtents{ns4, nt4}, SpinorFillTypes{SpinorFillType::one}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(COLD_EO)

    BOOST_AUTO_TEST_CASE(COLD_EO_1) { testEvenOddCold(LatticeExtents{ns4, nt4}, SpinorFillTypes{SpinorFillType::one}); }
...
BOOST_AUTO_TEST_SUITE(SAX)
    ...
    BOOST_AUTO_TEST_CASE(SAX_4) { testNonEvenOddSax(LatticeExtents{ns16, nt8}, ComplexNumbers{{1., 1.}}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(SAX_EO)

    BOOST_AUTO_TEST_CASE(SAX_EO_1) { testEvenOddSax(LatticeExtents{ns4, nt4}, ComplexNumbers{{0., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAX_EO_2) { testEvenOddSax(LatticeExtents{ns4, nt8}, ComplexNumbers{{1., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAX_EO_3) { testEvenOddSax(LatticeExtents{ns8, nt4}, ComplexNumbers{{0., 1.}}); }

    BOOST_AUTO_TEST_CASE(SAX_EO_4) { testEvenOddSax(LatticeExtents{ns16, nt8}, ComplexNumbers{{1., 1.}}); }
...
BOOST_AUTO_TEST_SUITE(SAXPY)
    ...
    BOOST_AUTO_TEST_CASE(SAXPY_5) { testNonEvenOddSaxpyArg(LatticeExtents{ns12, nt4}, ComplexNumbers{{0., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_6) { testNonEvenOddSaxpyArg(LatticeExtents{ns4, nt12}, ComplexNumbers{{1., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_7) { testNonEvenOddSaxpyArg(LatticeExtents{ns16, nt8}, ComplexNumbers{{0., 1.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_8) { testNonEvenOddSaxpyArg(LatticeExtents{ns8, nt16}, ComplexNumbers{{1., 1.}}); }

BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_SUITE(SAXPY_EO)

    BOOST_AUTO_TEST_CASE(SAXPY_EO_1) { testEvenOddSaxpy(LatticeExtents{ns4, nt4}, ComplexNumbers{{0., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_EO_2) { testEvenOddSaxpy(LatticeExtents{ns8, nt4}, ComplexNumbers{{1., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_EO_3) { testEvenOddSaxpy(LatticeExtents{ns4, nt8}, ComplexNumbers{{0., 1.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_EO_4) { testEvenOddSaxpy(LatticeExtents{ns8, nt8}, ComplexNumbers{{1., 1.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_EO_5) { testEvenOddSaxpyArg(LatticeExtents{ns12, nt4}, ComplexNumbers{{0., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_EO_6) { testEvenOddSaxpyArg(LatticeExtents{ns4, nt12}, ComplexNumbers{{1., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_EO_7) { testEvenOddSaxpyArg(LatticeExtents{ns16, nt8}, ComplexNumbers{{0., 1.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_EO_8) { testEvenOddSaxpyArg(LatticeExtents{ns8, nt16}, ComplexNumbers{{1., 1.}}); }
...
BOOST_AUTO_TEST_SUITE(CONVERT_EO)
    ...
    BOOST_AUTO_TEST_CASE(CONVERT_EO_3) { testConvertFromEvenOdd(LatticeExtents{ns4, nt4}); }
...
BOOST_AUTO_TEST_SUITE(GAUSSIAN)
    ...
    BOOST_AUTO_TEST_CASE(GAUSSIAN_NONEO) { testNonEvenOddGaussianSpinorfield(LatticeExtents{ns8, nt4}, 1000); }

    BOOST_AUTO_TEST_CASE_EXPECTED_FAILURES(GAUSSIAN_EO, 2)

    BOOST_AUTO_TEST_CASE(GAUSSIAN_EO) { testEvenOddGaussianSpinorfield(LatticeExtents{ns12, nt4}, 1000); }
