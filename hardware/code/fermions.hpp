...
namespace hardware {
    ...
    namespace code {
         ...
         * An OpenCL device
         *
         * This class wraps all operations on a device. Operations are always specific, e.g. each kernel and copy
         * operation has it's own wrapper function.
         *
        ...
        class Fermions : public hardware::code::Opencl_Module {
          public:
            ...
            //    non-eo
            //        explicit
            void M_wilson_device(const hardware::buffers::Plain<spinor>* in,
                                 const hardware::buffers::Plain<spinor>* out, const hardware::buffers::SU3* gf,
                                 hmc_float kappa = ARG_DEF) const;
            void M_tm_plus_device(const hardware::buffers::Plain<spinor>* in,
                                  const hardware::buffers::Plain<spinor>* out, const hardware::buffers::SU3* gf,
                                  hmc_float kappa = ARG_DEF, hmc_float mubar = ARG_DEF) const;
            void M_tm_minus_device(const hardware::buffers::Plain<spinor>* in,
                                   const hardware::buffers::Plain<spinor>* out, const hardware::buffers::SU3* gf,
                                   hmc_float kappa = ARG_DEF, hmc_float mubar = ARG_DEF) const;
            ...
            void M_tm_inverse_sitediagonal_device(const hardware::buffers::Spinor* in,
                                                  const hardware::buffers::Spinor* out,
                                                  hmc_float mubar = ARG_DEF) const;
            void M_tm_sitediagonal_device(const hardware::buffers::Spinor* in, const hardware::buffers::Spinor* out,
                                          hmc_float mubar = ARG_DEF) const;
            void M_tm_inverse_sitediagonal_minus_device(const hardware::buffers::Spinor* in,
                                                        const hardware::buffers::Spinor* out,
                                                        hmc_float mubar = ARG_DEF) const;
            void M_tm_sitediagonal_minus_device(const hardware::buffers::Spinor* in,
                                                const hardware::buffers::Spinor* out, hmc_float mubar = ARG_DEF) const;
            /**
             * Perform dslash_eo on the whole buffer.
             */
            void dslash_eo_device(const hardware::buffers::Spinor* in, const hardware::buffers::Spinor* out,
             ...
             */
            void dslash_eo_boundary(const hardware::buffers::Spinor* in, const hardware::buffers::Spinor* out,
                                    const hardware::buffers::SU3* gf, int evenodd, hmc_float kappa = ARG_DEF) const;
            /**
             * Perform dslash_eo only on the inner sites which do not require the halo.
             */
            void dslash_eo_inner(const hardware::buffers::Spinor* in, const hardware::buffers::Spinor* out,
                                 const hardware::buffers::SU3* gf, int evenodd, hmc_float kappa = ARG_DEF) const;
            // merged:
            // void Aee_AND_gamma5_eo(const hardware::buffers::Spinor * in, const hardware::buffers::Spinor * out,
            //                        const hardware::buffers::SU3 * gf, hmc_float kappa = ARG_DEF,
            //                        hmc_float mubar = ARG_DEF);
            // void Aee_minus_AND_gamma5_eo(const hardware::buffers::Spinor * in, const hardware::buffers::Spinor * out,
            //                              const hardware::buffers::SU3 * gf, hmc_float kappa = ARG_DEF,
            //                              hmc_float mubar = ARG_DEF);
            void dslash_AND_M_tm_inverse_sitediagonal_eo_device(const hardware::buffers::Spinor* in,
                                                                ...
                                                                hmc_float kappa = ARG_DEF,
                                                                hmc_float mubar = ARG_DEF) const;
            void dslash_AND_M_tm_inverse_sitediagonal_minus_eo_device(const hardware::buffers::Spinor* in,
                                                                      const hardware::buffers::Spinor* out,
                                                                      const hardware::buffers::SU3* gf, int evenodd,
                                                                      hmc_float kappa = ARG_DEF,
                                                                      hmc_float mubar = ARG_DEF) const;
            void M_tm_sitediagonal_AND_gamma5_eo_device(const hardware::buffers::Spinor* in,
                                                        const hardware::buffers::Spinor* out,
                                                        hmc_float mubar = ARG_DEF) const;
            void M_tm_sitediagonal_minus_AND_gamma5_eo_device(const hardware::buffers::Spinor* in,
                                                              const hardware::buffers::Spinor* out,
                                                              hmc_float mubar = ARG_DEF) const;
            void saxpy_AND_gamma5_eo_device(const hardware::buffers::Spinor* x, const hardware::buffers::Spinor* y,
          ...
          protected:
             ...
             */
          public:
            Fermions(const hardware::code::OpenClKernelParametersInterface& kernelParams,
