    ...
    namespace code {
        ...
        class Heatbath : public hardware::code::Opencl_Module {
          public:
             ...
             */
            void
            run_overrelax(const hardware::buffers::SU3* gaugefield, const hardware::buffers::PRNGBuffer* prng) const;
             ...
             */
          public:
            Heatbath(const hardware::code::OpenClKernelParametersInterface& kernelParams,
