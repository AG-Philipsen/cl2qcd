    ...
    namespace code {
        ...
        class Gaugefield : public Opencl_Module {
          public:
             ...
             * @param[in] gf gaugefield to measure on
             */
            void plaquette_device(const hardware::buffers::SU3* gf, const hardware::buffers::Plain<hmc_float>* plaq,
            ...
            void polyakov_md_local_device(const hardware::buffers::Plain<Matrixsu3>* partial_results,
                                          const hardware::buffers::SU3* gf) const;

            void polyakov_md_merge_device(const hardware::buffers::Plain<Matrixsu3>* partial_results,
          ...
          public:
             ...
             */
            Gaugefield(const hardware::code::OpenClKernelParametersInterface& kernelParams,
          ...
          private:
            ...
            void convertGaugefieldToSOA_device(const hardware::buffers::SU3* out,
                                               const hardware::buffers::Plain<Matrixsu3>* in) const;
            void convertGaugefieldFromSOA_device(const hardware::buffers::Plain<Matrixsu3>* out,
