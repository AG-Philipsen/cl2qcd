...
hardware::code::Complex::Complex(const meta::Inputparameters& params, const hardware::code::OpenClKernelParametersInterface& kernelParameters, hardware::Device * device)
