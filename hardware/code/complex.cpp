...
{
    basic_complex_code = get_fundamental_sources() << "types.hpp"
...
void hardware::code::Complex::set_complex_to_float_device(const hardware::buffers::Plain<hmc_float>* in,
...
void hardware::code::Complex::set_complex_to_ratio_device(const hardware::buffers::Plain<hmc_complex>* a,
                                                          const hardware::buffers::Plain<hmc_complex>* b,
                                                          const hardware::buffers::Plain<hmc_complex>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Complex::set_complex_to_product_device(const hardware::buffers::Plain<hmc_complex>* a,
                                                            const hardware::buffers::Plain<hmc_complex>* b,
                                                            const hardware::buffers::Plain<hmc_complex>* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Complex::set_complex_to_sum_device(const hardware::buffers::Plain<hmc_complex>* a,
                                                        const hardware::buffers::Plain<hmc_complex>* b,
                                                        const hardware::buffers::Plain<hmc_complex>* out) const
{
    // query work-sizes for kernel
...
void hardware::code::Complex::set_complex_to_difference_device(const hardware::buffers::Plain<hmc_complex>* a,
                                                               const hardware::buffers::Plain<hmc_complex>* b,
                                                               const hardware::buffers::Plain<hmc_complex>* out) const
{
    // query work-sizes for kernel
...
hardware::code::Complex::Complex(const hardware::code::OpenClKernelParametersInterface& kernelParameters,
