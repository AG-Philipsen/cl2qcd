...
const ReferenceValues calculateReferenceValues_GaugefieldUpdate(const int latticeVolume, GaugefieldFillType fillTypeIn,
                                                                const GaugeMomentumFilltype gmFillTypeIn)
{
    switch (fillTypeIn) {
...
const ReferenceValues calculateReferenceValues_FGaugeTlsym(const int latticeVolume, const GaugefieldFillType fillTypeIn,
                                                           const GaugeMomentumFilltype gmFillTypeIn)
{
    switch (fillTypeIn) {
        case GaugefieldFillType::cold: {
...
const ReferenceValues calculateReferenceValues_FGauge(const int latticeVolume, const GaugefieldFillType fillTypeIn,
                                                      const GaugeMomentumFilltype gmFillTypeIn)
{
    switch (fillTypeIn) {
        case GaugefieldFillType::cold: {
...
const ReferenceValues calculateReferenceValues_FFermion(const int latticeVolume, const GaugefieldFillType gfFillType,
                                                        const GaugeMomentumFilltype gmFillType,
                                                        const SpinorFillType sfFillType,
...
calculateReferenceValues_FFermionEvenOdd(const int latticeVolume, const GaugefieldFillType gfFillType,
                                         const GaugeMomentumFilltype gmFillType, const SpinorFillType sfFillType,
                                         const WilsonMassParameters massParameters)
{
    if (massParameters.kappa == nonTrivialParameter) {
        switch (gfFillType) {
...
const ReferenceValues
calculateReferenceValues_FFermionStaggeredEvenOdd(const int latticeVolume, const GaugefieldFillType gfFillType,
                                                  const GaugeMomentumFilltype gmFillType,
                                                  const SpinorFillType sfFillType, const bool evenOrOdd)
{
...
struct MolecularDynamicsTestParameters : public GaugemomentumTestParameters {
    MolecularDynamicsTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType fillTypeIn,
                                    GaugeMomentumFilltype gmFillTypeIn)
        : GaugemomentumTestParameters(latticeExtendsIn)
        , gaugeFillType(fillTypeIn)
        , gmFillType(gmFillTypeIn)
        , spinorFillType(SpinorFillType::one)
        , massParameters(1.)
    {
    }
    MolecularDynamicsTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType gfFillTypeIn,
                                    GaugeMomentumFilltype gmFillTypeIn, SpinorFillType sfFillTypeIn,
                                    WilsonMassParameters kappaIn)
        : GaugemomentumTestParameters(latticeExtendsIn, gmFillTypeIn)
        , gaugeFillType(gfFillTypeIn)
        , gmFillType(gmFillTypeIn)
        , spinorFillType(sfFillTypeIn)
        , massParameters(kappaIn)
    {
    }
...
struct EvenOddMolecularDynamicsTestParameters : public MolecularDynamicsTestParameters {
    EvenOddMolecularDynamicsTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType gfFillTypeIn,
                                           GaugeMomentumFilltype gmFillTypeIn, SpinorFillType sfFillTypeIn,
                                           WilsonMassParameters kappaIn, const bool evenOrOddIn)
        : MolecularDynamicsTestParameters(latticeExtendsIn, gfFillTypeIn, gmFillTypeIn, sfFillTypeIn, kappaIn)
        , evenOrOdd(evenOrOddIn)
    {
    }
    EvenOddMolecularDynamicsTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType gfFillTypeIn,
                                           GaugeMomentumFilltype gmFillTypeIn, SpinorFillType sfFillTypeIn,
                                           const bool evenOrOddIn)
        : MolecularDynamicsTestParameters(latticeExtendsIn, gfFillTypeIn, gmFillTypeIn, sfFillTypeIn, 1.)
        , evenOrOdd(evenOrOddIn)
    {
    }
...
struct GaugeFieldUpdateTestParameters : public MolecularDynamicsTestParameters {
    GaugeFieldUpdateTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType fillTypeIn,
                                   GaugeMomentumFilltype gmFillType, const hmc_float epsIn)
...
struct MolecularDynamicsTester : public GaugemomentumTester {
    MolecularDynamicsTester(std::string kernelName, const ParameterCollection pC, const ReferenceValues rV,
                            const MolecularDynamicsTestParameters tP)
...
struct GaugefieldUpdateTester : public MolecularDynamicsTester {
    GaugefieldUpdateTester(const ParameterCollection pC, const GaugeFieldUpdateTestParameters tP)
        : MolecularDynamicsTester("md_update_gaugefield", pC,
                                  calculateReferenceValues_GaugefieldUpdate(LatticeExtents(tP.latticeExtents)
                                                                                .getLatticeVolume(),
                                                                            tP.gaugeFillType, tP.gmFillType),
                                  tP)
    {
...
struct FGaugeTester : public MolecularDynamicsTester {
    FGaugeTester(const ParameterCollection pC, const MolecularDynamicsTestParameters tP)
        : MolecularDynamicsTester("f_gauge", pC,
                                  calculateReferenceValues_FGauge(LatticeExtents(tP.latticeExtents).getLatticeVolume(),
                                                                  tP.gaugeFillType, tP.gmFillType),
                                  tP)
    {
...
struct FGaugeTlsymTester : public MolecularDynamicsTester {
    FGaugeTlsymTester(const ParameterCollection pC, const MolecularDynamicsTestParameters tP)
        : MolecularDynamicsTester("f_gauge_tlsym", pC,
                                  calculateReferenceValues_FGaugeTlsym(LatticeExtents(tP.latticeExtents)
                                                                           .getLatticeVolume(),
                                                                       tP.gaugeFillType, tP.gmFillType),
                                  tP)
    {
...
struct FFermionTester : public MolecularDynamicsTester {
    FFermionTester(const ParameterCollection pC, const MolecularDynamicsTestParameters tP)
        : MolecularDynamicsTester("f_fermion", pC,
                                  calculateReferenceValues_FFermion(tP.latticeExtents.getLatticeVolume(),
                                                                    tP.gaugeFillType, tP.gmFillType, tP.spinorFillType,
                                                                    tP.massParameters),
                                  tP)
    {
        NonEvenOddSpinorfieldCreator sf(tP.latticeExtents);
        const hardware::buffers::Plain<spinor> in1(calculateSpinorfieldSize(tP.latticeExtents),
                                                   MolecularDynamicsTester::device);
        const hardware::buffers::Plain<spinor> in2(calculateSpinorfieldSize(tP.latticeExtents),
                                                   MolecularDynamicsTester::device);

        in1.load(sf.createSpinorfield(tP.spinorFillType));
        in2.load(sf.createSpinorfield(tP.spinorFillType));

        molecularDynamicsCode->fermion_force_device(&in1, &in2, gaugefieldBuffer, gaugemomentumBuffer,
                                                    tP.massParameters.kappa);
...
struct FFermionEvenOddTester : public MolecularDynamicsTester {
    FFermionEvenOddTester(const ParameterCollection pC, const EvenOddMolecularDynamicsTestParameters tP)
        : MolecularDynamicsTester("f_fermion_eo", pC,
                                  calculateReferenceValues_FFermionEvenOdd(tP.latticeExtents.getLatticeVolume(),
                                                                           tP.gaugeFillType, tP.gmFillType,
                                                                           tP.spinorFillType, tP.massParameters),
                                  tP)
    {
        ...
        sf.fillTwoSpinorBuffers(&in1, tP.spinorFillType, &in2,
                                tP.spinorFillType);  // the same SpinorFillType is used for both spinors

        molecularDynamicsCode->fermion_force_eo_device(&in1, &in2, gaugefieldBuffer, gaugemomentumBuffer, tP.evenOrOdd,
                                                       tP.massParameters.kappa);
        MolecularDynamicsTester::calcSquarenormAndStoreAsKernelResult(gaugemomentumBuffer);
    }
};
...
struct FFermionEvenOddComparator : public MolecularDynamicsTester {
        ...
        : MolecularDynamicsTester("f_fermion compare even-odd and non-even-odd", pC, defaultReferenceValues(), tP)
    {
        ...
        molecularDynamicsCode->fermion_force_eo_device(inEo1, inEo4, gaugefieldBuffer, outEo, ODD,
                                                       tP.massParameters.kappa);
        MolecularDynamicsTester::code
            ->set_float_to_gaugemomentum_squarenorm_device(outEo, MolecularDynamicsTester::doubleBuffer);
        MolecularDynamicsTester::doubleBuffer->dump(&cpu_res_eo);

        molecularDynamicsCode->fermion_force_eo_device(inEo2, inEo3, gaugefieldBuffer, outEo, EVEN,
                                                       tP.massParameters.kappa);
        MolecularDynamicsTester::code
            ->set_float_to_gaugemomentum_squarenorm_device(outEo, MolecularDynamicsTester::doubleBuffer);
        MolecularDynamicsTester::doubleBuffer->dump(&cpu_res_eo);
        ...
        molecularDynamicsCode->fermion_force_device(inNonEo1, inNonEo2, gaugefieldBuffer, outNonEo,
                                                    tP.massParameters.kappa);
  ...
  private:
    void createBuffers(const MolecularDynamicsTestParameters tP)
    {
        ...
        inNonEo1 = new const hardware::buffers::Plain<spinor>(calculateSpinorfieldSize(tP.latticeExtents),
                                                              MolecularDynamicsTester::device);
        inNonEo2 = new const hardware::buffers::Plain<spinor>(calculateSpinorfieldSize(tP.latticeExtents),
                                                              MolecularDynamicsTester::device);
...
struct FFermionStaggeredEvenOddTester : public MolecularDynamicsTester {
    FFermionStaggeredEvenOddTester(const ParameterCollection pC, const EvenOddMolecularDynamicsTestParameters tP)
        : MolecularDynamicsTester("f_staggered_fermion_eo", pC,
                                  calculateReferenceValues_FFermionStaggeredEvenOdd(tP.latticeExtents
                                                                                        .getLatticeVolume(),
                                                                                    tP.gaugeFillType, tP.gmFillType,
                                                                                    tP.spinorFillType, tP.evenOrOdd),
                                  tP)
    {
        ...
        molecularDynamicsCode->fermion_staggered_partial_force_device(gaugefieldBuffer, &in1, &in2, gaugemomentumBuffer,
                                                                      tP.evenOrOdd);
...
void callTest(const LatticeExtents lE, GaugefieldFillType gfFillType, GaugeMomentumFilltype gmFillType,
              SpinorFillType sfFillType, WilsonMassParameters kappa)
{
...
template<class TesterClass>
void callTest(const LatticeExtents lE, GaugefieldFillType gfFillType, GaugeMomentumFilltype gmFillType,
              SpinorFillType sfFillType, const bool evenOrOdd, WilsonMassParameters kappa)
{
    EvenOddMolecularDynamicsTestParameters parametersForThisTest(lE, gfFillType, gmFillType, sfFillType, kappa,
                                                                 evenOrOdd);
    hardware::HardwareParametersMockup hardwareParameters(lE, true);
    hardware::code::OpenClKernelParametersMockupForMolecularDynamics kernelParameters(lE, true);
    ParameterCollection parameterCollection{hardwareParameters, kernelParameters};
...
template<class TesterClass>
void callTest(const LatticeExtents lE, GaugefieldFillType gfFillType, GaugeMomentumFilltype gmFillType,
              SpinorFillType sfFillType, const bool evenOrOdd)
{
...
void testGaugefieldUpdate(const LatticeExtents lE, const GaugefieldFillType fillType,
                          const GaugeMomentumFilltype gmFillType, const hmc_float eps)
{
...
void testNonEvenOddFermionForce(const LatticeExtents lE, GaugefieldFillType gfFillType,
                                GaugeMomentumFilltype gmFillType, SpinorFillType sfFillType, WilsonMassParameters kappa)
{
    callTest<FFermionTester>(lE, gfFillType, gmFillType, sfFillType, kappa);
}
void testEvenOddFermionForce(const LatticeExtents lE, GaugefieldFillType fillType, GaugeMomentumFilltype gmFillType,
                             SpinorFillType sfFillType, const bool evenOrOdd, WilsonMassParameters kappa)
{
...
void compareEvenOddAndNonEvenOddFermionForce(const LatticeExtents lE, GaugefieldFillType fillType,
                                             GaugeMomentumFilltype gmFillType, SpinorFillType sfFillType,
                                             WilsonMassParameters kappa)
{
...
void testEvenOddStaggeredFermionForce(const LatticeExtents lE, GaugefieldFillType fillType,
                                      GaugeMomentumFilltype gmFillType, SpinorFillType sfFillType, const bool evenOrOdd)
{
...
BOOST_AUTO_TEST_SUITE(GF_UPDATE)
    ...
    // Note: test5 (but this refers to the old input files): "THIS TEST HAS TO BE INVESTIGATED!! IT COULD HINT TO AN
    ...
    {
        testGaugefieldUpdate(LatticeExtents{ns4, nt4}, GaugefieldFillType::nonTrivial, GaugeMomentumFilltype::Ascending,
                             .0);
    }
...
BOOST_AUTO_TEST_SUITE(STOUT_SMEAR_FERMION_FORCE)
    ...
    BOOST_AUTO_TEST_CASE(STOUT_SMEAR_FERMION_FORCE_1) { BOOST_TEST_MESSAGE("NOT YET IMPLEMENTED!!"); }
...
BOOST_AUTO_TEST_SUITE(F_FERMION)
    ...
    {
        testNonEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::cold, GaugeMomentumFilltype::One,
                                   SpinorFillType::one, WilsonMassParameters{nonTrivialParameter});
    }
    BOOST_AUTO_TEST_CASE(F_FERMION_2)
    {
        testNonEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::cold, GaugeMomentumFilltype::One,
                                   SpinorFillType::ascendingComplex, WilsonMassParameters{nonTrivialParameter});
    }
    BOOST_AUTO_TEST_CASE(F_FERMION_3)
    {
        testNonEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::cold, GaugeMomentumFilltype::Ascending,
                                   SpinorFillType::one, WilsonMassParameters{nonTrivialParameter});
    }
    ...
    {
        testNonEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::nonTrivial, GaugeMomentumFilltype::One,
                                   SpinorFillType::one, WilsonMassParameters{nonTrivialParameter});
    }
    ...
    BOOST_AUTO_TEST_CASE(F_FERMION_7)
    {
        testNonEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::nonTrivial,
                                   GaugeMomentumFilltype::Ascending, SpinorFillType::one,
                                   WilsonMassParameters{nonTrivialParameter});
    }
    BOOST_AUTO_TEST_CASE(F_FERMION_8)
    {
        testNonEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::nonTrivial,
                                   GaugeMomentumFilltype::Ascending, SpinorFillType::ascendingComplex,
                                   WilsonMassParameters{nonTrivialParameter});
    }
...
BOOST_AUTO_TEST_SUITE(F_FERMION_EO)
    ...
    {
        testEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::cold, GaugeMomentumFilltype::One,
                                SpinorFillType::one, EVEN, WilsonMassParameters{nonTrivialParameter});
    }
    BOOST_AUTO_TEST_CASE(F_FERMION_EO_2)
    {
        testEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::cold, GaugeMomentumFilltype::One,
                                SpinorFillType::ascendingComplex, ODD, WilsonMassParameters{nonTrivialParameter});
    }
    BOOST_AUTO_TEST_CASE(F_FERMION_EO_3)
    {
        testEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::cold, GaugeMomentumFilltype::Ascending,
                                SpinorFillType::one, EVEN, WilsonMassParameters{nonTrivialParameter});
    }
    ...
    {
        testEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::nonTrivial, GaugeMomentumFilltype::One,
                                SpinorFillType::one, EVEN, WilsonMassParameters{nonTrivialParameter});
    }
    ...
    BOOST_AUTO_TEST_CASE(F_FERMION_EO_7)
    {
        testEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::nonTrivial,
                                GaugeMomentumFilltype::Ascending, SpinorFillType::one, EVEN,
                                WilsonMassParameters{nonTrivialParameter});
    }
...
BOOST_AUTO_TEST_SUITE(F_FERMION_COMPARE_NONEO_EO)
    ...
    BOOST_AUTO_TEST_CASE(F_FERMION_COMPARE_NONEO_EO_1)
    {
        compareEvenOddAndNonEvenOddFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::cold,
                                                GaugeMomentumFilltype::One, SpinorFillType::one,
                                                WilsonMassParameters{nonTrivialParameter});
    }
...
BOOST_AUTO_TEST_SUITE(F_STAGG_FERMION_EO)
    ...
    {
        testEvenOddStaggeredFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::cold, GaugeMomentumFilltype::One,
                                         SpinorFillType::one, EVEN);
    }
    BOOST_AUTO_TEST_CASE(F_STAGG_FERMION_EO_2)
    {
        testEvenOddStaggeredFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::cold, GaugeMomentumFilltype::One,
                                         SpinorFillType::ascendingComplex, ODD);
    }
    ...
    BOOST_AUTO_TEST_CASE(F_STAGG_FERMION_EO_5)
    {
        testEvenOddStaggeredFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::nonTrivial,
                                         GaugeMomentumFilltype::One, SpinorFillType::one, ODD);
    }
    ...
    {
        testEvenOddStaggeredFermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::nonTrivial,
                                         GaugeMomentumFilltype::Ascending, SpinorFillType::ascendingComplex, EVEN);
    }
