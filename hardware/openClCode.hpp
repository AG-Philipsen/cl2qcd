...
namespace hardware {
    class OpenClCode {
      public:
        OpenClCode(const hardware::code::OpenClKernelParametersInterface& kernelParametersIn)
            : kernelParameters(&kernelParametersIn){};
        ~OpenClCode() {}
        ...
        {
            return std::unique_ptr<hardware::code::Gaugefield>(
                new hardware::code::Gaugefield{*kernelParameters, deviceIn});
        }
        ...
        {
            return std::unique_ptr<hardware::code::Gaugemomentum>(
                new hardware::code::Gaugemomentum{*kernelParameters, deviceIn});
        }
        std::unique_ptr<hardware::code::Molecular_Dynamics>
        getCode_Molecular_Dynamics(const hardware::Device* deviceIn) const
        {
            return std::unique_ptr<hardware::code::Molecular_Dynamics>(
                new hardware::code::Molecular_Dynamics{*kernelParameters, deviceIn});
        }
        std::unique_ptr<hardware::code::Correlator> getCode_Correlator(const hardware::Device* deviceIn) const
        {
            return std::unique_ptr<hardware::code::Correlator>(
                new hardware::code::Correlator{*kernelParameters, deviceIn});
        }
        ...
        std::unique_ptr<hardware::code::Spinors_staggered>
        getCode_Spinors_staggered(const hardware::Device* deviceIn) const
        {
            return std::unique_ptr<hardware::code::Spinors_staggered>(
                new hardware::code::Spinors_staggered{*kernelParameters, deviceIn});
        }
        std::unique_ptr<hardware::code::Correlator_staggered>
        getCode_Correlator_staggered(const hardware::Device* deviceIn) const
        {
            return std::unique_ptr<hardware::code::Correlator_staggered>(
                new hardware::code::Correlator_staggered{*kernelParameters, deviceIn});
        }
        std::unique_ptr<hardware::code::Fermions_staggered>
        getCode_Fermions_staggered(const hardware::Device* deviceIn) const
        {
            return std::unique_ptr<hardware::code::Fermions_staggered>(
                new hardware::code::Fermions_staggered{*kernelParameters, deviceIn});
        }
