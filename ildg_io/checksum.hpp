...
class Checksum {
  public:
    ...
    inline uint32_t get_suma() const noexcept { return suma; }

    inline uint32_t get_sumb() const noexcept { return sumb; }
    ...
    bool operator==(const Checksum& other) { return suma == other.suma && sumb == other.sumb; }
