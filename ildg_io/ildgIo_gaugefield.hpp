...
namespace ildgIo {
    ...
    class IldgIoWriter_gaugefield : public LimeFileWriter {
      public:
        IldgIoWriter_gaugefield(const std::vector<Matrixsu3>& data, const IldgIoParameters* parameters,
    ...
    void copy_gaugefield_to_ildg_format(std::vector<char>& dest, const std::vector<Matrixsu3>& source_in,
                                        const IldgIoParameters& parameters);
