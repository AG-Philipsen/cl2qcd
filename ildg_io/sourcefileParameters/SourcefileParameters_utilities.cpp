...
void goThroughBufferWithXmlReaderAndExtractInformationBasedOnMap(const char* buffer, int size,
...
static void
setParametersToValues_scidacChecksum(Sourcefileparameters& parameters, std::map<std::string, std::string> parserMap)
{
    uint32_t suma, sumb;
...
void sourcefileParameters::setFromLimeEntry_scidacChecksum(Sourcefileparameters& parameters, char* buffer,
