...
Matrixsu3* ildgIo::readGaugefieldFromSourcefile(std::string ildgfile,
                                                const physics::lattices::GaugefieldParametersInterface* parameters,
                                                int& trajectoryNumberAtInit)
{
    Matrixsu3* gf_host = nullptr;  // will be allocated by the following line, init to 0 to ensure error in case we fuck
                                   // up.
...
void ildgIo::writeGaugefieldToFile(std::string outputfile, std::vector<Matrixsu3>& host_buf,
                                   const physics::lattices::GaugefieldParametersInterface* parameters,
