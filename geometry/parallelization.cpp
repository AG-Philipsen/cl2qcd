...
TemporalParallelizationHandler::TemporalParallelizationHandler(const LatticeGridIndex lGI,
                                                               const LocalLatticeExtents lLE,
                                                               const size_t sizeOfElement, const size_t haloSize)
    : lLE(lLE)
    , lGI(lGI)
...
TemporalParallelizationHandlerLink::TemporalParallelizationHandlerLink(const LatticeGridIndex lGI,
                                                                       const LocalLatticeExtents lLE,
...
TemporalParallelizationHandlerNonLink::TemporalParallelizationHandlerNonLink(const LatticeGridIndex lGI,
                                                                             const LocalLatticeExtents lLE,
                                                                             const size_t sizeOfElement,
                                                                             const size_t haloSize)
    : TemporalParallelizationHandler(lGI, lLE, sizeOfElement, haloSize)
...
{
    return hyperVolume() * ((lGI * localExtentInSlowestDirection - haloSize + lLE.tExtent * lGI.t.extent) %
                            (lLE.tExtent * lGI.t.extent));
}
