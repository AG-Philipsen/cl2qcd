    ...
    namespace algorithms {
        ...
        class SolversParametersImplementation final : public SolversParametersInterface {
          public:
            ...
            SolversParametersImplementation(const meta::Inputparameters& paramsIn) : parameters(paramsIn) {}
            virtual ~SolversParametersImplementation() {}
            virtual unsigned getCgMax() const override { return parameters.get_cgmax(); }
            virtual unsigned getIterRefresh() const override { return parameters.get_iter_refresh(); }
            ...
            virtual bool getCgUseAsyncCopy() const override { return parameters.get_cg_use_async_copy(); }
            virtual bool getUseMergeKernelsSpinor() const override { return parameters.get_use_merge_kernels_spinor(); }
        ...
        class MinMaxEigenvalueParametersImplementation final : public MinMaxEigenvalueParametersInterface {
          public:
            ...
            virtual unsigned getFindMinMaxMaxValue() const override { return parameters.get_findminmax_max(); }
        ...
        class ForcesParametersImplementation final : public ForcesParametersInterface {
          public:
            ...
            virtual bool getUseGaugeOnly() const override { return parameters.get_use_gauge_only(); }
            virtual bool getUseRectangles() const override { return meta::get_use_rectangles(parameters); }
        ...
        class InversionParametersImplementation final : public InversionParemetersInterface {
          public:
            ...
            virtual common::action getFermact() const override { return parameters.get_fermact(); }
            virtual common::solver getSolver() const override { return parameters.get_solver(); }
            virtual double getSolverPrec() const override { return parameters.get_solver_prec(); }
            virtual bool getUseEo() const override { return parameters.get_use_eo(); }
            virtual bool getUseSmearing() const override { return parameters.get_use_smearing(); }
        ...
        class IntegratorParametersImplementation final : public IntegratorParametersInterface {
          public:
            ...
            virtual unsigned getNumTimescales() const override { return parameters.get_num_timescales(); }
            virtual double getTau() const override { return parameters.get_tau(); }
            virtual bool getUseMp() const override { return parameters.get_use_mp(); }
        ...
        class MetropolisParametersImplementation final : public MetropolisParametersInterface {
          public:
            ...
            virtual double getC0() const override { return meta::get_c0(parameters); }
            virtual double getC1() const override { return meta::get_c1(parameters); }
            virtual common::action getFermact() const override { return parameters.get_fermact(); }
            virtual size_t getRectanglesNormalization() const override { return meta::get_rect_norm(parameters); }
            virtual common::solver getSolver() const override { return parameters.get_solver(); }
            virtual double getSolverPrec() const override { return parameters.get_solver_prec(); }
            virtual bool getUseGaugeOnly() const override { return parameters.get_use_gauge_only(); }
            virtual bool getUseMp() const override { return parameters.get_use_mp(); }
        ...
        class HmcParametersImplementation final : public HmcParametersInterface {
          public:
            ...
            virtual double getBeta() const override { return parameters.get_beta(); }
            virtual bool getUseEo() const override { return parameters.get_use_eo(); }
            virtual bool getUseGaugeOnly() const override { return parameters.get_use_gauge_only(); }
            virtual bool getUseMp() const override { return parameters.get_use_mp(); }
        ...
        class RhmcParametersImplementation final : public RhmcParametersInterface {
          public:
            ...
            virtual double getBeta() const override { return parameters.get_beta(); }
            virtual bool getConservative() const override { return parameters.get_conservative(); }
            virtual double getFindMinMaxPrec() const override { return parameters.get_findminmax_prec(); }
            virtual double getMass() const override { return parameters.get_mass(); }
            virtual bool getUseGaugeOnly() const override { return parameters.get_use_gauge_only(); }
            virtual bool getUseMp() const override { return parameters.get_use_mp(); }
            virtual bool getUseEo() const override { return parameters.get_use_eo(); }
