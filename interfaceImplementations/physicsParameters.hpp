...
namespace physics {
    ...
    class StaggeredAdditionalParameters final : public AdditionalParameters {
      public:
        ...
        bool getConservative() const override { return parameters.get_conservative(); }
    ...
    class FermionParametersImplementation final : public FermionParametersInterface,
      ...
      public:
        ...
        FermionParametersImplementation(const meta::Inputparameters& parametersIn)
            : lattices::SpinorfieldParametersImplementation(parametersIn)
            , fermionmatrix::FermionmatrixParametersImplementation(parametersIn)
        {
        }
        unsigned getNt() const override { return lattices::SpinorfieldParametersImplementation::getNt(); }
        unsigned getNs() const override { return lattices::SpinorfieldParametersImplementation::getNs(); }
    ...
    class FermionEoParametersImplementation final : public FermionEoParametersInterface,
      ...
      public:
        ...
        FermionEoParametersImplementation(const meta::Inputparameters& parametersIn)
            : lattices::SpinorfieldEoParametersImplementation(parametersIn)
            , fermionmatrix::FermionmatrixParametersImplementation(parametersIn)
        {
        }
        common::action getFermionicActionType() const override
    ...
    class FermionStaggeredEoParametersImplementation
        : public FermionStaggeredEoParametersInterface,
      ...
      public:
        ...
        FermionStaggeredEoParametersImplementation(const meta::Inputparameters& parametersIn)
            : lattices::StaggeredfieldEoParametersImplementation(parametersIn)
            , fermionmatrix::FermionmatrixStaggeredParametersImplementation(parametersIn)
        {
        }
        unsigned getNumberOfElements() const override
        {
    ...
    class SourcesParametersImplementation final : public SourcesParametersInterface {
      public:
        ...
        unsigned getSourceT() const override { return parameters.get_source_t(); }
        unsigned getSourceX() const override { return parameters.get_source_x(); }
        unsigned getSourceY() const override { return parameters.get_source_y(); }
        unsigned getSourceZ() const override { return parameters.get_source_z(); }
    ...
    class PrngParametersImplementation final : public PrngParametersInterface {
      public:
        PrngParametersImplementation(const meta::Inputparameters& fullParametersIn)
            : fullParameters(fullParametersIn){};
        ...
        virtual bool useSameRandomNumbers() const override { return fullParameters.get_use_same_rnd_numbers(); }
        virtual std::string getNamePrefix() const override { return fullParameters.get_prng_prefix(); }
        virtual std::string getNamePostfix() const override { return fullParameters.get_prng_postfix(); }
        virtual int getNumberOfDigitsInName() const override { return fullParameters.get_config_number_digits(); }
