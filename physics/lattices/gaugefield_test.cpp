...
BOOST_AUTO_TEST_CASE(initialization)
{
...

    {
        ...
        BOOST_CHECK_CLOSE(physics::observables::measurePlaquette(&gf, gaugeobservablesParameters), 0.57107711169452713,
                          0.1);
    }
}
...
BOOST_AUTO_TEST_CASE(rectangles)
{
    ...
    BOOST_CHECK_CLOSE(physics::observables::measureRectangles(&gf2, gaugeobservablesParameters), 1103.2398401620451,
                      0.1);
}
