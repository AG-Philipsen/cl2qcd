...
namespace physics {
    namespace lattices {
        ...
        template<class Lattice, typename Basetype>
        void pseudo_randomize(const Lattice* to, int seed);
        ...
        class Spinorfield {
          ...
          private:
            ...
            friend void
            saxpy(const Spinorfield* out, const hmc_complex alpha, const Spinorfield& x, const Spinorfield& y);
            friend void sax(const Spinorfield* out, const hmc_complex alpha, const Spinorfield& x);
            friend void saxsbypz(const Spinorfield* out, const hmc_complex alpha, const Spinorfield& x,
         ...
         */
        std::vector<Spinorfield*> create_spinorfields(const hardware::System& system, const size_t n,
        ...
        void
        saxpy(const Spinorfield* out, const Scalar<hmc_complex>& alpha, const Spinorfield& x, const Spinorfield& y);
         ...
         */
        void saxsbypz(const Spinorfield* out, const hmc_complex alpha, const Spinorfield& x, const hmc_complex beta,
                      const Spinorfield& y, const Spinorfield& z);
        void saxsbypz(const Spinorfield* out, const Scalar<hmc_complex>& alpha, const Spinorfield& x,
         ...
         *
         * A window means all buffers of the first field will be filled with the same content of one buffer of the
         * second field.
         */
