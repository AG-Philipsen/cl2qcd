...
physics::lattices::Spinorfield::Spinorfield(const hardware::System& system,
    ...
    : system(system)
    , spinorfieldParametersInterface(spinorfieldParametersInterface)
    , spinorfield(system, place_on_host)
    , place_on_host(place_on_host)
{
}
...
physics::lattices::create_spinorfields(const hardware::System& system, const size_t n,
                                       physics::InterfacesHandler& interfacesHandler, const bool place_on_host)
{
    ...
    for (size_t i = 0; i < n; ++i) {
        fields.push_back(
            new Spinorfield(system, interfacesHandler.getInterface<physics::lattices::Spinorfield>(), place_on_host));
    }
...
void physics::lattices::scalar_product(const Scalar<hmc_complex>* res, const Spinorfield& left,
                                       const Spinorfield& right)
{
...
void physics::lattices::saxpy(const Spinorfield* out, const hmc_complex alpha, const Spinorfield& x,
                              const Spinorfield& y)
{
...
void physics::lattices::saxpy(const Spinorfield* out, const Scalar<hmc_complex>& alpha, const Spinorfield& x,
                              const Spinorfield& y)
{
    auto out_bufs   = out->get_buffers();
...
void physics::lattices::saxsbypz(const Spinorfield* out, const hmc_complex alpha, const Spinorfield& x,
                                 const hmc_complex beta, const Spinorfield& y, const Spinorfield& z)
{
    const Scalar<hmc_complex> alpha_buf(out->system);
...
void physics::lattices::saxsbypz(const Spinorfield* out, const Scalar<hmc_complex>& alpha, const Spinorfield& x,
                                 const Scalar<hmc_complex>& beta, const Spinorfield& y, const Spinorfield& z)
{
    auto out_bufs   = out->get_buffers();
    auto alpha_bufs = alpha.get_buffers();
    auto x_bufs     = x.get_buffers();
...
void physics::lattices::fill_window(const physics::lattices::Spinorfield* out,
                                    const physics::lattices::Spinorfield& src, const size_t idx)
{
