    ...
    namespace lattices {
        ...
        class Gaugemomenta {
          ...
          private:
            ...
            friend void
            saxpy(const Gaugemomenta* out, const hmc_float alpha, const Gaugemomenta& x, const Gaugemomenta& y);
        ...
        void
        saxpy(const Gaugemomenta* out, const Scalar<hmc_float>& alpha, const Gaugemomenta& x, const Gaugemomenta& y);
        ...
        template<typename S, void (*T)(const S*, const hmc_float, const S&, const S&)>
        size_t get_flops(const hardware::System&);
        template<>
        size_t get_flops<physics::lattices::Gaugemomenta, physics::lattices::saxpy>(const hardware::System&);
        ...
        size_t get_flops(const hardware::System&);
        template<>
        size_t get_flops<physics::lattices::Gaugemomenta, physics::lattices::squarenorm>(const hardware::System&);
