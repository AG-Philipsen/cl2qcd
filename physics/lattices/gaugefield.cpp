...
void physics::lattices::measurePlaqAndPoly(const physics::lattices::Gaugefield& gf, int iter, const std::string& filename, meta::Inputparameters params)
{
	hmc_float plaq;
	hmc_float tplaq;
	hmc_float splaq;
...
void physics::lattices::measurePlaqAndPoly(const physics::lattices::Gaugefield& gf, int iter, meta::Inputparameters params)
{
