...
BOOST_AUTO_TEST_CASE(initialization)
{
    ...
    BOOST_CHECK_NO_THROW(
        Rooted_Staggeredfield_eo sf2(system,
                                     interfacesHandler.getInterface<physics::lattices::Rooted_Staggeredfield_eo>(),
                                     approx));
}
...
BOOST_AUTO_TEST_CASE(initializationWithPseudofermions)
{
    ...
    const char* _params[] = {"foo", "--nPseudoFermions=3", "--fermionAction=rooted_stagg"};
...
BOOST_AUTO_TEST_CASE(rangeBasedForLoopOnPseudofermions)
{
    ...
    {
        const Rooted_Staggeredfield_eo sf(system, interfacesHandler
...
BOOST_AUTO_TEST_CASE(rescale)
{
    ...
    hmc_float a_ref[15] = {-2.722986658932525683e-07,  -1.2631475639728917521e-06, -4.360435755914117958e-06,
                           -1.4160691433260296987e-05, -4.5207926211912900696e-05, -0.00014352921651252466598,
                           -0.00045497933178524781715, -0.0014431546521933168083,  -0.0045926953908840342788,
                           -0.014747783330565073998,   -0.048456946841957317107,   -0.16880046472141346792,
                           -0.68431552061715394952,    -4.2198332136416603078,     -117.03837887995429412};
    hmc_float b_ref[15] = {9.2907369101588763806e-06, 5.0627210699159516975e-05, 0.00016198783558680096995,
                           0.00044474583457844121164, 0.0011563267279465730842,  0.0029447969579766914219,
                           0.007440491639209977949,   0.018751086281155571189,   0.047271072978110562079,
                           0.11959352757092110708,    0.30563294009891067704,    0.80189441104810432748,
    ...
    hmc_float a_ref_cons[15] = {-2.8942286130576286221e-07, -1.3425838169907005556e-06, -4.6346528686679587346e-06,
                                -1.5051222595004849162e-05, -4.8050941840019680289e-05, -0.00015255541700051565286,
                                -0.00048359186633654911497, -0.0015339111096058541221,  -0.0048815187425726713766,
                                -0.015675235262161982264,   -0.051504285410779379606,   -0.17941591204330820108,
                                -0.72735044574402074602,    -4.4852081772741634325,     -124.39863554566063897};
    hmc_float b_ref_cons[15] = {9.7552862512145591676e-06, 5.3158639325027219212e-05, 0.00017008744523117717558,
                                0.00046698372446689161283, 0.0012141446195419417376,  0.003092040766471044512,
                                0.007812526228236587808,   0.019688665814428581158,   0.04963469020409881638,
                                0.12557336479641045823,    0.32091499816392937694,    0.84199021010590602287,
