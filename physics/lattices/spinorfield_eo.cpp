...
physics::lattices::Spinorfield_eo::Spinorfield_eo(
    const hardware::System& system, const SpinorfieldEoParametersInterface& spinorfieldEoParametersInterface)
    : system(system)
    , spinorfieldEo(system)
    , spinorfieldEoParametersInterface(spinorfieldEoParametersInterface)
...
void physics::lattices::scalar_product(const Scalar<hmc_complex>* res, const Spinorfield_eo& left,
                                       const Spinorfield_eo& right)
{
    auto res_buffers   = res->get_buffers();
    auto left_buffers  = left.get_buffers();
    auto right_buffers = right.get_buffers();
...
void physics::lattices::saxpy(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x,
                              const Spinorfield_eo& y)
{
...
void physics::lattices::saxpy_AND_squarenorm(const Spinorfield_eo* out, const Scalar<hmc_complex>& alpha,
                                             const Spinorfield_eo& x, const Spinorfield_eo& y,
                                             const Scalar<hmc_complex>& squarenorm)
{
    auto out_bufs        = out->get_buffers();
    auto x_bufs          = x.get_buffers();
    auto y_bufs          = y.get_buffers();
    ...
    for (size_t i = 0; i < out_bufs.size(); ++i) {
        auto out_buf = out_bufs[i];
        auto device  = out_buf->get_device();
        device->getSpinorCode()->saxpy_AND_squarenorm_eo_device(x_bufs[i], y_bufs[i], alpha_bufs[i], out_buf,
                                                                squarenorm_bufs[i]);
    }
...
void physics::lattices::saxpy(const Spinorfield_eo* out, const Scalar<hmc_complex>& alpha, const Spinorfield_eo& x,
                              const Spinorfield_eo& y)
{
    auto out_bufs   = out->get_buffers();
    auto alpha_bufs = alpha.get_buffers();
...
void physics::lattices::saxpy_AND_gamma5_eo(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x,
                                            const Spinorfield_eo& y)
{
...
void physics::lattices::saxsbypz(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x,
                                 const hmc_complex beta, const Spinorfield_eo& y, const Spinorfield_eo& z)
{
    const Scalar<hmc_complex> alpha_buf(out->system);
...
void physics::lattices::saxsbypz(const Spinorfield_eo* out, const Scalar<hmc_complex>& alpha, const Spinorfield_eo& x,
                                 const Scalar<hmc_complex>& beta, const Spinorfield_eo& y, const Spinorfield_eo& z)
{
    auto out_bufs   = out->get_buffers();
    auto alpha_bufs = alpha.get_buffers();
    auto x_bufs     = x.get_buffers();
    ...
    for (size_t i = 0; i < out_bufs.size(); ++i) {
        auto out_buf = out_bufs[i];
        auto device  = out_buf->get_device();
        device->getSpinorCode()->saxsbypz_eoprec_device(x_bufs[i], y_bufs[i], z_bufs[i], alpha_bufs[i], beta_bufs[i],
                                                        out_buf);
    }

    auto const valid_halo_width = std::min(
        {x.get_valid_halo_width(), y.get_valid_halo_width(), z.get_valid_halo_width()});
    if (valid_halo_width) {
        out->mark_halo_clean(valid_halo_width);
    } else {
        out->mark_halo_dirty();
...
void physics::lattices::convert_from_eoprec(const Spinorfield* merged, const Spinorfield_eo& even,
                                            const Spinorfield_eo& odd)
{
    even.require_halo();
    odd.require_halo();
...
template<>
size_t physics::lattices::get_flops<physics::lattices::Spinorfield_eo, physics::lattices::scalar_product>(
...
template<>
size_t physics::lattices::get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::scalar_product>(
    const hardware::System& system)
{
    // assert single system
    auto devices     = system.get_devices();
...
template<>
size_t physics::lattices::get_flops<physics::lattices::Spinorfield_eo, physics::lattices::squarenorm>(
    const hardware::System& system)
{
    // assert single system
    auto devices     = system.get_devices();
...
template<>
size_t physics::lattices::get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::squarenorm>(
    const hardware::System& system)
{
    // assert single system
    auto devices     = system.get_devices();
...
template<>
size_t
physics::lattices::get_flops<physics::lattices::Spinorfield_eo, physics::lattices::sax>(const hardware::System& system)
{
    // assert single system
    auto devices     = system.get_devices();
    auto spinor_code = devices[0]->getSpinorCode();
...
template<>
size_t physics::lattices::get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::sax>(
    const hardware::System& system)
{
    // assert single system
    auto devices     = system.get_devices();
...
template<>
size_t physics::lattices::get_flops<physics::lattices::Spinorfield_eo, physics::lattices::saxpy>(
    const hardware::System& system)
{
    // assert single system
    auto devices     = system.get_devices();
...
template<>
size_t physics::lattices::get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::saxpy>(
    const hardware::System& system)
{
    // assert single system
    auto devices     = system.get_devices();
...
template<>
size_t physics::lattices::get_flops<physics::lattices::Spinorfield_eo, physics::lattices::saxsbypz>(
    const hardware::System& system)
{
    // assert single system
    auto devices     = system.get_devices();
...
template<>
size_t physics::lattices::get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::saxsbypz>(
    const hardware::System& system)
{
    // assert single system
    auto devices     = system.get_devices();
...
hardware::lattices::Spinorfield_eoHaloUpdate
physics::lattices::Spinorfield_eo::require_halo_async(unsigned reqd_width) const
{
...
void physics::lattices::copyData(const physics::lattices::Spinorfield_eo* to,
                                 const physics::lattices::Spinorfield_eo& from)
{
