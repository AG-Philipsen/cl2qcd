    ...
    namespace lattices {
        ...
        class Spinorfield_eo {
          ...
          public:
             ...
             *
             * \param width Only require the the given width of the halo to be up to date, use 0 to indicate the full
             * halo is required.
             */
             ...
             * Therefore commands using the default queues of each buffer can safely operate on the non-halo elements if
          ...
          private:
            ...
            friend void
            saxpy(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x, const Spinorfield_eo& y);
            friend void sax(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x);
            friend void saxsbypz(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x,
         ...
         * Calculate the scalar product of two spinorfields.
         *
         * The given tmp buffer is used to avoid initialization costs. It will be modified, but does not have to contain
         * the result afterwards.
         */
        hmc_complex
        scalar_product(const Spinorfield_eo& left, const Spinorfield_eo& right, const Scalar<hmc_complex>* res);
        /**
         * Calculate the scalar product of two spinorfields.
         *
        ...
        template<typename S, hmc_complex (*T)(const S&, const S&)>
        size_t get_flops(const hardware::System&);
        template<>
        size_t get_flops<physics::lattices::Spinorfield_eo, physics::lattices::scalar_product>(const hardware::System&);
        template<typename S, hmc_complex (*T)(const S&, const S&)>
        size_t get_read_write_size(const hardware::System&);
        template<>
        size_t get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::scalar_product>(
        ...
        size_t get_flops(const hardware::System&);
        template<>
        size_t get_flops<physics::lattices::Spinorfield_eo, physics::lattices::squarenorm>(const hardware::System&);
        template<typename S, hmc_float (*T)(const S&)>
        size_t get_read_write_size(const hardware::System&);
        template<>
        size_t
        get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::squarenorm>(const hardware::System&);
        ...
        void
        saxpy(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x, const Spinorfield_eo& y);
        void saxpy(const Spinorfield_eo* out, const Scalar<hmc_complex>& alpha, const Spinorfield_eo& x,
                   const Spinorfield_eo& y);

        template<typename S, void (*T)(const S*, const hmc_complex, const S&, const S&)>
        size_t get_flops(const hardware::System&);
        template<>
        size_t get_flops<physics::lattices::Spinorfield_eo, physics::lattices::saxpy>(const hardware::System&);
        template<typename S, void (*T)(const S*, const hmc_complex, const S&, const S&)>
        size_t get_read_write_size(const hardware::System&);
        template<>
        size_t
        get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::saxpy>(const hardware::System&);
        ...
        template<typename S, void (*T)(const S*, const hmc_complex, const S&)>
        size_t get_flops(const hardware::System&);
        template<>
        size_t get_flops<physics::lattices::Spinorfield_eo, physics::lattices::sax>(const hardware::System&);
        template<typename S, void (*T)(const S*, const hmc_complex, const S&)>
        size_t get_read_write_size(const hardware::System&);
        template<>
        size_t get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::sax>(const hardware::System&);
         ...
         */
        void saxsbypz(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x,
                      const hmc_complex beta, const Spinorfield_eo& y, const Spinorfield_eo& z);
        void saxsbypz(const Spinorfield_eo* out, const Scalar<hmc_complex>& alpha, const Spinorfield_eo& x,
        ...
        size_t get_flops(const hardware::System&);
        template<>
        size_t get_flops<physics::lattices::Spinorfield_eo, physics::lattices::saxsbypz>(const hardware::System&);
        template<typename S, void (*T)(const S*, const hmc_complex, const S&, const hmc_complex, const S&, const S&)>
        size_t get_read_write_size(const hardware::System&);
        template<>
        size_t
        get_read_write_size<physics::lattices::Spinorfield_eo, physics::lattices::saxsbypz>(const hardware::System&);
        ...
        void saxpy_AND_squarenorm(const Spinorfield_eo* out, const Scalar<hmc_complex>& alpha, const Spinorfield_eo& x,
                                  const Spinorfield_eo& y, const Scalar<hmc_complex>& squarenorm);
        void saxpy_AND_gamma5_eo(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x,
                                 const Spinorfield_eo& y);
