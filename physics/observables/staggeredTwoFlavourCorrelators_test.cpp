...
void compare_staggered_correlator(std::string which,
...
void test_staggered_correlator(const char* _params[], const std::vector<hmc_float>& ps_ref, bool coldOrZero)
{
    ...
    std::vector<physics::lattices::Staggeredfield_eo*>
        invertedSourcesEven = create_staggeredfields_eo(system, num_sources, interfacesHandler);
    std::vector<physics::lattices::Staggeredfield_eo*>
        invertedSourcesOdd = create_staggeredfields_eo(system, num_sources, interfacesHandler);
