...
BOOST_AUTO_TEST_CASE(testWlsonCorrelatorsObservablesParameters)
{
    auto params = createDefaultMetaInputparameters();
    ...
    BOOST_CHECK_EQUAL(test.getFermionObservablesCorrelatorFilename("conf.00000"), meta::get_ferm_obs_corr_file_name(*params, "conf.00000"));
    BOOST_CHECK_EQUAL(test.placeOfSourcesOnHost(), params->get_place_sources_on_host());
    BOOST_CHECK_EQUAL(test.getNumberOfSources(), params->get_num_sources());
}
