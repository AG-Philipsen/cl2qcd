...
BOOST_AUTO_TEST_CASE(md_update_gaugefield)
{
    ...
    using namespace physics::algorithms;
    {
...

        {
            ...
            hmc_float ref = physics::observables::measurePlaquette(&gf, interfacesHandler
                                                                            .getGaugeObservablesParametersInterface());
            gauge_force(&gm, gf);
            physics::algorithms::md_update_gaugefield(&gf, gm, .5);
            double plaq = physics::observables::measurePlaquette(&gf, interfacesHandler
                                                                          .getGaugeObservablesParametersInterface());
...

    {
        ...
        BOOST_REQUIRE_CLOSE(physics::observables::measurePlaquette(&gf, interfacesHandler
                                                                            .getGaugeObservablesParametersInterface()),
                            0.57107711169452713, 0.0001);
        physics::algorithms::md_update_gaugefield(&gf, gm, .5);
        BOOST_REQUIRE_CLOSE(physics::observables::measurePlaquette(&gf, interfacesHandler
                                                                            .getGaugeObservablesParametersInterface()),
                            0.57107711169452713, 0.0001);
...
BOOST_AUTO_TEST_CASE(mdUpdateStaggeredRootedSpinorfieldEo)
{
    ...
    Rooted_Staggeredfield_eo out(system, interfacesHandler.getInterface<physics::lattices::Rooted_Staggeredfield_eo>(),
                                 approx);
...
{
    {
        ...
        physics::algorithms::md_update_gaugemomentum_fermion(&gm, .6, gf, sf1, system, interfacesHandler,
                                                             interfacesHandler.getAdditionalParameters<Spinorfield>());
...
{
    {
        ...
        physics::algorithms::md_update_gaugemomentum_fermion(&gm, .6, gf, sf1, system, interfacesHandler,
                                                             interfacesHandler
                                                                 .getAdditionalParameters<Spinorfield_eo>());
...
BOOST_AUTO_TEST_CASE(md_update_gaugemomentum_detratio)
{
    {
        using namespace physics::lattices;
        const char* _params[] = {"foo", "--nTime=4", "--kappaMP=.25"};
...
{
    {
        ...
        physics::algorithms::md_update_gaugemomentum(&gm, .5, gf, sf1, system, interfacesHandler,
                                                     interfacesHandler.getAdditionalParameters<Spinorfield>());
...
{
    {
        ...
        physics::algorithms::md_update_gaugemomentum(&gm, .6, gf, sf1, system, interfacesHandler,
                                                     interfacesHandler.getAdditionalParameters<Spinorfield_eo>());
