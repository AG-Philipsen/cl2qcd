...
namespace physics {
    namespace algorithms {
        namespace solvers {
             ...
             * For further details, see B.Jegerlehner arXiv:hep-lat/9612014v1, even if here there are some missing
             * information and also some wrong indeces. Then compare with "Accurate conjugate gradient methods for
             * families of shifted systems" that is a work by Jasper van den Eshof and Gerard L. G. Sleijpen of December
             * 2003: here the notation is completely different, but one can build the complete CG-M algorithm. This was
             * done and summarized in the file CG-M.pdf (see Feature #482)
             *
             ...
             */
            int cg_m(const std::vector<std::shared_ptr<physics::lattices::Staggeredfield_eo>> x,
                     const physics::fermionmatrix::Fermionmatrix_stagg_eo& A, const physics::lattices::Gaugefield& gf,
                     const std::vector<hmc_float> sigma, const physics::lattices::Staggeredfield_eo& b,
            ...
            class SolverShifted {
              ...
              private:
                ...
                void
                debugLogSquarenormSetOfFields(const std::string&,
                                              const std::vector<std::shared_ptr<physics::lattices::Staggeredfield_eo>>,
                                              const int);
                ...
                // Auxiliary scalars
                const physics::lattices::Scalar<hmc_float> alpha_scalar_prev;  // This is alpha_scalar at the step
                                                                               // iter-1
