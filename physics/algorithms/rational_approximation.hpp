    ...
    namespace algorithms {
        ...
        class Rational_Coefficients {
          public:
             ...
             */
            Rational_Coefficients(const int d, const hmc_float a0, const std::vector<hmc_float> a,
        ...
        class Rational_Approximation : public Rational_Coefficients {
          public:
             ...
             */
            Rational_Approximation(int d, int y, int z, hmc_float low, hmc_float high, bool inv = true,
                                   int precision = 113);
            ...
            Rescale_Coefficients(const hmc_float minEigenvalue, const hmc_float maxEigenvalue) const;
