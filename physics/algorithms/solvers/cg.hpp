...
namespace physics {
    namespace algorithms {
        namespace solvers {
             ...
             */
            int cg(const physics::lattices::Spinorfield* x, const physics::fermionmatrix::Fermionmatrix& A,
             ...
             * \exception SolverDidNotSolve if the solver did not solve (hit iteration limit).
             */
            int cg(const physics::lattices::Spinorfield_eo* x, const physics::fermionmatrix::Fermionmatrix_eo& A,
