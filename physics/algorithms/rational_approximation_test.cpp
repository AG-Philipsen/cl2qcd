...
BOOST_AUTO_TEST_CASE(rescale)
{
	...
	Rational_Coefficients coeff = approx.Rescale_Coefficients(matrix, gf, system, interfacesHandler, 1.e-3, params.get_mass(), false);
	Rational_Coefficients coeff_cons = approx.Rescale_Coefficients(matrix, gf, system, interfacesHandler, 1.e-3, params.get_mass(), true);
