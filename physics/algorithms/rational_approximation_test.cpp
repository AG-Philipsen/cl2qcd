...
BOOST_AUTO_TEST_CASE(coefficients)
{
    ...
    hmc_float res[5] = {0.0194661374678695, 0.03561358805557574, 0.0821572765515051, 0.21113622523593300,
                        0.7946025292155642};
    hmc_float pol[5] = {0.0002065381736724, 0.00302707751065980, 0.0200732678058145, 0.12517586269872370,
                        1.0029328743375700};
