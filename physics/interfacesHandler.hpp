...
namespace physics {
    ...
    class InterfacesHandler {
      public:
        ...
        const typename InterfaceType<OBJECT>::value& getInterface();
        template<class OBJECT>
        const physics::AdditionalParameters& getAdditionalParameters(bool withMassPreconditioning = false);

        // TODO: For the moment there is no object responsible to calculate observables, so we leave the following
        // getters out of the above template
        //      Think about to create objects in physics::observables and move these getters in the template above.
        //      Actually the observables are similar to algorithms in the sense that their nature is more a function
        //      than an object. Nevertheless, one could make them static in a class so that one would have here an
        //      object to use in getInterface!
        virtual const physics::observables::GaugeObservablesParametersInterface&
        getGaugeObservablesParametersInterface() = 0;
        virtual const physics::observables::WilsonTwoFlavourChiralCondensateParametersInterface&
        getWilsonTwoFlavourChiralCondensateParametersInterface() = 0;
        virtual const physics::observables::StaggeredChiralCondensateParametersInterface&
        getStaggeredChiralCondensateParametersInterface() = 0;
        virtual const physics::observables::WilsonTwoFlavourCorrelatorsParametersInterface&
        getWilsonTwoFlavourCorrelatorsParametersInterface() = 0;
        virtual const physics::observables::StaggeredTwoFlavourCorrelatorsParametersInterface&
        getStaggeredTwoFlavourCorrelatorsParametersInterface() = 0;
        ...
        virtual const physics::algorithms::MinMaxEigenvalueParametersInterface&
        getMinMaxEigenvalueParametersInterface()                                                             = 0;
      ...
      private:
        ...
        virtual const physics::lattices::StaggeredfieldEoParametersInterface&
        getStaggeredfieldEoParametersInterface() = 0;
        virtual const physics::lattices::RootedStaggeredfieldEoParametersInterface&
        getRootedStaggeredfieldEoParametersInterface() = 0;
        virtual const physics::fermionmatrix::FermionmatrixParametersInterface&
        getFermionmatrixParametersInterface() = 0;
        virtual const physics::fermionmatrix::FermionmatrixStaggeredParametersInterface&
        getFermionmatrixStaggeredParametersInterface()                                                           = 0;
    ...
    template<>
    inline const typename InterfaceType<physics::lattices::Gaugefield>::value&
    InterfacesHandler::getInterface<physics::lattices::Gaugefield>()
    {
        return getGaugefieldParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::lattices::Gaugemomenta>::value&
    InterfacesHandler::getInterface<physics::lattices::Gaugemomenta>()
    {
        return getGaugemomentaParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::lattices::Spinorfield>::value&
    InterfacesHandler::getInterface<physics::lattices::Spinorfield>()
    {
        return getSpinorfieldParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::lattices::Spinorfield_eo>::value&
    InterfacesHandler::getInterface<physics::lattices::Spinorfield_eo>()
    {
        return getSpinorfieldEoParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::lattices::Staggeredfield_eo>::value&
    InterfacesHandler::getInterface<physics::lattices::Staggeredfield_eo>()
    {
        return getStaggeredfieldEoParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::lattices::Rooted_Staggeredfield_eo>::value&
    InterfacesHandler::getInterface<physics::lattices::Rooted_Staggeredfield_eo>()
    {
        return getRootedStaggeredfieldEoParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::M>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::M>()
    {
        return getFermionmatrixParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::Qplus>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::Qplus>()
    {
        return getFermionmatrixParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::Qminus>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::Qminus>()
    {
        return getFermionmatrixParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::QplusQminus>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::QplusQminus>()
    {
        return getFermionParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::Aee>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::Aee>()
    {
        return getFermionEoParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::Aee_minus>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::Aee_minus>()
    {
        return getFermionEoParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::Qplus_eo>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::Qplus_eo>()
    {
        return getFermionEoParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::Qminus_eo>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::Qminus_eo>()
    {
        return getFermionEoParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::QplusQminus_eo>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::QplusQminus_eo>()
    {
        return getFermionEoParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::D_KS_eo>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::D_KS_eo>()
    {
        return getFermionmatrixStaggeredParametersInterface();
    }
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::MdagM_eo>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::MdagM_eo>()
    {
        return getFermionStaggeredEoParametersInterface();
    }

    template<>
    inline const physics::AdditionalParameters&
    InterfacesHandler::getAdditionalParameters<physics::lattices::Spinorfield>(bool withMassPreconditioning)
    {
        return getWilsonAdditionalParameters(withMassPreconditioning);
    }
    template<>
    inline const physics::AdditionalParameters&
    InterfacesHandler::getAdditionalParameters<physics::lattices::Spinorfield_eo>(bool withMassPreconditioning)
    {
        return getWilsonAdditionalParameters(withMassPreconditioning);
    }
    template<>
    inline const physics::AdditionalParameters&
    InterfacesHandler::getAdditionalParameters<physics::lattices::Staggeredfield_eo>(bool)
    {
        return getStaggeredAdditionalParameters();
    }
    template<>
    inline const physics::AdditionalParameters&
    InterfacesHandler::getAdditionalParameters<physics::lattices::Rooted_Staggeredfield_eo>(bool)
    {
        return getStaggeredAdditionalParameters();
    }
