...
namespace physics {
    ...
    namespace fermionmatrix {
         ...
         */
        void DKS_eo(const physics::lattices::Staggeredfield_eo* out, const physics::lattices::Gaugefield& gf,
                    const physics::lattices::Staggeredfield_eo& in, int evenodd);
        ...
        class Fermionmatrix_stagg_basic {
          ...
          protected:
            Fermionmatrix_stagg_basic(
                const hardware::System& system,
                const FermionmatrixStaggeredParametersInterface& fermionmatrixStaggeredParametersInterface, bool herm,
                bool hasMinEigenThreshold)
                : fermionmatrixStaggeredParametersInterface(fermionmatrixStaggeredParametersInterface)
                , isMatrixHermitian(herm)
                , hasMatrixMinimumEigenvalueThreshold(hasMinEigenThreshold)
                , system(system){};
        ...
        class Fermionmatrix_stagg_eo : public Fermionmatrix_stagg_basic {
          public:
             ...
             */
            virtual void operator()(const physics::lattices::Staggeredfield_eo* out,
                                    const physics::lattices::Gaugefield& gf,
                                    const physics::lattices::Staggeredfield_eo& in,
                                    const physics::AdditionalParameters* additionalParameters = NULL) const = 0;
            virtual ~Fermionmatrix_stagg_eo() {}

          protected:
            Fermionmatrix_stagg_eo(
                const hardware::System& system,
                const FermionmatrixStaggeredParametersInterface& fermionmatrixStaggeredParametersInterface, bool herm,
                bool hasMinEigenThreshold)
                : Fermionmatrix_stagg_basic(system, fermionmatrixStaggeredParametersInterface, herm,
                                            hasMinEigenThreshold){};
        };
        ...
        class D_KS_eo final : public Fermionmatrix_stagg_eo {
          public:
            D_KS_eo(const hardware::System& system,
                    const FermionmatrixStaggeredParametersInterface& fermionmatrixStaggeredParametersInterface,
                    bool evenodd)
                : Fermionmatrix_stagg_eo(system, fermionmatrixStaggeredParametersInterface, false, false)
                , evenodd(evenodd){};
            void operator()(const physics::lattices::Staggeredfield_eo* out, const physics::lattices::Gaugefield& gf,
                            const physics::lattices::Staggeredfield_eo& in,
                            const physics::AdditionalParameters* additionalParameters = NULL) const override;
        ...
        class MdagM_eo final : public Fermionmatrix_stagg_eo {
          public:
            MdagM_eo(const hardware::System& system,
                     const physics::FermionStaggeredEoParametersInterface& fermionStaggeredEoParametersInterface,
                     bool ul = EVEN)
                : Fermionmatrix_stagg_eo(system, fermionStaggeredEoParametersInterface, true, true)
                , tmp(system, fermionStaggeredEoParametersInterface)
                , upper_left(ul){};
            void operator()(const physics::lattices::Staggeredfield_eo* out, const physics::lattices::Gaugefield& gf,
                            const physics::lattices::Staggeredfield_eo& in,
                            const physics::AdditionalParameters* additionalParameters = NULL) const override;
