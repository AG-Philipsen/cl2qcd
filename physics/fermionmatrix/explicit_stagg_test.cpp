...
{
    // void physics::fermionmatrix::DKS_eo(const physics::lattices::Staggeredfield_eo * out, const
    // physics::lattices::Gaugefield& gf, const physics::lattices::Staggeredfield_eo& in, int evenodd)
    {
