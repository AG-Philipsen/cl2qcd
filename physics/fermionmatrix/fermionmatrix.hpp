...
namespace physics {
    ...
    namespace fermionmatrix {
         ...
         */
        void M_wilson(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
                      const physics::lattices::Spinorfield& in, hmc_float kappa);
        void M_tm_plus(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
                       const physics::lattices::Spinorfield& in, hmc_float kappa, hmc_float mubar);
        void M_tm_minus(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
                        const physics::lattices::Spinorfield& in, hmc_float kappa, hmc_float mubar);
        void M_tm_inverse_sitediagonal(const physics::lattices::Spinorfield_eo* out,
                                       const physics::lattices::Spinorfield_eo& in, hmc_float mubar);
        void M_tm_sitediagonal(const physics::lattices::Spinorfield_eo* out,
                               const physics::lattices::Spinorfield_eo& in, hmc_float mubar);
        void M_tm_inverse_sitediagonal_minus(const physics::lattices::Spinorfield_eo* out,
                                             const physics::lattices::Spinorfield_eo& in, hmc_float mubar);
        void M_tm_sitediagonal_minus(const physics::lattices::Spinorfield_eo* out,
                                     const physics::lattices::Spinorfield_eo& in, hmc_float mubar);
        void dslash(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
                    const physics::lattices::Spinorfield_eo& in, int evenodd, hmc_float kappa);
        ...
        class Fermionmatrix_basic {
          ...
          protected:
            Fermionmatrix_basic(const hardware::System& system,
                                const FermionmatrixParametersInterface& fermionmatrixParametersInterface, bool herm)
                : fermionmatrixParametersInterface(fermionmatrixParametersInterface)
                , _is_hermitian(herm)
                , system(system){};
        ...
        class Fermionmatrix : public Fermionmatrix_basic {
          public:
             ...
             */
            virtual void operator()(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
                                    const physics::lattices::Spinorfield& in,
                                    const physics::AdditionalParameters& additionalParameters) const = 0;
            virtual ~Fermionmatrix(){};

          protected:
            Fermionmatrix(bool herm, const hardware::System& system,
                          const FermionmatrixParametersInterface& fermionmatrixParametersInterface)
        ...
        class Fermionmatrix_eo : public Fermionmatrix_basic {
          public:
             ...
             * Invoke the matrix function.
             */
            virtual void operator()(const physics::lattices::Spinorfield_eo* out,
          ...
          protected:
            Fermionmatrix_eo(bool herm, const hardware::System& system,
                             const FermionmatrixParametersInterface& fermionmatrixParametersInterface)
                : Fermionmatrix_basic(system, fermionmatrixParametersInterface, herm){};
        };
        ...
        class Qminus final : public Fermionmatrix {
          public:
            Qminus(const hardware::System& system,
                   const FermionmatrixParametersInterface& fermionmatrixParametersInterface)
                : Fermionmatrix(false, system, fermionmatrixParametersInterface){};
            void operator()(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
                            const physics::lattices::Spinorfield& in,
        ...
        class QplusQminus final : public Fermionmatrix {
          public:
            QplusQminus(const hardware::System& system, const FermionParametersInterface& fermionParametersInterface)
                : Fermionmatrix(true, system, fermionParametersInterface)
                , q_plus(system, fermionParametersInterface)
                , q_minus(system, fermionParametersInterface)
                , tmp(system, fermionParametersInterface){};
            void operator()(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
                            const physics::lattices::Spinorfield& in,
                            const physics::AdditionalParameters& additionalParameters) const override;
            cl_ulong get_flops() const override;
        ...
        class Aee final : public Fermionmatrix_eo {
          public:
            Aee(const hardware::System& system, const FermionEoParametersInterface& fermionEoParametersInterface)
                ...
                , tmp2(system, fermionEoParametersInterface){};
        ...
        class Aee_AND_gamma5_eo final : public Fermionmatrix_eo {
          public:
            Aee_AND_gamma5_eo(const hardware::System& system,
                              const FermionEoParametersInterface& fermionEoParametersInterface)
                : Fermionmatrix_eo(false, system, fermionEoParametersInterface)
                , tmp(system, fermionEoParametersInterface)
                , tmp2(system, fermionEoParametersInterface){};
            void operator()(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
        ...
        class Aee_minus_AND_gamma5_eo final : public Fermionmatrix_eo {
          public:
            Aee_minus_AND_gamma5_eo(const hardware::System& system,
                                    const FermionEoParametersInterface& fermionEoParametersInterface)
                : Fermionmatrix_eo(false, system, fermionEoParametersInterface)
                , tmp(system, fermionEoParametersInterface)
                , tmp2(system, fermionEoParametersInterface){};
        ...
        class QplusQminus_eo final : public Fermionmatrix_eo {
          public:
            QplusQminus_eo(const hardware::System& system,
                           const FermionEoParametersInterface& fermionEoParametersInterface)
