...
{
    // void M_wilson(const physics::lattices::Spinorfield * out, const physics::lattices::Gaugefield& gf, const
...
{
    // void M_tm_plus(const physics::lattices::Spinorfield * out, const physics::lattices::Gaugefield& gf, const
...
{
    // void M_tm_minus(const physics::lattices::Spinorfield * out, const physics::lattices::Gaugefield& gf, const
    // physics::lattices::Spinorfield& in, hmc_float kappa = ARG_DEF, hmc_float mubar = ARG_DEF);
    {
        using namespace physics::lattices;
        const char* _params[] = {"foo", "--nTime=16", "--fermionAction=twistedmass"};
...
{
    // void M_tm_inverse_sitediagonal(const physics::lattices::Spinorfield_eo * out, const
...
{
    // void M_tm_sitediagonal(const physics::lattices::Spinorfield_eo * out, const physics::lattices::Spinorfield_eo&
...
{
    // void M_tm_inverse_sitediagonal_minus(const physics::lattices::Spinorfield_eo * out, const
    // physics::lattices::Spinorfield_eo& in, hmc_float mubar = ARG_DEF);
    {
        using namespace physics::lattices;
        const char* _params[] = {"foo", "--nTime=16", "--fermionAction=twistedmass"};
...
{
    // void M_tm_sitediagonal_minus(const physics::lattices::Spinorfield_eo * out, const
    // physics::lattices::Spinorfield_eo& in, hmc_float mubar = ARG_DEF);
    {
        using namespace physics::lattices;
        const char* _params[] = {"foo", "--nTime=16", "--fermionAction=twistedmass"};
...
{
    // void dslash(const physics::lattices::Spinorfield_eo * out, const physics::lattices::Gaugefield& gf, const
    // physics::lattices::Spinorfield_eo& in, int evenodd, hmc_float kappa = ARG_DEF);
