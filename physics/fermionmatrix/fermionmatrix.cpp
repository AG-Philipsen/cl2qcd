...
void physics::fermionmatrix::M::
operator()(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield& in, const physics::AdditionalParameters& additionalParameters) const
{
    switch (fermionmatrixParametersInterface.getFermionicActionType()) {
        ...
        case common::action::twistedmass:
            ...
            break;
        default:
            throw Invalid_Parameters("Unkown fermion action!", "wilson or twistedmass",
                                     fermionmatrixParametersInterface.getFermionicActionType());
    }
}
...
void physics::fermionmatrix::Qplus::
operator()(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield& in, const physics::AdditionalParameters& additionalParameters) const
{
    switch (fermionmatrixParametersInterface.getFermionicActionType()) {
...
void physics::fermionmatrix::Qminus::
operator()(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield& in, const physics::AdditionalParameters& additionalParameters) const
{
    switch (fermionmatrixParametersInterface.getFermionicActionType()) {
...
void physics::fermionmatrix::QplusQminus::
operator()(const physics::lattices::Spinorfield* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield& in, const physics::AdditionalParameters& additionalParameters) const
{
...
void physics::fermionmatrix::Aee::
operator()(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
    ...
    switch (fermionmatrixParametersInterface.getFermionicActionType()) {
        case common::action::wilson:
            ...
            break;
        case common::action::twistedmass:  // explicit scope to be able to declare variable in it, initializing it at
                                           // the same time
        {
...
void physics::fermionmatrix::Aee_AND_gamma5_eo::
operator()(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
    /**
...
void physics::fermionmatrix::Aee_minus::
operator()(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
    /**
...
void physics::fermionmatrix::Aee_minus_AND_gamma5_eo::
operator()(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
    /**
...
void physics::fermionmatrix::Qplus_eo::
operator()(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
...
void physics::fermionmatrix::Qminus_eo::
operator()(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
    if (fermionmatrixParametersInterface.useMergedFermionicKernels() == false) {
...
void physics::fermionmatrix::QplusQminus_eo::
operator()(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
    q_minus(&tmp, gf, in, additionalParameters);
