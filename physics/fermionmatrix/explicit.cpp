...
void physics::fermionmatrix::M_wilson(const physics::lattices::Spinorfield* out,
                                      const physics::lattices::Gaugefield& gf, const physics::lattices::Spinorfield& in,
                                      hmc_float kappa)
{
...
void physics::fermionmatrix::M_tm_plus(const physics::lattices::Spinorfield* out,
...
void physics::fermionmatrix::M_tm_minus(const physics::lattices::Spinorfield* out,
                                        const physics::lattices::Gaugefield& gf,
                                        const physics::lattices::Spinorfield& in, hmc_float kappa, hmc_float mubar)
{
    auto out_bufs = out->get_buffers();
...
void physics::fermionmatrix::M_tm_inverse_sitediagonal(const physics::lattices::Spinorfield_eo* out,
...
void physics::fermionmatrix::M_tm_sitediagonal(const physics::lattices::Spinorfield_eo* out,
                                               const physics::lattices::Spinorfield_eo& in, hmc_float mubar)
{
    auto out_bufs = out->get_buffers();
    auto in_bufs  = in.get_buffers();
...
void physics::fermionmatrix::M_tm_inverse_sitediagonal_minus(const physics::lattices::Spinorfield_eo* out,
...
void physics::fermionmatrix::M_tm_sitediagonal_minus(const physics::lattices::Spinorfield_eo* out,
                                                     const physics::lattices::Spinorfield_eo& in, hmc_float mubar)
{
    auto out_bufs = out->get_buffers();
    auto in_bufs  = in.get_buffers();
...
void physics::fermionmatrix::dslash(const physics::lattices::Spinorfield_eo* out,
                                    const physics::lattices::Gaugefield& gf,
