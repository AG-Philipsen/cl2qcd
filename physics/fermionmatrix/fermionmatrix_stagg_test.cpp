...
typename boost::enable_if<
    boost::is_base_of<physics::fermionmatrix::Fermionmatrix_stagg_eo, physics::fermionmatrix::D_KS_eo>, void>::type
test_fermionmatrix_stagg<physics::fermionmatrix::D_KS_eo>(const hmc_float refs[4]);

BOOST_AUTO_TEST_CASE(D_KS_eo)
{
    const hmc_float refs[4] = {2030.1639500272767691, 2076.7437224316167885, 547.69039343718509372,
                               536.10645183266251479};
    test_fermionmatrix_stagg<physics::fermionmatrix::D_KS_eo>(refs);
}

BOOST_AUTO_TEST_CASE(MdagM_eo)
{
    const hmc_float refs[4] = {12670.438549218517437, 12925.274439556447760, 2980.0540282922056576,
                               2883.0056841550949684};
...
{
    {
        ...
        physics::fermionmatrix::D_KS_eo matrix1(system,
                                                interfacesHandler.getInterface<physics::fermionmatrix::D_KS_eo>(),
                                                EVEN);
        physics::fermionmatrix::D_KS_eo matrix2(system,
