...
meta::ParametersConfig::ParametersConfig() : options("Configuration options")
{
	...
	("startingPrng", po::value<std::string>(&initial_prng_state)->default_value(""),"The path of the file containing the pseudo random number generator state to start from.")
