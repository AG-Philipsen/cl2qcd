...
static void
check(const ConfigFileNormalizer& normalizer, const std::string& input_filename, const std::string reference_value);
...
BOOST_AUTO_TEST_CASE(test_noop)
{
    ...
    check(cand, "config_file_normalizer_test_input1",
          "bla=blub\n"
          "foo=bla\n"
          "old=new\n"
          "new=old\n"
