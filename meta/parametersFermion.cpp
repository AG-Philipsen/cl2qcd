    ...
    , fermactMP(common::action::wilson)
{
    ...
    ("chemicalPotentialRe", po::value<double>(&chem_pot_re)->default_value(chem_pot_re),"The value of the real part of the baryon chemical potential.")
    ("chemicalPotentialIm", po::value<double>(&chem_pot_im)->default_value(chem_pot_im),"The value of the imaginary part of the baryon chemical potential.")
    ("useChemicalPotentialRe", po::value<bool>(&use_chem_pot_re)->default_value(use_chem_pot_re),"Whether to switch on a nonzero real part of the baryon chemical potential.")
    ("useChemicalPotentialIm", po::value<bool>(&use_chem_pot_im)->default_value(use_chem_pot_im),"Whether to switch on a nonzero imaginary part of the baryon chemical potential.")
