...
__kernel void test(__global hmc_ocl_gaugefield* gaugefield,__global hmc_float* beta, const int nsteps,__global hmc_float* check,__global hmc_ocl_gaugefield* gaugefield2){
