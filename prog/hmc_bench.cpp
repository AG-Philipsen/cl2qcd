...
{
	std::cout << "This is HMC-Benchmarking Programme " << name << endl;
	return;
}


//CP: This is the HMC-Benchmarking programme, which is basically a copy of the HMC
int main(int argc, char* argv[])
{
	...
	logger.trace() << "perform HMC-Benchmarking on device... ";
	//main hmc-loop
	logger.trace() << "start HMC-Benchmarking loop with " << hmc_iter << " iterations: " ;
