...
void Dummyfield::runTestKernel2()
{
	...
	static_cast<Device*>(opencl_modules[0])->runTestKernel2(out_eo, in_eo1, in_eo2, *(get_clmem_gaugefield()), gs, ls, get_parameters()->get_kappa(), get_parameters()->get_mubar());
}
...
void Dummyfield::runTestKernel2withconvertedfields()
{
	...
	static_cast<Device*>(opencl_modules[0])->runTestKernel2(out_eo_converted, in_eo1_converted, in_eo2_converted, *(get_clmem_gaugefield()), gs, ls, get_parameters()->get_kappa(), get_parameters()->get_mubar());
}
...
void Dummyfield::runTestKernel()
{
	...
	static_cast<Device*>(opencl_modules[0])->runTestKernel(out_noneo, in_noneo, *(get_clmem_gaugefield()), gs, ls, get_parameters()->get_kappa(), get_parameters()->get_mubar());
}
...
void Dummyfield::runTestKernelwithconvertedfields()
{
	...
	static_cast<Device*>(opencl_modules[0])->runTestKernel(out_noneo_converted, in_noneo_converted, *(get_clmem_gaugefield()), gs, ls, get_parameters()->get_kappa(), get_parameters()->get_mubar());
}
