...
void md_update_spinorfield(const physics::lattices::Staggeredfield_eo * out, const physics::lattices::Gaugefield& gf, const physics::lattices::Spinorfield_eo& orig, physics::algorithms::Rational_Coefficients& coeff, const hardware::System& system, hmc_float mass);
