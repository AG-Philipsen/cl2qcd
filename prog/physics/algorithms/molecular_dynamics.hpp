...
void md_update_gaugemomentum_gauge(const physics::lattices::Gaugemomenta * const gm, const physics::lattices::Gaugefield& gf, const hardware::System& system, hmc_float eps);
