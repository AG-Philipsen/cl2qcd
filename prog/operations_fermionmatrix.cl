...
// //this is M with the original gammas for debugging
// __kernel void M(__global spinorfield * in, __global ocl_s_gaugefield * field, __global spinorfield * out){
// int id = get_global_id(0);
// if (id ==0){
//   int n,t,nn, dir;
...
// //		if(n==0 && t==0){
// //	if(t==0&&n==0) printf("\nout:\n");
// //		if(n==0 && t==0)print_spinor(out_tmp);
// //		if(n==0 && t==0)print_spinor(plus);
// 
// 		psi = su3vec_dim_i(plus.e0, plus.e3);
// 		phi = su3matrix_times_su3vec(U, psi);
// 		psi = su3vec_times_real(phi, kappa_minus);
...
// //		}
// 
// //if(n==0 && t==0){printf("at mu=+1:\n");print_spinor(out_tmp);}
// //if(t==0&n==0) printf("mu1: %f\n", spinor_squarenorm(out_tmp));
// 	//out_tmp = set_spinor_zero();
// 
// 	       	///////////////////////////////////
// 		//mu = -1
