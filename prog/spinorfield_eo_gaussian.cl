__kernel void generate_gaussian_spinorfield_eoprec(__global spinorStorageType * const restrict out, __global rngStateStorageType * const restrict rngStates)
{
