 ...
 */
inline su3vec get_spinor_staggered_eo(__global const staggeredStorageType * const restrict in, const uint idx)
{
#ifdef _USE_SOA_
	return (su3vec) {
		{
 ...
 */
inline void put_spinor_staggered_eo(__global staggeredStorageType * const restrict out, const uint idx, const su3vec val)
{
#ifdef _USE_SOA_
	// su3vec = 3 * cplx
