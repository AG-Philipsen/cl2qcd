...
hmc_error create_point_source_eoprec(hmc_eoprec_spinor_field* be,hmc_eoprec_spinor_field* bo,int i,int spacepos,int timepos,hmc_float kappa, hmc_float mu, hmc_gaugefield* gaugefield){
  ...
  dslash_eoprec(be,spintmp,gaugefield,kappa,EVEN);
