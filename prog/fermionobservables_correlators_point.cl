...
__kernel void correlator_sc_z(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_sc_t(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_vx_z(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_vx_t(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_vy_z(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_vy_t(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_vz_z(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_vz_t(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_ax_z(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_ax_t(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_ay_z(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_ay_t(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_az_z(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
...
__kernel void correlator_az_t(__global hmc_float * const restrict out, __global const spinor * const restrict phi)
{
	int local_size = get_local_size(0);
	int global_size = get_global_size(0);
	int id = get_global_id(0);
