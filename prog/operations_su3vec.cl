...
su3vec su3matrix_times_su3vec(Matrixsu3 u, su3vec in){
	...
	hmc_float u20_re = reconstruct_su3(u, 0).re;
	hmc_float u20_im = reconstruct_su3(u, 0).im;
	hmc_float u21_re = reconstruct_su3(u, 1).re;
	hmc_float u21_im = reconstruct_su3(u, 1).im;
	hmc_float u22_re = reconstruct_su3(u, 2).re;
	hmc_float u22_im = reconstruct_su3(u, 2).im;
	
	tmp.e0.re = u.e00.re*in.e0.re + u.e01.re * in.e1.re + u.e02.re * in.e2.re;
	tmp.e0.im = u.e00.im*in.e0.im + u.e01.im * in.e1.im + u.e02.im * in.e2.im;
	tmp.e1.re = u.e10.re*in.e0.re + u.e11.re * in.e1.re + u.e12.re * in.e2.re;
	tmp.e1.im = u.e10.im*in.e0.im + u.e11.im * in.e1.im + u.e12.im * in.e2.im;
	tmp.e2.re = u20_re*in.e0.re + u21_re * in.e1.re + u22_re * in.e2.re;
	tmp.e2.im = u20_im*in.e0.im + u21_im * in.e1.im + u22_im * in.e2.im;
	#else
	tmp.e0.re = u.e00.re*in.e0.re + u.e01.re * in.e1.re + u.e02.re * in.e2.re;
	tmp.e0.im = u.e00.im*in.e0.im + u.e01.im * in.e1.im + u.e02.im * in.e2.im;
	tmp.e1.re = u.e10.re*in.e0.re + u.e11.re * in.e1.re + u.e12.re * in.e2.re;
	...
	tmp.e2.im = u.e20.im*in.e0.im + u.e21.im * in.e1.im + u.e22.im * in.e2.im;
	#endif
	return tmp;
}
...
su3vec su3matrix_dagger_times_su3vec(Matrixsu3 u, su3vec in){
	...
	tmp.e0.im = -u.e00.im*in.e0.im - u.e10.im * in.e1.im - u.e20.im * in.e2.im;
	tmp.e1.re =  u.e01.re*in.e0.re + u.e11.re * in.e1.re + u.e21.re * in.e2.re;
	tmp.e1.im = -u.e01.im*in.e0.im - u.e11.im * in.e1.im - u.e21.im * in.e2.im;
	tmp.e2.re =  u02_re*in.e0.re + u12_re * in.e1.re + u22_re * in.e2.re;
	tmp.e2.im = -u02_im*in.e0.im - u12_im * in.e1.im - u22_im * in.e2.im;
	#else
	tmp.e0.re =  u.e00.re*in.e0.re + u.e10.re * in.e1.re + u.e20.re * in.e2.re;
	tmp.e0.im = -u.e00.im*in.e0.im - u.e10.im * in.e1.im - u.e20.im * in.e2.im;
	tmp.e1.re =  u.e01.re*in.e0.re + u.e11.re * in.e1.re + u.e21.re * in.e2.re;
	...
	tmp.e2.im = -u.e02.im*in.e0.im - u.e12.im * in.e1.im - u.e22.im * in.e2.im;
	#endif
	return tmp;
}
