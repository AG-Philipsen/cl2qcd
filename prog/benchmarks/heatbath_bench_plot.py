...
if __name__ == '__main__':
	...
	parser.add_argument('--title', default='Heatbath Performance', help='Title to use for the plot')
	...
	main(datafiles, labels, r'heatbath_(odd|even)', args.output, args.metric, False if args.notitle else args.title, args.maxSize, False, False, args.grayscale)
