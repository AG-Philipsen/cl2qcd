...
__kernel void scalar_product_eoprec( __global const hmc_complex  * const restrict x, __global const hmc_complex * const restrict y, __global hmc_complex * const restrict result, __local hmc_complex * const restrict result_local )
{
