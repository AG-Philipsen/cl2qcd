...
)
{
	...
	logger.info() << "*******************************************************************";
	logger.info() << "total runtime:" << setfill(' ') << setw(12) << totaltime;
	logger.info() << "Times:\t" << setfill(' ') << setw(12) << "tot" << '\t' << setw(12) << "avg" << '\t' << setw(12) << "site" << '\t' << setw(5) << "perc";

	logger.info() << "Init.:\t" << setfill(' ') << setw(12) << inittime << '\t' << setw(12) << inittime << '\t' << setw(12) << divide(inittime, VOL4D) << '\t' << setw(5) << fixed << setw(5) << setprecision(1) << percent(inittime, totaltime) ;
	logger.info() << "Copy.:\t" << setfill(' ') << setw(12) << copytime << '\t' << setw(12) << copy_avgtime << '\t' << setw(12) << copytime << '\t' << fixed << setw(5) << setprecision(1) << percent(copytime, totaltime);
	logger.info() << "Plaq.:\t" << setfill(' ') << setw(12) << plaqtime << '\t' << setw(12) << plaq_avgtime << '\t' << setw(12) << plaq_avgtime_site << '\t' << fixed << setw(5) << setprecision(1) << percent(plaqtime, totaltime);
	logger.info() << "Poly.:\t" << setfill(' ') << setw(12) << polytime << '\t' << setw(12) << poly_avgtime << '\t' << setw(12) << poly_avgtime_site << '\t' << fixed << setw(5) << setprecision(1) << percent(polytime, totaltime);
	logger.info() << "Updt.:\t" << setfill(' ') << setw(12) << updatetime << '\t' << setw(12) << update_avgtime << '\t' << setw(12) << update_avgtime_site << '\t' << fixed << setw(5) << setprecision(1) << percent(updatetime, totaltime);
	logger.info() << "Over.:\t" << setfill(' ') << setw(12) << overrelaxtime << '\t' << setw(12) << overrelax_avgtime << '\t' << setw(12) << overrelax_avgtime_site << '\t' << fixed << setw(5) << setprecision(1) << percent(overrelaxtime, totaltime);
	logger.info() << "*******************************************************************";
