...
__kernel void fermion_force_eo(__global const ocl_s_gaugefield * const restrict field, __global const spinorStorageType * const restrict Y, __global const spinorStorageType * const restrict X, __global ae * const restrict out, int evenodd)
{
