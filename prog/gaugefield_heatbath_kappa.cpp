...
void Gaugefield_heatbath_kappa::init_devices(){
  ...
  opencl_modules[1] = new Opencl_Module[1];
  opencl_modules[1]->init(queue[1], get_clmem_gaugefield(), get_parameters(), get_max_compute_units(1), get_double_ext(1));
