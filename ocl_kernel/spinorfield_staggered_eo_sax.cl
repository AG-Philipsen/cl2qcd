...
__kernel void sax_arg_staggered_eoprec(__global const staggeredStorageType * const x, const hmc_float alpha_re, const hmc_float alpha_im, __global staggeredStorageType * const out)
{
