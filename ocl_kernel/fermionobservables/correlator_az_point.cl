...
hmc_float calculate_az_correlator(const spinor in1, const spinor in2, const spinor in3, const spinor in4)
{
    hmc_float correlator = 0.0f;

    correlator += su3vec_squarenorm(in1.e0) - su3vec_squarenorm(in1.e1) - su3vec_squarenorm(in1.e2) +
                  su3vec_squarenorm(in1.e3);
    correlator += -su3vec_squarenorm(in2.e0) + su3vec_squarenorm(in2.e1) + su3vec_squarenorm(in2.e2) -
                  su3vec_squarenorm(in2.e3);
    correlator += -su3vec_squarenorm(in3.e0) + su3vec_squarenorm(in3.e1) + su3vec_squarenorm(in3.e2) -
                  su3vec_squarenorm(in3.e3);
    correlator += su3vec_squarenorm(in4.e0) - su3vec_squarenorm(in4.e1) - su3vec_squarenorm(in4.e2) +
                  su3vec_squarenorm(in4.e3);
...
__kernel void correlator_az_z(__global hmc_float* const restrict out, __global const spinor* const restrict phi1,
                              __global const spinor* const restrict phi2, __global const spinor* const restrict phi3,
                              __global const spinor* const restrict phi4)
{
        ...
        for (int t = 0; t < NTIME_LOCAL; t++) {
            for (coord.x = 0; coord.x < NSPACE; coord.x++) {
                for (coord.y = 0; coord.y < NSPACE; coord.y++) {
                    ...
                    correlator += calculate_az_correlator(tmp1, tmp2, tmp3, tmp4);
                }
            }
        }
