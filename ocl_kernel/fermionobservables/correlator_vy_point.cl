...
hmc_complex calculate_vy_correlator(const spinor in1, const spinor in2, const spinor in3, const spinor in4)
{
    hmc_complex restmp;
        ...
        for (int t = 0; t < NTIME_LOCAL; t++) {
            for (coord.x = 0; coord.x < NSPACE; coord.x++) {
                for (coord.y = 0; coord.y < NSPACE; coord.y++) {
                    ...
                    cortmp = calculate_vy_correlator(tmp1, tmp2, tmp3, tmp4);
