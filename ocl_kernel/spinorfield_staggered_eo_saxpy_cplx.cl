...
__kernel void saxpy_cplx_staggered_eoprec(__global const staggeredStorageType* const restrict x,
...
__kernel void saxpy_cplx_arg_staggered_eoprec(__global const staggeredStorageType* const restrict x,
                                              __global const staggeredStorageType* const restrict y,
