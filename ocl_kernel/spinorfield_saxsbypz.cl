...
// alpha*x + beta*y + z
__kernel void saxsbypz(__global const spinor* const restrict x, __global const spinor* const restrict y,
                       __global const spinor* const restrict z, __global const hmc_complex* const restrict alpha,
                       __global const hmc_complex* const restrict beta, __global spinor* const restrict out)
{
