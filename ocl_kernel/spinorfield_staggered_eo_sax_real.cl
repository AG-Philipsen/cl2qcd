...
__kernel void sax_real_staggered_eoprec(__global const staggeredStorageType * const x, __global const hmc_float * const alpha, __global staggeredStorageType * const out)
{
...
__kernel void sax_real_arg_staggered_eoprec(__global const staggeredStorageType * const x, const hmc_float alpha, __global staggeredStorageType * const out)
{
