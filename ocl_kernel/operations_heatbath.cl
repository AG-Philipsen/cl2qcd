...
#endif
        delta = -log(rands.x) / alpha * pow(cos((hmc_float)(2.f * PI * rands.y)), (hmc_float)2.f) -
                log(rands.z) / alpha;
        a0  = 1. - delta;
        eta = rands.w;
...
inline void perform_heatbath(__global Matrixsu3StorageType* const restrict gaugefield, const int mu,
...
#    pragma unroll 1
    ...
    for (int i = 0; i < NC; i++) {
        ...
        hmc_float k = sqrt(w_pauli.e00 * w_pauli.e00 + w_pauli.e01 * w_pauli.e01 + w_pauli.e10 * w_pauli.e10 +
                           w_pauli.e11 * w_pauli.e11);

        hmc_float beta_new = 2. * BETA / NC * k;

        Matrixsu2_pauli r_pauli = SU2Update(beta_new, rnd);

        w.e00.re = (r_pauli.e00 * w_pauli.e00 + r_pauli.e01 * w_pauli.e01 + r_pauli.e10 * w_pauli.e10 +
                    r_pauli.e11 * w_pauli.e11) /
                   k;
        w.e00.im = (w_pauli.e00 * r_pauli.e11 - w_pauli.e11 * r_pauli.e00 + r_pauli.e01 * w_pauli.e10 -
                    r_pauli.e10 * w_pauli.e01) /
                   k;
        w.e01.re = (w_pauli.e00 * r_pauli.e10 - w_pauli.e10 * r_pauli.e00 + r_pauli.e11 * w_pauli.e01 -
                    r_pauli.e01 * w_pauli.e11) /
                   k;
        w.e01.im = (w_pauli.e00 * r_pauli.e01 - w_pauli.e01 * r_pauli.e00 + r_pauli.e10 * w_pauli.e11 -
                    r_pauli.e11 * w_pauli.e10) /
                   k;
        w.e10.re = -(w_pauli.e00 * r_pauli.e10 - w_pauli.e10 * r_pauli.e00 + r_pauli.e11 * w_pauli.e01 -
                     r_pauli.e01 * w_pauli.e11) /
                   k;
        w.e10.im = (w_pauli.e00 * r_pauli.e01 - w_pauli.e01 * r_pauli.e00 + r_pauli.e10 * w_pauli.e11 -
                    r_pauli.e11 * w_pauli.e10) /
                   k;
        w.e11.re = (r_pauli.e00 * w_pauli.e00 + r_pauli.e01 * w_pauli.e01 + r_pauli.e10 * w_pauli.e10 +
                    r_pauli.e11 * w_pauli.e11) /
                   k;
        w.e11.im = -(w_pauli.e00 * r_pauli.e11 - w_pauli.e11 * r_pauli.e00 + r_pauli.e01 * w_pauli.e10 -
                     r_pauli.e10 * w_pauli.e01) /
                   k;
...
inline void perform_overrelaxing(__global Matrixsu3StorageType* const restrict gaugefield, const int mu,
                                 prng_state* const restrict rnd, const int pos, const int t)
{
    Matrix3x3 staplematrix;
#ifdef _ANISO_
    ...
    for (int i = 0; i < NC; i++) {
        ...
        w.e00.re = (w_pauli.e00 * w_pauli.e00 - w_pauli.e01 * w_pauli.e01 - w_pauli.e10 * w_pauli.e10 -
                    w_pauli.e11 * w_pauli.e11) /
                   k / k;
        ...
        w.e11.re = (w_pauli.e00 * w_pauli.e00 - w_pauli.e01 * w_pauli.e01 - w_pauli.e10 * w_pauli.e10 -
                    w_pauli.e11 * w_pauli.e11) /
                   k / k;
