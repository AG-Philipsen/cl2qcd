...
__kernel void global_squarenorm_staggered_eoprec( __global const staggeredStorageType * const restrict x, __global hmc_float * const restrict result, __local hmc_float * const restrict result_local )
{
