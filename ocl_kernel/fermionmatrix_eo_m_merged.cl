...
__kernel void M_tm_sitediagonal_AND_gamma5_eo(__global const spinorStorageType* const restrict in,
...
__kernel void M_tm_sitediagonal_minus_AND_gamma5_eo(__global const spinorStorageType* const restrict in,
                                                    __global spinorStorageType* const restrict out, hmc_float mubar_in)
{
    int global_size = get_global_size(0);
    int id          = get_global_id(0);
