...
__kernel void md_update_gaugefield(const hmc_float eps, __global const aeStorageType* const restrict p_in,
                                   __global Matrixsu3StorageType* const restrict u_inout)
{
    ...
    PARALLEL_FOR (index, VOL4D_MEM * NDIM) {
        ...
        // &(p_in[index*8]) should point to the right position for the pos-th element of the long gaugemomentum vector
        // p_in
