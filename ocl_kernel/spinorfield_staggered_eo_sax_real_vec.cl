...
__kernel void sax_real_vec_staggered_eoprec(__global const staggeredStorageType * const x, __global const hmc_float * const alpha, const int index_alpha, __global staggeredStorageType * const out)
{
