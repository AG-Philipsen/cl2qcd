...
__kernel void saxpby_real_vec_staggered_eoprec(__global const staggeredStorageType * const x, __global const staggeredStorageType * const y, __global const hmc_float * const alpha, __global hmc_float * beta, const int index_alpha, const int index_beta, __global staggeredStorageType * const out)
{
