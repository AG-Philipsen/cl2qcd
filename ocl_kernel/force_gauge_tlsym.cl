...
__kernel void
gauge_force_tlsym(__global const Matrixsu3StorageType* const restrict field, __global aeStorageType* const restrict out)
{
#ifndef _USE_RECT_
...
#    error should not be used if rect is deactivated
    ...
    PARALLEL_FOR (id_local, VOL4D_LOCAL * NDIM) {
        ...
        // NOTE: this is not necessarily equal to the geometric  conventions, one just needs a one-to-one correspondence
        // between thread-id and (n,t,mu) here
...
__kernel void gauge_force_tlsym_multipass1_tpe(__global const Matrixsu3StorageType* const restrict field,
                                               __global Matrix3x3StorageType* const restrict tmp)
{
...
__kernel void gauge_force_tlsym_multipass2_tpe(__global const Matrixsu3StorageType* const restrict field,
                                               __global Matrix3x3StorageType* const restrict tmp)
{
    const size_t id_local = get_global_id(0);
    if (id_local < VOL4D_LOCAL * NDIM) {
...
__kernel void gauge_force_tlsym_multipass3_tpe(__global const Matrixsu3StorageType* const restrict field,
                                               __global Matrix3x3StorageType* const restrict tmp)
{
    const size_t id_local = get_global_id(0);
    if (id_local < VOL4D_LOCAL * NDIM) {
...
__kernel void gauge_force_tlsym_multipass4_tpe(__global const Matrixsu3StorageType* const restrict field,
                                               __global Matrix3x3StorageType* const restrict tmp)
{
    const size_t id_local = get_global_id(0);
    if (id_local < VOL4D_LOCAL * NDIM) {
...
__kernel void gauge_force_tlsym_multipass5_tpe(__global const Matrixsu3StorageType* const restrict field,
                                               __global Matrix3x3StorageType* const restrict tmp)
{
    const size_t id_local = get_global_id(0);
    if (id_local < VOL4D_LOCAL * NDIM) {
...
__kernel void gauge_force_tlsym_multipass6_tpe(__global const Matrixsu3StorageType* const restrict field,
                                               __global aeStorageType* const restrict out,
                                               __global Matrix3x3StorageType* const restrict tmp)
{
    const size_t id_local = get_global_id(0);
    if (id_local < VOL4D_LOCAL * NDIM) {
