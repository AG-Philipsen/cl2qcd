 ...
 */
__kernel void M_tm_plus(__global const spinor* const restrict in, __global const Matrixsu3StorageType* field,
                        __global spinor* const restrict out, hmc_float kappa_in, hmc_float mubar_in)
{
